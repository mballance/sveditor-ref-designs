...
#include "sparse_mem_model_funext.h"


Dll_Export char *veriuser_version_str = 
	"=== OpenSparc T2 sparse_mem_model loadpli ===\n";	
...
Dll_Export static s_tfcell sparse_mem_model_veriusertfs[] =
{
...
# include "sparse_mem_model_fundef.c"
...
Dll_Export p_tfcell sparse_mem_model_pli_boot()
{
io_printf("*** Registering OpenSparc T2 sparse_mem_model system tasks...\n");
return sparse_mem_model_veriusertfs;
}
