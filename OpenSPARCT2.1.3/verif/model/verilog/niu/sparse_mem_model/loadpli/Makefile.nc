...
PLILIB = $(TARGETDIR)/libniu_sparse_mem_model_pli.$(SHARED_LIB_POSTFIX)
...
# not want deleted in "clean" target.
#
PLI_OBJECTS_SAFE = $(DV_ROOT)/verif/model/verilog/niu/sparse_mem_model/loadpli/libniu_sparse_mem_model.a
