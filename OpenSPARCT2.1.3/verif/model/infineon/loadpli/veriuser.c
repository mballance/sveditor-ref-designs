...
#include "memory_funext.h"


Dll_Export char *veriuser_version_str = 
	"=== OpenSparc T2 memory loadpli ===\n";	
...
Dll_Export static s_tfcell memory_veriusertfs[] =
{
...
Dll_Export p_tfcell memory_pli_boot()
{
io_printf("*** Registering OpenSparc T2 memory system tasks...\n");
return memory_veriusertfs;
}
