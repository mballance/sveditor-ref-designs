...
//
// Sun Microsystems, Inc. may have one or more patents relating
// to technology embodied in this design.  In particular, and without
// limitation, these intellectual property rights may include one or
// more of the U.S. patents listed at http://www.sun.com/patents
// and one or more additional patents or pending patent applications
// in the U.S. and other countries. This design is distributed under
// licenses restricting its use, copying, and distribution. No part of
// this design may be reproduced in any form by any means without prior 
...
//
// Description: 
//		This is the FIRE chip level Include file where all of the
//		'defines which are shared among FIRE cores will be defined 
//
//
//
// Design    : FIRE
