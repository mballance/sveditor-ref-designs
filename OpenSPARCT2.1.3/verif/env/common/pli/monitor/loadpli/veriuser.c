...
#include "monitor_funext.h"


Dll_Export char *veriuser_version_str = 
	"=== OpenSparc T2 monitor loadpli ===\n";	
...
Dll_Export static s_tfcell monitor_veriusertfs[] =
{
...
Dll_Export p_tfcell monitor_pli_boot()
{
io_printf("*** Registering OpenSparc T2 monitor system tasks...\n");
return monitor_veriusertfs;
}
