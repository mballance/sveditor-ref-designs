...
#include "socket_funext.h"


Dll_Export char *veriuser_version_str = 
	"=== OpenSparc T2 socket loadpli ===\n";	
...
Dll_Export static s_tfcell socket_veriusertfs[] =
{
...
Dll_Export p_tfcell socket_pli_boot()
{
io_printf("*** Registering OpenSparc T2 socket system tasks...\n");
return socket_veriusertfs;
}
