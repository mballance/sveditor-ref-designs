...
PLILIB = $(TARGETDIR)/libniupli.$(SHARED_LIB_POSTFIX)
...
# VERIUSER_O = $(DV_ROOT)/verif/env/common/pli/niu_pli/loadpli/veriuser.$(OBJ_POSTFIX)
VERIUSER_O =
...
# not want deleted in "clean" target.
#
PLI_OBJECTS_SAFE = $(DV_ROOT)/verif/env/common/pli/niu_pli/loadpli/niu.o \
	$(DV_ROOT)/verif/env/common/pli/niu_pli/loadpli/veriuser.o \
	libnet_ncverilog.a
