...
#include "niu_pli_funext.h"


Dll_Export char *veriuser_version_str = 
	"=== OpenSparc T2 niu loadpli ===\n";	
...
Dll_Export static s_tfcell niu_pli_veriusertfs[] =
{
...
Dll_Export p_tfcell niu_pli_boot()
{
io_printf("*** Registering OpenSparc T2 niu system tasks...\n");
return niu_pli_veriusertfs;
}
