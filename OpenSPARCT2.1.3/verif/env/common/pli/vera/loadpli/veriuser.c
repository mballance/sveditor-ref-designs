...
Dll_Export static s_tfcell vera_veriusertfs[] =
{
...
Dll_Export p_tfcell vera_pli_boot()
{
io_printf("*** Registering Synopsys Vera system tasks...\n");
return vera_veriusertfs;
}
