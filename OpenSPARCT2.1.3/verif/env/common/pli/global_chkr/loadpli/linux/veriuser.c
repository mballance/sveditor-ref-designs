...
#include "global_chkr_funext.h"


Dll_Export char *veriuser_version_str = 
	"=== OpenSparc T2 global_chkr loadpli ===\n";	
...
Dll_Export static s_tfcell global_chkr_veriusertfs[] =
{
...
Dll_Export p_tfcell global_chkr_pli_boot()
{
io_printf("*** Registering OpenSparc T2 global_chkr system tasks...\n");
return global_chkr_veriusertfs;
}
