...
PLILIB = $(TARGETDIR)/libniu_ippktgen_pli.$(SHARED_LIB_POSTFIX)
...
# not want deleted in "clean" target.
#
PLI_OBJECTS_SAFE = $(DV_ROOT)/verif/env/common/vera/niu_ippktgen/C/wrapper/obj/genCpacket.o \
	$(DV_ROOT)/verif/env/common/vera/niu_ippktgen/C/wrapper/obj/pgLibnetL2.o \
	$(DV_ROOT)/verif/env/common/vera/niu_ippktgen/C/wrapper/obj/pgLibnetL3.o \
	$(DV_ROOT)/verif/env/common/vera/niu_ippktgen/C/wrapper/obj/pgLibnetL4.o \
	$(DV_ROOT)/verif/env/common/vera/niu_ippktgen/C/wrapper/obj/pgLibnet.o \
	$(DV_ROOT)/verif/env/common/vera/niu_ippktgen/C/wrapper/obj/pgrand.o \
	$(DV_ROOT)/verif/env/common/vera/niu_ippktgen/C/wrapper/obj/pgUtils.o \
	$(DV_ROOT)/verif/env/common/vera/niu_ippktgen/C/wrapper/obj/pgVeraWrap.o
