...
* 
* OpenSPARC T2 Processor File: mpgen_300_2.s
...
!	mpgen_300_2.s created on Mar 27, 2009 (14:18:51)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_300_2 -p 1 -l 300
...
p0_check_registers:
	...
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 0000000073a58dd8
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 000000009a0328d4
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 000000007b9c8d1a
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be 000000006a86a25f
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be d9ba90ac a0728117
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be e943b5c4 1cb13fbb
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be 9d543db4 37602d1e
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 00000000 ff606bd5
	bne	%xcc,p0_f8_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be bd850000 660a0085
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 35435d09 00000000
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 25396da4 00000000
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 00000097 a4e8baf4
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 9b1cbda9 a8f259d2
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 1e760389 5fa2866a
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 58ffb3e9 f665033f
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be f3a13ed1 809d5b12
	bne	%xcc,p0_f30_fail
	nop
...
p0_local1_sec_expect:
	.word	0x715b3889,0x1e760389
	.word	0x0b005f8f,0xdc87f6e0
	.word	0xd9ba90ac,0x2a6bc2ad
...
p0_local2_expect:
	.word	0x00000000,0x6ea5980e
	.word	0x73a58dd8,0xabffc6a8
	.word	0x5b2069f2,0x0000a46d
...
p0_local3_sec_expect:
	.word	0x5f8da573,0xa8c6ffab
	.word	0x8dfde954,0x2ee28bad
	.word	0x8d380000,0x55ff5b4c
...
p0_local4_sec_expect:
	.word	0xd4000000,0x947b56ab
	.word	0xd45b3889,0x12f42099
	.word	0x158a0000,0x00000000
...
p0_local5_expect:
	...
	.word	0x97000000,0xe162f86c
	.word	0xe943b5c4,0xfa6eab54
...
p0_local6_expect:
	...
	.word	0x1781ffff,0x78352735
	.word	0x995ef499,0x893c5b71
...
p0_local6_sec_expect:
	.word	0xd40034d4,0x2f067da9
	.word	0x00000000,0x00000000
	.word	0xff0034d4,0x46f89bf9
