...
* 
* OpenSPARC T2 Processor File: mpgen_2000_1.s
...
!	mpgen_2000_1.s created on Mar 27, 2009 (14:45:13)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_2000_1 -p 1 -l 2000
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 0ef3afb7d82b51d1
	bne,a,pn %xcc,p0_reg_l0_fail
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 063d97f8480ed2f5
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 29000000ffff1867
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 0000000000007e00
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be ff606077 ff000000
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 00000000 ffa003d0
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 7c6f1867 6432e3e7
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be 14cdf0a0 d003a0ff
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be fa776362 0a1f039a
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 7594537a 00000000
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 7c6f1867 6432e3e7
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 0aaf40f1 ffffff7f
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be ff76594e 000000ff
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 1fff457c 6f000000
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 00ff00ff ff76594e
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be ffffffff 00000000
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 293e0dfb 00000000
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 1e7e61ff ffff1867
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be e52742bb 6432e3ff
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	.word	0x0ef3afb7,0xd82b51d1
	.word	0x063d97f8,0x480ed2f5
	.word	0x00000000,0x000000ff
	.word	0x00000000,0x000000ff
	.word	0x29000000,0xffff1867
	.word	0x00000000,0x00007e00
	.word	0x00000000,0x0000ff00
	.word	0x00000000,0x00000027
p0_expected_fp_regs:
	.word	0xff606077,0xff000000
	.word	0x00000000,0xffa003d0
	.word	0x7c6f1867,0x6432e3e7
	.word	0x14cdf0a0,0xd003a0ff
	.word	0xfa776362,0x0a1f039a
	.word	0x00000000,0x00000000
	.word	0x7594537a,0x00000000
	.word	0x7c6f1867,0x6432e3e7
	.word	0x0aaf40f1,0xffffff7f
	.word	0xff76594e,0x000000ff
	.word	0x1fff457c,0x6f000000
	.word	0x00ff00ff,0xff76594e
	.word	0xffffffff,0x00000000
	.word	0x293e0dfb,0x00000000
	.word	0x1e7e61ff,0xffff1867
	.word	0xe52742bb,0x6432e3ff
	.word	0x0000002a,0x00000800		! %fsr = 0000002a00000800
p0_local0_expect:
	.word	0xffe33264,0x67186f7c
	.word	0xd003a0ff,0x00000000
	.word	0xff000000,0xfa776362
	.word	0x00000000,0x00000000
	.word	0x00ff00ff,0xff76594e
	.word	0x0aaf40f1,0xffffff7f
	.word	0x00000000,0xa35aa749
...
p0_local1_expect:
	.word	0x0aaf40f1,0xffffff7f
	.word	0xff610000,0x000000ff
	.word	0x7c45ff1f,0xffffffe3
	.word	0x00ff00ff,0xff76594e
	.word	0xffffffff,0x00000000
	.word	0x293e0dfb,0x00000000
	.word	0x1e7e61ff,0xffff1867
...
p0_local1_sec_expect:
	...
	.word	0xff03a0ff,0xa35aa749
	.word	0x09ac1b34,0x7b1e9ff7
p0_local2_expect:
	.word	0x000000ff,0x000002ff
	.word	0x00000000,0xffffffff
	.word	0xff617e1e,0xffffffff
	.word	0x00007e00,0x0932356f
	.word	0xff606077,0x6e2dcd72
	.word	0xd3332db5,0xffffffff
	.word	0xde9b58e3,0x30e7b50f
	.word	0xd2ab68ff,0x40ff1e7d
p0_local2_sec_expect:
	.word	0xffb50000,0x40ff1e7d
	.word	0x00000000,0xff617e1e
	.word	0x4e5976ff,0x0f1cff16
...
p0_local3_expect:
	.word	0xe3ffffff,0xf2690d26
	.word	0x00000000,0x000000ff
	.word	0x29f50000,0xffff1867
	.word	0x00ff00ff,0xff76594e
	.word	0x000000ff,0xffffffff
	.word	0xd003a0ff,0xff617eff
	.word	0xff606077,0xff000000
	.word	0xe52742bb,0x72cd2d6e
p0_local3_sec_expect:
	.word	0xd003a0ff,0xffffffff
	.word	0x7594537a,0xffa003d0
	.word	0xdea00000,0x1e3fe782
...
p0_local4_expect:
	.word	0xd1512bd8,0xf5d20e48
	.word	0x007e61ff,0x00000b21
	.word	0x671f039a,0x9b000000
	.word	0xffffffff,0xffffffff
	.word	0x00000000,0x7a53ffff
	.word	0x7e181316,0x4e5976b4
	.word	0xff000000,0x0000001e
	.word	0x00000000,0xff68abd2
...
p0_local5_expect:
	.word	0x00000000,0xff03e0ff
	.word	0xff76594e,0x000000ff
	.word	0x27000000,0x5f064a5e
	.word	0x00ff00ff,0xff76594e
	.word	0xffffffff,0x00000000
	.word	0x293e0dfb,0x00000000
	.word	0x1e7e61ff,0xffff1867
...
p0_local5_sec_expect:
	.word	0x7e001867,0x000000ff
	.word	0x000000ff,0x776060ff
	.word	0xffa75aa3,0xffa003ff
	.word	0xb476594e,0x1613187e
...
p0_local6_expect:
	...
	.word	0xff7071a6,0x4e5976ff
	.word	0x00ff42bb,0x72cd2d6e
	.word	0x869902ff,0x00000000
	.word	0x1e7e61ff,0xffa003d0
	.word	0x7cca72a4,0x8a27d318
	.word	0x00000000,0x000061ff
	.word	0xda82ff79,0xfb0d3eff
p0_local6_sec_expect:
	.word	0x00000000,0xd12aff77
	.word	0x00000000,0x835bb353
	.word	0x00ff0000,0x6432e3e7
