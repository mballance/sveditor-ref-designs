...
* 
* OpenSPARC T2 Processor File: mpgen_3000_11.s
...
!	mpgen_3000_11.s created on Mar 27, 2009 (14:45:29)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_3000_11 -p 1 -l 3000
...
p0_check_registers:
	...
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be ff0000ff00000000
	bne,a,pn %xcc,p0_reg_l2_fail
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be 000000007b0f0000
	...
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 00883fddf00883fd
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be ff000000 ff000000
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be ff006800 00000000
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 00000000 c6de9dcb
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 78b7ff9c ff0000ff
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 00000000 006800ff
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 89a56831 5c11a999
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 00ffffff 00000000
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be e98b0000 000000ff
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be ff000000 ff800000
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
...
p0_expected_registers:
	...
	.word	0x00000000,0x7b0f0000
	.word	0x00000000,0xffffff00
	.word	0x00000000,0x00000000
	.word	0x00000000,0xffffffff
	.word	0x00883fdd,0xf00883fd
p0_expected_fp_regs:
	...
	.word	0x00000000,0x00000000
	.word	0x00000000,0x006800ff
	.word	0xffffffff,0x000000ff
	.word	0x89a56831,0x5c11a999
	.word	0x00ffffff,0x00000000
	.word	0xe98b0000,0x000000ff
	.word	0xff000000,0xff800000
	.word	0xff0000ff,0x00000000
	.word	0x00000026,0x00000000		! %fsr = 0000002600000000
p0_local0_expect:
	.word	0xff0000ff,0x332bcfad
	.word	0xffffff00,0xaeba1b43
	.word	0x0000001a,0x000000ff
	.word	0x00620000,0xffff0000
	.word	0xffff8900,0x38ea007b
	.word	0xe98b0000,0x000000ff
	.word	0xffff00ff,0x000000ff
	.word	0x00000000,0x431bbaff
p0_local0_sec_expect:
	.word	0xffff00ff,0xc6f3ecaf
	.word	0xff000000,0x00000000
	.word	0xffff00ff,0x00000000
	.word	0x00000000,0x00000000
	.word	0x45548937,0x09be3ca1
	.word	0xffff00d8,0xd9e67963
	.word	0xac9bffff,0xff1014c4
	.word	0xc7e0001f,0xe0000000
p0_local1_expect:
	.word	0x00ffffff,0xffffffff
	.word	0x000000ff,0x000000ff
	.word	0xffffffba,0xf00883fd
	.word	0x0000ff00,0x0000ff00
	.word	0x00000000,0x00000080
	.word	0x00000000,0xff000000
	.word	0x00ff48ff,0x378954ff
	.word	0x006800ff,0x00000000
p0_local1_sec_expect:
	.word	0xff006800,0x00000000
	.word	0xffba1b43,0x00000000
	.word	0xff000000,0xff000000
	.word	0xff006800,0x00000000
	.word	0x00000000,0xc6de9dcb
	.word	0x80000000,0x00000000
...
p0_local2_expect:
	...
	.word	0xff000000,0x332bcfad
	.word	0xafecf3c6,0xaeba1b43
	.word	0xffba1b43,0x000000ff
	.word	0x006800ff,0x00000000
	.word	0x00000000,0x00000000
	.word	0x7b00ea38,0x00000000
p0_local2_sec_expect:
	.word	0xffffff54,0xffefe943
	.word	0x431bbaae,0xffff00ff
	.word	0xff000000,0x000000ff
	.word	0xafecf3c6,0xaeba1b43
	.word	0x0a000000,0x00000000
	.word	0x00000000,0x9cffb778
	.word	0x00680089,0xff0000d4
	.word	0xd40000ff,0x00000000
p0_local3_expect:
	.word	0xba000000,0xac000000
	.word	0xff000000,0xffffffff
	.word	0x00ffffff,0x00000000
	.word	0xb78954ff,0x00000000
	.word	0xff000000,0xda36eeff
	.word	0x00004fff,0xff0000ff
	.word	0xd9cf2b33,0x00000000
	.word	0xffffff00,0xffee36da
p0_local3_sec_expect:
	.word	0xffba1b43,0xae5da5b6
	.word	0x00ffffff,0xffffffff
	.word	0xff000000,0x00000f7b
...
p0_local4_expect:
	...
	.word	0x00ff4fff,0x00000000
	.word	0x00000000,0xff1a0000
	.word	0xffffff00,0xffee36da
p0_local4_sec_expect:
	.word	0xffba1b43,0x0000001b
	...
	.word	0x00000000,0x000000ff
p0_local5_expect:
	.word	0xffff0000,0xffba1b43
	.word	0x00000000,0x000000ff
	.word	0xffffafec,0x000000ff
	.word	0x000000ff,0xc6ffecaf
	.word	0x00000000,0x00000000
	.word	0x78b7ff9c,0x00000000
	.word	0x00000000,0x89006800
	.word	0xff000000,0xff0000d4
p0_local5_sec_expect:
	.word	0x000000ff,0xf01014c4
	.word	0xffba1b43,0x00000000
	.word	0xfffffdbc,0x00000000
	.word	0x0062fb4e,0xffff0000
	.word	0x7dea0e50,0x1d858298
	.word	0xb0661710,0x95748079
	.word	0xaca2929f,0x88b66458
	.word	0xd58cfcc8,0xa3d13100
p0_local6_expect:
	.word	0x00000000,0x00000000
	.word	0xcb9ddec6,0x00000000
	.word	0x54ffffff,0x00000000
	.word	0x09be3ca1,0xff3fbf33
	.word	0x00000000,0x000000ff
	.word	0x00000000,0x0000007b
	.word	0xc06caef7,0xffffff00
	.word	0xfffff57f,0xff000000
p0_local6_sec_expect:
	.word	0x00000000,0x00000000
	.word	0xff000000,0xff000000
	.word	0xff001b43,0x00000000
	.word	0x89a56831,0x5c11a999
