...
* 
* OpenSPARC T2 Processor File: mpgen_2000_0.s
...
!	mpgen_2000_0.s created on Mar 27, 2009 (14:45:12)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_2000_0 -p 1 -l 2000
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 00000000ffd60000
	...
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 00211d9f2bee0573
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be ffffffff 450440d6
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 50630000 000000b4
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be e139503d 911a540e
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 5586c10f 17a27aa7
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be ff000000 00000000
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 50630200 b50e61d7
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be ece72778 0a32e176
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be ff000000 ecff0000
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 000001ff 0e541a91
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 00000049 00000000
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 00000000 7e3e58ff
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 80000000 73050000
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 55045c7d 6de02ca5
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	.word	0x00000000,0xffd60000
	.word	0x00000000,0x00000001
	.word	0x00000000,0x00000000
	.word	0x00000000,0x00000000
	.word	0x00000000,0x000000ff
	.word	0x00211d9f,0x2bee0573
	.word	0x00000000,0x00000000
	.word	0xffffffff,0xffffffff
p0_expected_fp_regs:
	.word	0x00000000,0x0000ffff
	.word	0xffffffff,0x450440d6
	.word	0x50630000,0x000000b4
	.word	0xe139503d,0x911a540e
	.word	0x5586c10f,0x17a27aa7
	.word	0xff000000,0x00000000
	.word	0x50630200,0xb50e61d7
	.word	0xece72778,0x0a32e176
	.word	0xff000000,0xecff0000
	.word	0x000001ff,0x0e541a91
	.word	0x00000049,0x00000000
	.word	0xffffffff,0x00000000
	.word	0x00000000,0x7e3e58ff
	.word	0x80000000,0x73050000
	.word	0x00000000,0x80000000
	.word	0x55045c7d,0x6de02ca5
	.word	0x00000035,0x00000c00		! %fsr = 0000003500000c00
p0_local0_expect:
	.word	0xff000000,0x00000000
	.word	0xff75a8b0,0xffffffff
	.word	0x00000000,0xffffffff
	.word	0x2bee0573,0x72507abd
	.word	0xac990448,0x1b00ff00
	.word	0xffbf607e,0x20dd659f
	.word	0xff006de9,0xffffffc2
	.word	0xff000000,0x33660000
p0_local0_sec_expect:
	.word	0xffffffff,0x00000000
	.word	0xffffffff,0x00000000
	.word	0x00000000,0x00006350
...
p0_local2_expect:
	...
	.word	0xffffffff,0xffe02ca5
p0_local2_sec_expect:
	.word	0x50630200,0xb50e61d7
	.word	0xffbf00dd,0xa90cadac
	.word	0x00000000,0x00000000
...
p0_local3_expect:
	.word	0x00211d9f,0x63050000
	.word	0xffd60000,0x00000000
	.word	0x000000b4,0xff6049ff
	.word	0x2349c7e1,0x00000000
	.word	0x49000000,0x00000000
	.word	0x00000000,0xff0000ff
	.word	0xfffffff9,0xdf48e814
	.word	0xffe1f0f2,0x6705d656
p0_local3_sec_expect:
	.word	0x00000042,0x00000000
	.word	0x00000000,0x000000ff
...
p0_local4_expect:
	...
	.word	0x00000001,0x0e541a91
	.word	0x0000ff00,0x0000ffff
	.word	0xdd9dc0ff,0xf2002fdc
...
p0_local4_sec_expect:
	.word	0x00000000,0x00000000
	.word	0xff010000,0x00000000
	.word	0xff1a540e,0x00006350
	.word	0x0e26a88e,0x3d5039e1
	.word	0xa77aa217,0x0fc18655
	.word	0xdd63fba2,0xf02d8855
	.word	0xd7610eb5,0x918ccb87
...
p0_local5_expect:
	...
	.word	0xffff0000,0x00000000
	.word	0xff000000,0xecff0000
	.word	0xb40000ff,0xff000099
	.word	0xffffffff,0xffffff9d
	.word	0x425aeabe,0x0e541a91
	.word	0x00000000,0xffbf607e
	.word	0xddffffff,0xffbf6049
p0_local5_sec_expect:
	...
	.word	0xece72778,0x0a32e176
p0_local6_expect:
	.word	0xff0066ff,0xdd9dc0ff
	.word	0xffd60000,0xfffffff8
	.word	0xffffffdd,0x49000000
	.word	0xf8ffffff,0x00000048
	.word	0x5037e299,0x00000000
	.word	0xc193a468,0x00000063
	.word	0x00000005,0x0000001b
	.word	0xf6002dd6,0x63ace9a5
p0_local6_sec_expect:
	.word	0xffffffff,0x00000000
	.word	0x000000d6,0xffffffff
	.word	0x00ff0000,0x00006350
	.word	0x0e26a88e,0x3d5039e1
	.word	0xa77aa217,0x0fc18655
	.word	0x00000000,0x80000000
	.word	0xd7610eb5,0x00026350
	.word	0x76e1320a,0x7827e7ec
share0_expect:
	.word	0xff024c08,0xa7219620
