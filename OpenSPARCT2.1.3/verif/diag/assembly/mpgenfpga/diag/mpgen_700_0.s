...
* 
* OpenSPARC T2 Processor File: mpgen_700_0.s
...
!	mpgen_700_0.s created on Mar 27, 2009 (14:18:48)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_700_0 -p 1 -l 700
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 000000005f000000
	bne,a,pn %xcc,p0_reg_l0_fail
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 00000000187c5b17
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 00000000ee000000
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 000000003e9932b4
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be 00000000b6000000
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 3e9932b4 9b000000
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 281ef4e9 000000ff
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be b432993e f4000000
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be d78b8338 a2a5f8fc
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 08b1ca49 000000a0
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 8521a483 f5d11fe7
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 1022d25b 237c9571
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be cbf20b01 e2db6ac4
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be ba7e6560 c0000000
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be ffe10275 ea000000
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
...
p0_expected_registers:
	.word	0x00000000,0x5f000000
	.word	0x00000000,0x187c5b17
	.word	0x00000000,0x00000075
	.word	0x00000000,0x0000005f
	.word	0x00000000,0xee000000
	.word	0x00000000,0x3e9932b4
	.word	0x00000000,0xb6000000
	.word	0x00000000,0x00000005
p0_expected_fp_regs:
	.word	0x3e9932b4,0x9b000000
	.word	0x281ef4e9,0x000000ff
	.word	0xb432993e,0xf4000000
	.word	0xd78b8338,0xa2a5f8fc
	.word	0x08b1ca49,0x000000a0
	.word	0x8521a483,0xf5d11fe7
	.word	0x1022d25b,0x237c9571
	.word	0xcbf20b01,0xe2db6ac4
	.word	0x02bfcef0,0xb87baf9d
	.word	0x175b7c18,0xb432993e
	.word	0x000005ff,0xffe10275
	.word	0xf232db5f,0x6226cf1d
	.word	0xba7e6560,0xc0000000
	.word	0xffe10275,0xea000000
...
p0_local2_expect:
	.word	0xff000000,0x77c2f4bf
	.word	0x8ebe3471,0xff3b59bb
	.word	0xff00ffa7,0xa6141aa7
...
p0_local4_sec_expect:
	.word	0x000000ee,0xb432993e
	.word	0x05000000,0xe9f41e28
...
p0_local6_expect:
	.word	0x7502e1ff,0x000000ff
	.word	0xcbf20b01,0xffffff9b
	.word	0xc6b0302d,0x2779c048
	.word	0x4c2eff8c,0x2d9aa3af
	.word	0xd4532c5c,0x5605a52b
	.word	0xea95b63f,0xf1e94f13
	.word	0x43bf034b,0x00cd3c3e
	.word	0xba7e6560,0x7b2a0a90
