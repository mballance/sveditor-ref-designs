...
* 
* OpenSPARC T2 Processor File: mpgen_400_2.s
...
!	mpgen_400_2.s created on Mar 27, 2009 (14:18:51)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_400_2 -p 1 -l 400
...
p0_check_registers:
	...
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 00000000a46d3925
	...
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 00000000d88da573
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be d43400ff 1cb13fbb
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be ff0034d4 715b3889
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be b78117c2 620a7b00
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 5de00000 6ea5980e
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 4471ab05 11ea1440
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 9e86b923 bdf85de0
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 004b4167 f74bd567
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be a0728117 e162f86c
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0x00000000,0xd88da573
p0_expected_fp_regs:
	.word	0xd9ba90ac,0xa0728117
	.word	0xbfc25ba5,0x00000000
	.word	0xd43400ff,0x1cb13fbb
	.word	0xff0034d4,0x715b3889
	...
	.word	0x4471ab05,0x11ea1440
	.word	0x5b2069f2,0x0000a46d
	.word	0x9e86b923,0xbdf85de0
	.word	0x345a82e7,0x69cfe569
	.word	0x00000000,0x00000000
	.word	0x004b4167,0xf74bd567
	.word	0xa0728117,0xe162f86c
	.word	0x00000025,0x00000000		! %fsr = 0000002500000000
p0_local0_expect:
	.word	0x99340a66,0x24eb85bd
...
p0_local2_expect:
	.word	0x5de00000,0x6eff980e
	.word	0x715b3c89,0xabffc6a8
	.word	0x5b2069f2,0x0000a46d
	.word	0x9e86b923,0xbdf85de0
	.word	0x345a82e7,0x69cfe569
...
p0_local2_sec_expect:
	...
	.word	0xbd850000,0x00000000
	.word	0x00008a15,0x125b9d80
...
p0_local3_sec_expect:
	.word	0xd48da573,0xa8c6ffab
	.word	0x178172a0,0x2ee28bad
...
p0_local6_expect:
	.word	0xff000000,0xe754ffd4
	.word	0x12738fc4,0x3b5c9625
	.word	0x000000e5,0x893c5b71
