...
* 
* OpenSPARC T2 Processor File: mpgen_800_2.s
...
!	mpgen_800_2.s created on Mar 27, 2009 (14:18:52)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_800_2 -p 1 -l 800
...
p0_check_registers:
	...
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 00000000f0531021
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 0000000000000df6
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 00000000d7a29cd8
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be 000000004a660000
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be a905ae7c 13b2ab7e
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be fff01e7e 7fffffff
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 000000dc 0cdaef19
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 41ddc7bf 00000000
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be a818ebf9 ffffffff
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 0000ffff 9622db11
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 01000000 ffe7ad74
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
...
p0_expected_registers:
	.word	0xffffffff,0xffffff7f
	.word	0x00000000,0x00000000
	.word	0x00000000,0xf0531021
	.word	0x00000000,0x000000ff
	.word	0x00000000,0x00000df6
	.word	0x00000000,0xd7a29cd8
	.word	0x00000000,0x4a660000
	.word	0x00000000,0x000000ff
p0_expected_fp_regs:
	.word	0xa905ae7c,0x13b2ab7e
	.word	0xfff01e7e,0x7fffffff
	.word	0x00000000,0x00000000
	.word	0x00000000,0xffffff7f
	.word	0x74ad42b6,0x55720ec3
	.word	0x000000dc,0x0cdaef19
	.word	0x41ddc7bf,0x00000000
...
p0_local0_expect:
	.word	0xa58ea241,0xffffffff
	.word	0xffabb213,0xc3a4b638
	.word	0xffabb213,0x36c4b553
...
p0_local0_sec_expect:
	...
	.word	0x00000000,0x0cdaef19
	.word	0x13b2abff,0xffffffff
