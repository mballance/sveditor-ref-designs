...
* 
* OpenSPARC T2 Processor File: mpgen_600_1.s
...
!	mpgen_600_1.s created on Mar 27, 2009 (14:18:50)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_600_1 -p 1 -l 600
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 0000000000008d7e
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 00000000ff30a335
	...
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be 000000001bffff56
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be 586f8d58 ecc5ea83
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 5ee3d60b 00000025
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be bd987101 b005eb71
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be caf77e8d 35a330ff
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 00000000 0100073a
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 467e21a6 c2e82081
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 15f80e7f 00642d67
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
...
p0_local3_sec_expect:
	.word	0x000000ff,0x0000009e
	.word	0x05a6b3c3,0x00000000
	.word	0x56ffff1b,0x4407699b
...
p0_local4_expect:
	...
	.word	0xff568d58,0x80326ec9
	.word	0xffffffff,0x000000b9
	.word	0x0a11cf8c,0xf06aab63
	.word	0xf2af9a9e,0xffe00039
	.word	0x425cdb36,0x02b393b5
...
p0_local6_sec_expect:
	...
	.word	0xff000000,0xe530693d
	.word	0x00003dff,0xe4d8ffff
