...
* 
* OpenSPARC T2 Processor File: mpgen_300_3.s
...
!	mpgen_300_3.s created on Mar 27, 2009 (14:18:53)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_300_3 -p 1 -l 300
...
p0_check_registers:
	...
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 00000000789eac55
	bne,a,pn %xcc,p0_reg_l1_fail
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 00000000000a5dcb
	bne,a,pn %xcc,p0_reg_l2_fail
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be 00000000ff383b35
	bne,a,pn %xcc,p0_reg_l3_fail
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 00000000ff833bb1
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 00000000127ec32e
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 789eac55 222755ff
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 8314efa9 000000f7
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be ffd30960 d663614a
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 167cf44a ac3d3187
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 5ca6146f 00000031
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be ff1cb58a d4b2bcb9
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 27ffa4ac ae8f020f
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be f61762ed 26464f62
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 3d7182e4 6769ec80
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 46000000 00000000
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0x00000000,0x789eac55
	.word	0x00000000,0x000a5dcb
	.word	0x00000000,0xff383b35
	.word	0x00000000,0xff833bb1
	.word	0x00000000,0x127ec32e
	.word	0x00000000,0x0000002e
	.word	0xffffffff,0xffffffe0
p0_expected_fp_regs:
	.word	0x789eac55,0x222755ff
	.word	0x8314efa9,0x000000f7
	.word	0xffd30960,0xd663614a
...
p0_local1_sec_expect:
	...
	.word	0xe9833bb1,0x127ec32e
p0_local2_expect:
	.word	0x281eea71,0xa8803c3a
	.word	0xff513b35,0x0000002c
	.word	0xff000000,0x267f3b15
	.word	0xbe1a8633,0x2d7b3f45
	.word	0x00000046,0xc71998b3
	.word	0x5d3a04c9,0x30c82000
	.word	0x9e06b803,0x84ec10b3
	.word	0xdf91e4cf,0x7e673868
p0_local2_sec_expect:
	.word	0x31000000,0xfc75b03c
	.word	0x87313dac,0x4af47c16
	.word	0xb4000000,0xaad46247
	.word	0x0fee3bab,0xb3a6898e
	.word	0x03e5fc7d,0xd7d8da15
...
p0_local3_sec_expect:
	.word	0x30c82000,0x30872293
	.word	0x00000000,0x0000660d
	.word	0x213b83e9,0x1eb42ac5
