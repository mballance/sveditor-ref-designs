...
* 
* OpenSPARC T2 Processor File: mpgen_300_0.s
...
!	mpgen_300_0.s created on Mar 27, 2009 (14:18:48)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_300_0 -p 1 -l 300
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 0000000049000000
	bne,a,pn %xcc,p0_reg_l0_fail
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be dd20bc97fd611aec
	...
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be ffffffffffffa0ec
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be 000000003e9932b4
	bne,a,pn %xcc,p0_reg_l6_fail
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 00000000187c5b17
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be 794fef64 1734b30b
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 2aab8c3f c66d9f69
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be ff00616c 3e189957
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 48231f22 a9559c98
	bne	%xcc,p0_f12_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be f4bc50f9 8eb6249e
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 885d0e5f ffffff9b
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 559e0000 3f8cab2a
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 4c2e988c 2d9aa3af
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be d4532c5c 5605a52b
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be e46bdc3e f1e94f13
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 1dcf2662 59cd3c3e
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be ba7e6560 7b2a0a90
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0xdd20bc97,0xfd611aec
	.word	0x00000000,0x000000ff
	.word	0x00000000,0x0000009b
	.word	0x00000000,0x000000ce
	.word	0xffffffff,0xffffa0ec
	.word	0x00000000,0x3e9932b4
	.word	0x00000000,0x187c5b17
p0_expected_fp_regs:
	.word	0x5e95f273,0x3e9932b4
	.word	0x9bffffff,0x5f0e5d88
	.word	0x1dcf2662,0x5fdb32f2
	.word	0x794fef64,0x1734b30b
	.word	0x2aab8c3f,0xc66d9f69
	.word	0xff00616c,0x3e189957
	.word	0x48231f22,0xa9559c98
	.word	0xa96627f8,0xe9f41e28
	.word	0xf4bc50f9,0x8eb6249e
	.word	0x885d0e5f,0xffffff9b
	.word	0x559e0000,0x3f8cab2a
...
p0_local1_expect:
	.word	0xff000000,0xf827b7a9
	.word	0x3e9932b4,0x187c5b17
	.word	0xff3deb5b,0x37db7da3
	.word	0xb0c6c93e,0xeebb22ff
	.word	0x1edf6f23,0x9a0dd359
	.word	0x11469aa7,0x5316b51c
	.word	0xc803e019,0xc3ae91ca
	.word	0x9418e363,0x3a539281
p0_local1_sec_expect:
	.word	0x49000000,0x07fb9f3b
	.word	0x00000080,0xc966b8ce
	.word	0x48231f22,0xa9559c98
	.word	0xced4a5ec,0x72479139
	.word	0x3a98bc65,0xd182e059
	.word	0x5f125167,0xc4e524e6
	.word	0xebacec60,0x311aac52
	.word	0xfaf9da52,0x85472862
p0_local2_expect:
	.word	0xff1ef4e9,0x9b000000
	.word	0x00000049,0x374bd17b
	.word	0xff00616c,0x6226cf1d
	.word	0xb142343a,0xf3a9fe7b
	.word	0xc8b0f249,0xd570cacc
...
p0_local3_expect:
	...
	.word	0x0368d1b3,0xf39e0fcd
	.word	0x4b03bf43,0x0768f29d
...
p0_local3_sec_expect:
	.word	0xe9f41e28,0x00000028
	.word	0xa0ec86d9,0x56f91289
	.word	0xa1000000,0x5e000000
...
p0_local4_expect:
	...
	.word	0x48bb1b18,0x4bd08d1c
p0_local4_sec_expect:
	.word	0xff95f273,0x3e9932b4
	.word	0xa96627f8,0xe9f41e28
	.word	0xffe10275,0x3e9932b4
