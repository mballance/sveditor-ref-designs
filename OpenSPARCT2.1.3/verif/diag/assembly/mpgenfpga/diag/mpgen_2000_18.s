...
* 
* OpenSPARC T2 Processor File: mpgen_2000_18.s
...
!	mpgen_2000_18.s created on Mar 27, 2009 (14:45:39)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_2000_18 -p 1 -l 2000
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 000000009495b8c3
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 0e30509a fffffc9f
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be ff5a0000 00000000
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 00007d7d a15a0000
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be 9ffcffff 9a50300e
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 00000000 2ef3f120
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 20f1f32e 00000000
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 00000000 ff000000
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be a15a0000 1dfbd0f5
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 5475fff3 00001044
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 000000ae 2db2ff7c
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 48b5b99d 9a50300e
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be ff000000 c3b89594
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 8b6516ff 5200ffff
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 2ef3f120 00005aa1
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be c5a5f115 000000ff
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be ffffffae f50000ff
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0x00000000,0x000000ff
p0_expected_fp_regs:
	.word	0x0e30509a,0xfffffc9f
	.word	0xff5a0000,0x00000000
	.word	0x00007d7d,0xa15a0000
	.word	0x9ffcffff,0x9a50300e
	.word	0x00000000,0x2ef3f120
	.word	0x20f1f32e,0x00000000
	.word	0x00000000,0xff000000
	.word	0xa15a0000,0x1dfbd0f5
	.word	0x5475fff3,0x00001044
	.word	0x000000ae,0x2db2ff7c
	.word	0x48b5b99d,0x9a50300e
	.word	0xff000000,0xc3b89594
	.word	0x8b6516ff,0x5200ffff
	.word	0x2ef3f120,0x00005aa1
	.word	0xc5a5f115,0x000000ff
	.word	0xffffffae,0xf50000ff
	.word	0x00000029,0x00000000		! %fsr = 0000002900000000
p0_local0_expect:
	.word	0xff5a0000,0x000000ff
	.word	0x70000000,0x00005aa1
	.word	0xff000000,0x00000000
	.word	0x10000000,0x00000000
	.word	0xffffffae,0x000000ff
	.word	0xfff1a5c5,0x2ef3f120
	.word	0x000000ff,0x00000000
	.word	0x8a5e64bd,0x00005aa1
p0_local0_sec_expect:
	.word	0x000000ff,0x0000ffae
	.word	0x879ae900,0x64ffff69
	.word	0xff000000,0x00000000
...
p0_local1_sec_expect:
	...
	.word	0x8a5e64bd,0x00005aa1
p0_local2_expect:
	.word	0xff000000,0x00000091
	.word	0x000000ae,0x00000000
	.word	0xffff0000,0x00000000
	.word	0x00000000,0xffffffff
	.word	0x00000000,0xffff0000
	.word	0x00001f57,0x00000000
	.word	0x00000000,0xbac82067
	.word	0xff0000f5,0x00005ca1
p0_local2_sec_expect:
	.word	0x00000000,0xc1460847
	.word	0x00000000,0x000000a1
	.word	0x1023d0d0,0xaeff0000
	.word	0x00000000,0x00000010
	.word	0xff000000,0x000000ff
	.word	0x20f1f32e,0xc5a5f115
	.word	0x00000000,0xff000000
	.word	0xa15a0000,0xbd645e8a
p0_local3_expect:
	.word	0xffff84ff,0x00001044
	.word	0xa100ffff,0x00000054
	.word	0x9495b8c3,0x000000ff
	.word	0x00007d7d,0x000000ff
	.word	0xffffffff,0xffffd0d0
	.word	0xff000000,0x00000000
	.word	0xff000000,0x000000ff
	.word	0x00000000,0x0000ce77
...
p0_local4_sec_expect:
	.word	0xffffffff,0xf33247b6
	.word	0x68d02310,0x0000ffae
	.word	0xff3effff,0x00000000
	.word	0x01000000,0x102375ff
	.word	0x00005aa1,0x00000000
	.word	0x62b0a630,0xed4f1170
	.word	0xe0776e03,0x1023d0d0
	.word	0xbda6b4e7,0xc3b89594
p0_local5_expect:
	.word	0x00000000,0x2ef3f120
	.word	0x68d02310,0x036e77e0
	.word	0x00000000,0xffffffff
	.word	0x00000000,0x000009ec
	.word	0xc3d757ff,0x00000000
	.word	0xf3ff7554,0x00000000
	.word	0xf3ff7500,0xc523f1d0
	.word	0x00000000,0x0000dd89
p0_local5_sec_expect:
	.word	0x5aa164bd,0x00005aa1
	.word	0x68000000,0x00000010
	.word	0x000000ff,0x00000000
...
p0_local6_expect:
	.word	0x15f1a5c5,0x2ef3f120
	.word	0xfffb0000,0x5e8a0000
	.word	0x00000000,0xff16658b
	.word	0x00000000,0x00000000
...
p0_local6_sec_expect:
	.word	0x00005aa1,0x00000000
	.word	0x00000000,0x00000000
	.word	0x1d00509a,0x5475fff3
	.word	0xffffffff,0x7d7d0000
	.word	0xd0d0ffff,0xffffffff
	.word	0x00000000,0x000000ff
	.word	0xff000000,0x000000ff
	.word	0xff0000f5,0xaeffffff
share0_expect:
	.word	0x00ff8819,0xa3030399
