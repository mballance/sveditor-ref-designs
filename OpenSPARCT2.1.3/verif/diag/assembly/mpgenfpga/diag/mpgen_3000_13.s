...
* 
* OpenSPARC T2 Processor File: mpgen_3000_13.s
...
!	mpgen_3000_13.s created on Mar 27, 2009 (14:45:32)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_3000_13 -p 1 -l 3000
...
p0_check_registers:
	...
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be ae9775387bc675ef
	bne,a,pn %xcc,p0_reg_l1_fail
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 00000000db0dffff
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 21000000 5fb27bff
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be 0000ffff 00000021
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be ff610021 000000ff
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 00000000 03000000
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 00000000 ffff687b
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 045d00ff 00000000
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 7b6800ff 00000000
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be ffffffff f200807f
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 80000000 24b25d04
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be ffffffff 000000ff
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 74ff38d1 ffffffff
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 318eab04 24b20000
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_fp_regs:
	.word	0x21000000,0x5fb27bff
	.word	0x0000ff00,0x00000000
	.word	0xffffffff,0xff000000
	.word	0x0000ffff,0x00000021
	.word	0xff610021,0x000000ff
	.word	0x00000000,0x00000000
	.word	0x00000000,0x03000000
	.word	0x00000000,0xffff687b
	.word	0x045d00ff,0x00000000
	.word	0xffffffff,0x000000ff
	.word	0x7b6800ff,0x00000000
	.word	0xffffffff,0xf200807f
	.word	0x80000000,0x24b25d04
	.word	0xffffffff,0x000000ff
	.word	0x74ff38d1,0xffffffff
	.word	0x318eab04,0x24b20000
	.word	0x00000027,0x00000c00		! %fsr = 0000002700000c00
p0_local0_expect:
	.word	0xb7670000,0x00000000
	.word	0x318eab04,0x24b20000
	.word	0xff0000ff,0xffffffff
	.word	0xae46747d,0x00000046
	.word	0x000000ff,0x000000ff
	.word	0xffffffff,0x000000ff
	.word	0x00000004,0x00000000
	.word	0xff800000,0x00000000
p0_local0_sec_expect:
	.word	0x00000021,0xffffff00
	.word	0xff000000,0x00000000
	.word	0xff610021,0x00000000
	.word	0x21003800,0x210061ff
	.word	0x7fe4967b,0xb3a3d9aa
	.word	0x268d7c0a,0x096cf5c2
	.word	0xe4258817,0xf7f898a4
	.word	0x987eb9ad,0x0850b773
p0_local1_expect:
	.word	0xffff00ff,0x24b25d04
	.word	0xff000000,0x210061ff
	.word	0x00000021,0x00000000
	.word	0x8e610000,0xffffd441
	.word	0x00000000,0x00000000
	.word	0x00008e61,0x7b68038d
	.word	0x21000000,0x5fb27bff
	.word	0x00000024,0xffffffff
p0_local1_sec_expect:
	.word	0x00000000,0x03000000
	.word	0x00ff0000,0x7b68038d
	.word	0xc35f987c,0xff005d04
	.word	0x8d03687b,0x03000000
	.word	0x21000000,0x00000000
	.word	0x00000000,0x00000021
	.word	0x00000000,0x03000000
	.word	0x00000000,0xf200807f
p0_local2_expect:
	.word	0x00000000,0x00000000
	.word	0xff305a67,0x8468f4c6
	.word	0x00000000,0x045d00ff
	.word	0xf200807f,0x000000ff
	.word	0x6ddaff08,0xc791c515
	.word	0x24b25d04,0xab0300ff
	.word	0xff80ff00,0xff000000
	.word	0x00000003,0x000000ff
p0_local2_sec_expect:
	.word	0xffffffff,0xfed7b767
	.word	0xff000000,0x00000000
	.word	0x00000000,0x7b68038d
	.word	0x04ab8e31,0xf200807f
	.word	0xc6ffffff,0x24b25d04
	.word	0x00000000,0x24b20000
	.word	0x74ff38d1,0xff000000
	.word	0x0000b224,0xff000004
p0_local3_expect:
	.word	0xff000000,0xf200807f
	.word	0xff0000ff,0x7b68038d
	.word	0x00000000,0x00000000
	.word	0xffffffff,0x00000000
	.word	0xc6ffffff,0x24b25d04
	.word	0xffffffff,0xff0000ff
	.word	0x74ff38d1,0xffffffff
	.word	0x318eab04,0xffffffff
p0_local3_sec_expect:
	.word	0xffffffff,0xf200807f
	.word	0x47010000,0x000000ff
	.word	0x0000b224,0x04ab8e31
	.word	0x318eab04,0xffffffff
	.word	0x7099543b,0x968f5ab2
	.word	0xfddf580a,0xdc69950b
	.word	0x24b25d04,0xffffffff
	.word	0x38763b02,0x0700da69
p0_local4_expect:
	.word	0xffffffff,0xd138ff74
	.word	0xff000000,0x000000ff
	.word	0x00000000,0xdb0dffff
	.word	0xffff0000,0x00000000
	.word	0xff5db224,0xff005d04
	.word	0x00000000,0x7b68038d
	.word	0x000000ff,0x5746d40a
	.word	0xffffffff,0xff0003ff
p0_local4_sec_expect:
	.word	0xff000000,0x210061ff
	.word	0x000000ff,0x00ff0000
	.word	0xff000000,0xffffdb0d
	.word	0xffff0ddb,0x00000000
	.word	0x03f2ff00,0xcd659a95
	.word	0x7ffb8e61,0x7b68038d
	.word	0x00000000,0x00000000
	.word	0xff0000ff,0xffb27b5a
p0_local5_expect:
	.word	0x0000ffff,0x00000000
	.word	0x00000003,0x00000000
	.word	0xffffffff,0xf200807f
	.word	0x0000ffff,0x00000046
	.word	0xffffffff,0x5fff7b5a
	.word	0x000000fd,0x618efb7f
	.word	0x000000ff,0x000000ff
	.word	0xffffffff,0xffb2ff5a
p0_local5_sec_expect:
	.word	0x00ffffff,0xff005d04
	.word	0x00000000,0xff0000ff
	.word	0xff000000,0xff00687b
	.word	0x7f8000f2,0xffffffff
	.word	0x045db224,0x00000080
	.word	0xff0000ff,0xffffffff
	.word	0xffffffff,0xd138ff74
	.word	0x0000b224,0x04ab8e31
p0_local6_expect:
	.word	0xffff0ddb,0xffffffff
	.word	0x03b21f9d,0x00000000
	.word	0x00000000,0xb09fa4a2
	.word	0x8d030000,0x00000000
	.word	0x00000000,0x000000f2
	.word	0x0000ffc8,0x8fb2181f
	.word	0xff0000ff,0x8941ffd4
	.word	0xffffffff,0xffff0000
p0_local6_sec_expect:
	.word	0x00000000,0x00000000
	.word	0x0000d7fe,0xffffffff
	.word	0x045d00ff,0x00000000
	.word	0x83cf7f40,0xff18b28f
	.word	0x00000003,0x7b68038d
	.word	0x2e824d80,0x0000ffff
	.word	0x00000000,0x000000ff
	.word	0x000000c8,0xedbe00c3
share0_expect:
