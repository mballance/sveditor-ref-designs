...
* 
* OpenSPARC T2 Processor File: mpgen_900_2.s
...
!	mpgen_900_2.s created on Mar 27, 2009 (14:18:52)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_900_2 -p 1 -l 900
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 26909cc9c3a4b638
	bne,a,pn %xcc,p0_reg_l0_fail
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 00000000469c20d5
	bne,a,pn %xcc,p0_reg_l1_fail
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 0000000000004a66
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 26909cc9 13b2ab7e
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be ff072081 ddedd791
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 000000ff aeadfa93
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 91000000 742b4bb8
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 85c5693d 80000000
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 000000ad 00000001
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 00000000 00000001
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
...
p0_expected_fp_regs:
	...
	.word	0x000000ff,0xaeadfa93
	.word	0x91000000,0x742b4bb8
	.word	0x4561a35f,0x742b4bb8
	.word	0x85c5693d,0x80000000
...
p0_local2_expect:
	...
	.word	0xffffff7f,0x000000ff
	.word	0x00000000,0x00000091
	.word	0xb84b2b74,0x5fa36145
	.word	0x7b186fae,0x3d69c585
	.word	0xa58ea241,0x11937f18
	.word	0x84ffffff,0x30000000
	.word	0x6df83f43,0x19efda0c
p0_local2_sec_expect:
	.word	0x0000b638,0xc4ac45a4
	.word	0xf6de0df6,0xf3265385
	.word	0x00000000,0xa818ebf9
...
p0_local3_expect:
	.word	0xff000000,0xda8bf3ff
	.word	0xff000000,0x00000000
	.word	0x0000f800,0x469c20d5
	.word	0x26909cc9,0x13b2ab7e
...
p0_local3_sec_expect:
	.word	0xff000000,0xffe7ad74
	.word	0x00de0000,0x000020d5
...
p0_local4_sec_expect:
	.word	0x469c20d5,0x00000091
	.word	0xa905ae7c,0x00000002
	.word	0x93faadae,0xff000000
