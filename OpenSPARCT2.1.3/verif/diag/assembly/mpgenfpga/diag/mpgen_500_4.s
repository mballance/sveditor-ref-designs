...
* 
* OpenSPARC T2 Processor File: mpgen_500_4.s
...
!	mpgen_500_4.s created on Mar 27, 2009 (14:18:55)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_500_4 -p 1 -l 500
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 0000000089bd5368
	...
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be 34f6c51009f396ac
	...
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 00000000052fd791
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 0b34d72a a2dbc0ff
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 6226aaa9 ac96f309
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 6dd96223 fe74caff
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 8bcc7c81 000000ce
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 1fff3cdc 35e04482
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
...
p0_expected_registers:
	...
	.word	0x00000000,0x052fd791
p0_expected_fp_regs:
	.word	0x0b34d72a,0xa2dbc0ff
...
p0_local1_expect:
	...
	.word	0xa900387f,0x315317c0
	.word	0x86540000,0x42ab6605
...
p0_local2_sec_expect:
	.word	0x00000048,0x236992c3
	.word	0xce000000,0x817ccc8b
	.word	0xe226ffb1,0xf9ff6d1d
...
p0_local3_expect:
	.word	0x328743fb,0xf9ff6d1d
	.word	0xffc0dba2,0x2ad7340b
	.word	0xfe74caff,0xedff370c
...
p0_local3_sec_expect:
	.word	0x96acf309,0xc6d50574
	.word	0x085097da,0x315317c0
	.word	0xedff370c,0x00000000
	.word	0xe9773d22,0x49d1610e
	...
	.word	0xb835ef8f,0x04f925de
p0_local4_expect:
	.word	0x00ff05ff,0x00000000
	.word	0x000000ff,0x0000618e
...
p0_local4_sec_expect:
	...
	.word	0x235999fb,0x926a46b1
	.word	0xba5df761,0x59398f40
...
p0_local6_expect:
	.word	0xedff370c,0x00000000
	.word	0xb3952800,0x2ad7340b
	.word	0x0566ab42,0x00000000
