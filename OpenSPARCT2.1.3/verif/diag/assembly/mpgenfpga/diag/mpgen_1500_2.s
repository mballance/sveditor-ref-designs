...
* 
* OpenSPARC T2 Processor File: mpgen_1500_2.s
...
!	mpgen_1500_2.s created on Mar 27, 2009 (14:45:15)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_1500_2 -p 1 -l 1500
...
p0_check_registers:
	...
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be 0000000067ce8707
	...
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be ffffffffffff8cad
	bne,a,pn %xcc,p0_reg_l6_fail
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 000000007e00364a
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 67ce8707 11000000
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 052dfec6 00000000
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 00000000 00ffff00
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be d5edeaba fff0bb9c
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be ffc60000 00000000
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be bfc28cf8 ffff9744
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 70db00d2 02e18cad
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 056fadff ece279ff
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be ff000000 061ac655
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be c77babee 000000ff
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 918960f8 ece279ff
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 000000ff ffa7ffff
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 1b707ea8 ffff00b4
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
...
p0_expected_registers:
	...
	.word	0xffffffff,0xffff8cad
	.word	0x00000000,0x7e00364a
p0_expected_fp_regs:
	.word	0x67ce8707,0x11000000
	.word	0x052dfec6,0x00000000
	.word	0x00000000,0x00ffff00
	.word	0xd5edeaba,0xfff0bb9c
	.word	0x80000000,0x00000000
	.word	0xffc60000,0x00000000
	.word	0xbfc28cf8,0xffff9744
	.word	0x70db00d2,0x02e18cad
	.word	0x056fadff,0xece279ff
	.word	0xff000000,0x061ac655
	.word	0x000000ff,0x00000000
	.word	0xc77babee,0x000000ff
	.word	0x918960f8,0xece279ff
	.word	0x000000ff,0xffa7ffff
	.word	0x1b707ea8,0xffff00b4
	.word	0x00000000,0xff000000
	.word	0x00000012,0x00000000		! %fsr = 0000001200000000
p0_local0_expect:
	.word	0x00000000,0x7bd72e46
	.word	0x00000000,0xc5a7ffff
	.word	0xffffffff,0xffff8cad
	.word	0x00000000,0x000000ff
	.word	0x0c099c75,0x00000000
	.word	0x0f4f9d1d,0xff4d8b1f
	.word	0x00000000,0xffdb82eb
	.word	0x33f371b2,0x056fad8c
p0_local0_sec_expect:
	.word	0xffc60000,0x00000000
	.word	0x0787ce67,0xffffffff
	.word	0x8cad6f05,0xb271f333
	.word	0xf3187341,0x68d50536
	.word	0xadd0ff91,0x0ba043f5
	.word	0x10fa2a9b,0x9cc32763
	.word	0xe2c09d1d,0x135ac655
	.word	0xdaeee5c6,0x4319c7e0
p0_local1_expect:
	.word	0x056fadff,0xece279ff
	.word	0xff000000,0x061ac655
	...
	.word	0x000000ff,0xffa7ffff
	.word	0x1b707ea8,0xffff00b4
	.word	0x00000000,0xff00002a
p0_local1_sec_expect:
	.word	0xff0000a8,0x000000ff
	.word	0x052dfec6,0xad8c0000
	.word	0xff00e2ec,0x0c099c75
	.word	0xffffffff,0xffffffff
	.word	0x00000000,0x447250aa
	.word	0xce685179,0x4a278aa9
	.word	0xffffffff,0xffc60000
	.word	0xffffffff,0x9a847a4b
p0_local2_expect:
	.word	0xff2500ff,0x00000000
	.word	0xff7900ec,0xf8608991
	.word	0x0f000000,0x00000000
	.word	0x3700e102,0xffc60000
	.word	0x67ce8707,0x1100ff00
	.word	0x000000ff,0x9020fb0b
	.word	0x7eff00ff,0xa85a9ad6
	.word	0x061ac6ff,0x00008cad
p0_local2_sec_expect:
	.word	0x00000037,0x37000000
	.word	0xff370706,0xffff00b4
	.word	0x8b000000,0x000000ff
...
p0_local3_expect:
	.word	0xff00c6ff,0x00000000
	.word	0x00000000,0x00000000
	.word	0xff79e2ec,0xf8608991
	.word	0xffffffff,0xfff0bb9c
	.word	0x87a255b1,0x00000000
	.word	0xf8608991,0xff93c1c7
	.word	0xbfc28cf8,0xffff9744
	.word	0x70db00d2,0x9302b615
p0_local3_sec_expect:
	.word	0x0f000000,0xd3613e5c
	.word	0x00000000,0x000079ff
	.word	0x00000000,0xffffff7e
	.word	0xb3b919e3,0x51c59100
	.word	0x2a000000,0x1f79100e
	.word	0x6b55598b,0x7283e4bc
	.word	0x992bc721,0x6e5f9478
	.word	0x11da2acc,0xafdad75c
p0_local4_expect:
	.word	0x00000000,0xff79e2ec
	.word	0xa85a9ad6,0xece279ff
	.word	0x00005aff,0x1bff7ea8
	.word	0x0000ffff,0x000000ff
	.word	0x1fffa7c5,0x32b0aa8b
	.word	0x00ff0000,0xffffffff
	.word	0x9a370706,0x9020fb0b
	.word	0x724869eb,0x00000000
p0_local4_sec_expect:
	.word	0xffc60000,0x00000000
	.word	0xff2dfec6,0xad8c0000
	.word	0x32b0aa8b,0x1b707ea8
	.word	0xaf52593e,0x1c53fbca
	.word	0x918960ee,0x056fad8c
	.word	0x129d217c,0xb81e66a0
	.word	0x8baab032,0xc5a7ff1f
	.word	0x3eeec2d8,0x38c62378
p0_local5_expect:
	.word	0xe5517eff,0x00000000
	.word	0x0000008b,0x11000000
...
p0_local6_sec_expect:
	...
	.word	0xfff8b398,0xf50c9a30
	.word	0x55c61a06,0x955a90b6
share0_expect:
	.word	0xffff5a4a,0xb21d1fc1
