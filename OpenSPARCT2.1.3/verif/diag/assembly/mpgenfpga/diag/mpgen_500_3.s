...
* 
* OpenSPARC T2 Processor File: mpgen_500_3.s
...
!	mpgen_500_3.s created on Mar 27, 2009 (14:18:53)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_500_3 -p 1 -l 500
...
p0_check_registers:
	...
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 5ff42148743884ec
	...
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be 00000000ff1300b4
	...
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 0000000017d51292
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be ffffffffffffff00
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 624f4626 33345c7c
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 167cf44a 31000000
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 7fffffff 17d51292
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be f6b76916 c4394112
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 93228730 27ffa4ac
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 4762d4aa 0000002e
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
...
p0_expected_registers:
	...
	.word	0x5ff42148,0x743884ec
	.word	0x00000000,0x00000000
	.word	0x00000000,0xff1300b4
	.word	0x00000000,0x00000000
	.word	0x00000000,0x17d51292
	.word	0xffffffff,0xffffff00
	.word	0x00000000,0x000000e7
p0_expected_fp_regs:
	.word	0x624f4626,0x33345c7c
	.word	0x8314efa9,0x327e141c
	.word	0x167cf44a,0x31000000
	...
	.word	0x7fffffff,0x17d51292
	.word	0x73da9dfe,0x00000031
	.word	0xf6b76916,0xc4394112
	.word	0x27ffa4ac,0x2ec37e12
	.word	0x93228730,0x27ffa4ac
...
p0_local0_expect:
	.word	0x00000000,0x83000000
	.word	0x6f14a65c,0x4af47c16
