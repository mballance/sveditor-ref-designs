...
* 
* OpenSPARC T2 Processor File: mpgen_900_0.s
...
!	mpgen_900_0.s created on Mar 27, 2009 (14:18:49)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_900_0 -p 1 -l 900
...
p0_check_registers:
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 00000000b9b8ffff
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 1a00814b 000007ff
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 00000000 4be97d6b
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 25668c93 ffa30eff
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be d5cd0283 9bd210c4
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be b0bbeb1d a7117829
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be e459510f 9c567ad1
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 01000000 69611ef1
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be b0e9d4b6 7d30a100
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 59730000 00000000
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 69611ef1 1724420a
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be df4e814b 984aa100
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0x00000000,0xb9b8ffff
	.word	0x00000000,0x00000000
	.word	0x00000000,0x00000000
	.word	0x00000000,0x00000061
p0_expected_fp_regs:
	.word	0x1a00814b,0x000007ff
	.word	0x00000000,0x4be97d6b
	.word	0x25668c93,0xffa30eff
	.word	0xd5cd0283,0x9bd210c4
	.word	0xb0bbeb1d,0xa7117829
	.word	0xe459510f,0x9c567ad1
	.word	0x01000000,0x69611ef1
	.word	0xb0e9d4b6,0x7d30a100
	.word	0x61000000,0xc298736b
	.word	0xffffb8b9,0x569de4ea
	.word	0x59730000,0x00000000
...
p0_local1_sec_expect:
	...
	.word	0xdf4e814b,0x984aa100
p0_local2_expect:
	.word	0x69610000,0x808695a1
	.word	0x00000000,0x00007359
	.word	0x61000000,0xc298736b
	.word	0x00000000,0xef909986
	.word	0xc4302353,0xab6306d2
	.word	0xb207bcd5,0x015242de
	.word	0x0000007c,0xdf4e814b
	.word	0xea8837cb,0xd5e0865b
p0_local2_sec_expect:
	.word	0xffffff87,0x569de4ea
	.word	0xffb91eb9,0x179d420a
	.word	0xff7398c2,0x00000061
...
p0_local4_expect:
	.word	0xabffff87,0x4be97d13
	.word	0x2560a930,0x00000000
	.word	0x4b814edf,0x137de94b
...
p0_local6_expect:
	...
	.word	0x00000000,0x63294eff
	.word	0x1b3aff18,0xffe2dc88
p0_local6_sec_expect:
	.word	0xb8b90000,0xc2000000
	.word	0xd20663ab,0x00000047
	.word	0xffdb7cb6,0xffcdcd8a
