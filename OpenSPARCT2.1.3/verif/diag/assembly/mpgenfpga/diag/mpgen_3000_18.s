...
* 
* OpenSPARC T2 Processor File: mpgen_3000_18.s
...
!	mpgen_3000_18.s created on Mar 27, 2009 (14:45:39)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_3000_18 -p 1 -l 3000
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 950000ff 000000ff
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 00005aa1 00000000
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be ff000000 0000ff10
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 44100000 00003eff
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 00005aff 00000000
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 00000000 00001044
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 00000000 ff000000
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be ffffffff a15a0000
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 000000a1 5a007396
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 8b6516ff 00000000
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 000000ff 00000000
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0x00000000,0x00000000
p0_expected_fp_regs:
	.word	0x950000ff,0x000000ff
	.word	0x000000ff,0x00000000
	.word	0x00005aa1,0x00000000
	.word	0xff000000,0x0000ff10
	.word	0x44100000,0x00003eff
	.word	0xff000000,0x00000000
	.word	0xffffffff,0x00000000
	.word	0x00005aff,0x00000000
	.word	0x00000000,0x00001044
	.word	0x00000000,0xff000000
	.word	0xffffffff,0xa15a0000
	.word	0x000000a1,0x5a007396
	.word	0x8b6516ff,0x00000000
...
p0_local1_expect:
	...
	.word	0x00000000,0x00000000
	.word	0xffffffff,0x9a50300e
	.word	0xff00ffff,0x000000ff
	.word	0x20f1f32e,0x00000000
	.word	0x00000000,0xff000000
	.word	0x000000ff,0x1dfbd0f5
p0_local1_sec_expect:
	.word	0x44100000,0x00000000
	.word	0x00000000,0xff3ea5ff
	.word	0x00005aa1,0xffffffff
...
p0_local2_sec_expect:
	.word	0x00000000,0x00000000
	.word	0x00000010,0xff000000
	.word	0xff000000,0x00000000
	.word	0xf9ff0000,0xf50000ff
	.word	0xff000000,0x000000ff
...
p0_local3_expect:
	...
	.word	0x000000ff,0x00000000
	.word	0x00000000,0xa15a0000
	.word	0xff000095,0x0000ff10
	.word	0xff000000,0xaeffffff
...
p0_local4_sec_expect:
	.word	0x00005aff,0x00000000
	.word	0x00000000,0xff000000
	.word	0x00000000,0xffffffa1
	.word	0x10000000,0x00000068
	.word	0x00000000,0x2ef30000
	.word	0x62b0a630,0xed4f1170
	.word	0xe0776e03,0x1023d0d0
	.word	0xbda6b4e7,0xc3b89594
p0_local5_expect:
	.word	0xff000000,0x00000068
	.word	0x950000ff,0x00000000
	.word	0x00005aff,0x000000a1
	.word	0x00000000,0x00000000
	.word	0x000000ff,0x00000000
	.word	0x00000000,0x000000ff
	.word	0xff000000,0x0000fff9
	.word	0x00000000,0xffa53eff
...
p0_local6_expect:
	.word	0xffffffff,0x00001044
	.word	0x00000000,0x00000010
	.word	0xff000000,0xff000095
	.word	0x00000000,0x00000000
	.word	0xff000000,0x265aff0a
	.word	0x0e30509a,0x935ea4f9
	.word	0xffffffff,0xffffffff
	.word	0x0000ff00,0x00000000
p0_local6_sec_expect:
	.word	0xa15a0000,0x00000000
	.word	0xffff0000,0x00000068
	.word	0x00000000,0x00000000
	.word	0x35b82ab9,0x65a46210
