...
* 
* OpenSPARC T2 Processor File: mpgen_800_1.s
...
!	mpgen_800_1.s created on Mar 27, 2009 (14:18:50)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_800_1 -p 1 -l 800
...
p0_check_registers:
	...
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 00000000ff4f0000
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be fa00000000000000
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 00000000a9dffb51
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be 00000000caffffff
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 23fef9ff 8fb30934
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be caf77e8d 23fef9ff
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 00000000 000056ff
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 824747dc 31cfabbb
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 985e8d1e 937a6ba0
	bne	%xcc,p0_f30_fail
	nop
...
p0_local0_expect:
	.word	0xff560000,0x017198bd
	.word	0xfffffffa,0x94890000
...
p0_local3_sec_expect:
	.word	0xffffffff,0x7cd30000
	.word	0xfa000000,0x00000000
	.word	0x000000ff,0x7cd000ff
	.word	0x9b690744,0x1b86ff56
	.word	0x56ff861b,0x4407699b
...
p0_local5_expect:
	.word	0xfff9fe23,0x0171ffbd
	.word	0x00000000,0x000000ff
	.word	0xd60000ff,0x44e48ca9
...
p0_local6_expect:
	.word	0xff0000d6,0x81794a99
	.word	0xef000000,0xffbe50ae
	.word	0x00000000,0x51fbdfa9
