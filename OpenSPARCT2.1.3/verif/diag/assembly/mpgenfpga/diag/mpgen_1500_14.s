...
* 
* OpenSPARC T2 Processor File: mpgen_1500_14.s
...
!	mpgen_1500_14.s created on Mar 27, 2009 (14:45:33)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_1500_14 -p 1 -l 1500
...
p0_check_registers:
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be ffffffff90d5fc1e
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 000000000000ff11
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be 00000000ff0000d6
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 59b17d9b d4fbebce
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 90d5fc1e 33c35d18
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be ff0009e0 8aa63b93
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be db800000 ff000000
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 00aaffff 185dc333
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be ff000053 db800000
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 4b9a26a4 000009e0
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be ce4e5d9a a4269a4b
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 00032e67 ce6aba12
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be c9634651 0f64e000
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be ff0000aa 10000000
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 185dc333 ce4e00ff
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be b52df303 d6bc032f
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 00000056 00000010
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0x00000000,0x00000000
	.word	0xffffffff,0x90d5fc1e
	.word	0x00000000,0x0000ff11
	.word	0x00000000,0xff0000d6
	.word	0x00000000,0x0000006b
p0_expected_fp_regs:
	.word	0x59b17d9b,0xd4fbebce
	.word	0x90d5fc1e,0x33c35d18
	.word	0xff0009e0,0x8aa63b93
	.word	0xdb800000,0xff000000
	.word	0x00aaffff,0x185dc333
	.word	0xff000053,0xdb800000
	.word	0x4b9a26a4,0x000009e0
	.word	0xce4e5d9a,0xa4269a4b
	.word	0xff000000,0x00000000
	.word	0x00032e67,0xce6aba12
	.word	0xc9634651,0x0f64e000
	.word	0xff0000aa,0x10000000
	.word	0x185dc333,0xce4e00ff
	.word	0xb52df303,0xd6bc032f
	.word	0x000000ff,0x000000ff
	.word	0x00000056,0x00000010
	.word	0x0000002a,0x00000400		! %fsr = 0000002a00000400
p0_local0_expect:
	.word	0x1efcd590,0x00000000
	.word	0xceebfb00,0x00000000
	.word	0x672e0300,0x98770000
	.word	0x00000000,0x005ea001
	.word	0x59c9c11a,0xe009ff00
	.word	0x00000000,0x69305030
	.word	0x00000000,0x00000000
	.word	0x9b7db159,0xf26c050e
p0_local0_sec_expect:
	.word	0x00000000,0x00000000
	.word	0x000000ff,0x000000ff
	.word	0x006c050e,0x00000072
	.word	0x5ea25b74,0x56860dd4
	.word	0x772efcfd,0xeb35b308
	.word	0xb52df303,0xd6bc032f
	.word	0x0daaa74c,0xcfa24919
	.word	0xf7bef48f,0xce4e00a6
p0_local1_expect:
	.word	0x00ffffff,0x185dc333
	.word	0x10726dd6,0xce6aba12
	.word	0x90000000,0x03780000
	.word	0x00000000,0x00000000
	.word	0x772efcfd,0x000000b0
	.word	0x69305030,0x185dc333
	.word	0x8aa63b93,0x00003054
	.word	0x62000000,0x00000000
p0_local1_sec_expect:
	.word	0xffb17d9b,0xd4fbebce
	.word	0x185dc333,0xce4e00ff
...
p0_local2_expect:
	.word	0xff2e0300,0x0000050e
	.word	0x90d5fc1e,0x33c35d18
	.word	0x00000000,0x00000000
	.word	0x00000000,0xe8004aef
	.word	0x185dc333,0x00000000
	.word	0x53a62c32,0x000000ff
	.word	0x0010a74c,0xcfa24919
	.word	0x00000072,0x94c2fd7c
p0_local2_sec_expect:
	.word	0x00000000,0xffd5c92d
	.word	0xff4822b7,0x530000ff
	.word	0x8ff4bef7,0xffffffff
	...
	.word	0x10726dd6,0xce6aba12
p0_local3_expect:
	.word	0x009a00a4,0x00107ee0
	.word	0x00000010,0x2d000000
	.word	0x66a2ffff,0x72000000
...
p0_local3_sec_expect:
	.word	0xff000000,0x00000000
	.word	0xff003054,0x185dc333
	.word	0x9a000000,0x33c35d18
	.word	0x9914c033,0x8aa63b93
	.word	0x3e07c3fa,0x0cec9855
	.word	0xa9bc7c61,0x7627c1a7
	.word	0x76e77a14,0x6ed6ddf6
	.word	0x18f3f355,0xfe33170b
p0_local4_expect:
	.word	0xaa2effe5,0x00000000
	.word	0x00000000,0x00000000
	.word	0xffffffff,0x00000000
	.word	0x0dbd8189,0x8aa63b93
	.word	0x00000000,0x000000ff
	.word	0x000000ff,0x7eee8d5c
	.word	0xf05e1d00,0x3357ee94
	.word	0x8590ff23,0x000000ff
p0_local4_sec_expect:
	.word	0xffbef48f,0x00000000
	.word	0x59000000,0x11ff0000
	.word	0x66000000,0x9a5dffbe
...
p0_local5_expect:
	.word	0xffffffff,0x00000000
	.word	0xffffffaa,0xd40d8656
	.word	0xff5d4ece,0x00000000
	.word	0x000000aa,0x7eee8d5c
	.word	0x0dbd8189,0x8aa63b93
	.word	0x8ddb922c,0xed3c7995
	.word	0x4b9a26a4,0x2ab73dc9
	.word	0x12ba6ace,0x2d6d7210
p0_local5_sec_expect:
	.word	0xff0000aa,0x00000000
	.word	0x00000000,0x00000000
	.word	0xff000000,0x00000001
	.word	0x622572cc,0x745ba25e
	.word	0xe9af3b9c,0x04d7358c
	.word	0x530432d3,0x00000000
	.word	0x00000000,0x622572cc
	.word	0xff000000,0x322ca653
p0_local6_expect:
	.word	0x00000000,0x00000000
	.word	0xff00d45e,0x2c92db8d
	.word	0x00aaffff,0x185dc333
	.word	0x0dbd8189,0x8aa67893
	.word	0xd4189176,0xeafcff4a
	.word	0x00002dc9,0x00000000
	.word	0xff000053,0xdb800000
	.word	0x672e0378,0x0023df27
p0_local6_sec_expect:
	.word	0x00000000,0x170f8656
	.word	0x00000000,0xbeff5d9a
	.word	0xff0000d6,0x03f32db5
	.word	0x469497b9,0x7c55eadd
	.word	0x6ea696bb,0x42107eed
	.word	0x8a7bd704,0x9c3b6b63
	.word	0xc0856eb2,0x32dfe348
	.word	0x82e676b7,0x1bbb1267
share0_expect:
	.word	0xa266e0d4,0xd09d1d7a
