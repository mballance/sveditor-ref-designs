...
* 
* OpenSPARC T2 Processor File: mpgen_1500_19.s
...
!	mpgen_1500_19.s created on Mar 27, 2009 (14:45:40)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_1500_19 -p 1 -l 1500
...
p0_check_registers:
	...
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 0000000000b20000
	...
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 0000000049000000
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be ff000000ffffffff
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 0aafffff b20000e3
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 00000000 735700ff
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be 73000000 ffffffbb
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be e09cba41 2302b620
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 5341aa5a 49000000
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 00000000 49000000
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be ff900102 ff000000
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 007f0000 000000ff
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 000000ff e282b620
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 00000000 c90a45ff
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 147fa279 6ad67029
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 7914086f 5aaa4153
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be ae3ded1d f87c67df
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be a2e1f9a7 58caeb5e
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_fp_regs:
	.word	0x0aafffff,0xb20000e3
	.word	0x000000ff,0xffffffff
	.word	0x00000000,0x735700ff
	.word	0x73000000,0xffffffbb
	.word	0xe09cba41,0x2302b620
	.word	0x5341aa5a,0x49000000
	.word	0x00000000,0x49000000
	.word	0xff900102,0xff000000
	.word	0x007f0000,0x000000ff
	.word	0x000000ff,0xe282b620
	.word	0x00000000,0x00000000
	.word	0x00000000,0xc90a45ff
	.word	0x147fa279,0x6ad67029
	.word	0x7914086f,0x5aaa4153
	.word	0xae3ded1d,0xf87c67df
	.word	0xa2e1f9a7,0x58caeb5e
	.word	0x0000000e,0x00000400		! %fsr = 0000000e00000400
p0_local0_expect:
	.word	0x596d00a0,0x00000000
	.word	0xffafffff,0x3791c43b
	.word	0x00000000,0x00000000
	.word	0x00ff0000,0x7f3c76ff
	.word	0x0000ff00,0x6cb69670
	.word	0x00000059,0x00000000
	.word	0x000000ff,0x00000000
	.word	0xb9c22738,0x000000e3
p0_local0_sec_expect:
	.word	0x0aafffff,0xff000000
	.word	0xff000000,0xffffffff
	.word	0x00000000,0x735700ff
...
p0_local1_expect:
	.word	0xffffffff,0x00000059
	.word	0xffff0000,0x240b06fe
	.word	0xff000000,0xff000000
	.word	0xab88e890,0x000000ff
	.word	0x00000000,0x00000000
	.word	0x5aa5c652,0xacffcdff
	.word	0xdec25738,0xff000000
	.word	0x00590000,0xff26b6e3
p0_local1_sec_expect:
	.word	0x002806fe,0x00000000
	.word	0x000000e3,0x596de9bb
	.word	0x00000000,0x40a0db9a
	.word	0x000000e3,0xd2077973
	.word	0x3ba5ef0b,0xa2ae6320
	.word	0x00000000,0x00000059
	.word	0xff000000,0xffff2ceb
	.word	0xbbb4aac3,0x7b34ac03
p0_local2_expect:
	.word	0x000000e1,0xffffffff
	.word	0xff000000,0xffffffff
	.word	0x6f004d21,0x00000000
	.word	0xe5592105,0xbb7b3782
	.word	0xffbb0000,0x0000af0a
	.word	0x0000ff00,0x6cb69670
	.word	0x00000056,0xb6a6bb80
	.word	0x154b1ac0,0x259c005a
p0_local2_sec_expect:
	.word	0xff000000,0x00007f00
	.word	0x20b682e2,0xff000000
	.word	0x00000000,0x00000000
	...
	.word	0x5eebca58,0xa7f9e1a2
p0_local3_expect:
	.word	0xff0000ff,0x05df1bf1
	.word	0x0affffbb,0xe3b626ff
	.word	0x7f3c7674,0xff000000
	.word	0x2aeb6dff,0x000000ff
	.word	0x9ef72440,0x3cbfd576
	.word	0xe5000029,0xcddfc3cd
	.word	0x2c7cf65d,0xff40b0a1
	.word	0x73000000,0xffffffbb
p0_local3_sec_expect:
	.word	0x007f0000,0x000000ff
	.word	0x00000049,0x5aaa4153
	.word	0xff005773,0x00000000
...
p0_local4_expect:
	...
	.word	0xff000000,0x000000e1
	.word	0xb5362bff,0x000000a0
	.word	0x00000000,0x00000000
	.word	0x000000ff,0xffffffff
	.word	0x0000ee1c,0x0000080a
	.word	0x09deefe5,0x91710aaf
p0_local4_sec_expect:
	.word	0xb20000e3,0x00000000
	.word	0x00000000,0x00000000
...
p0_local5_expect:
	...
	.word	0xff0000e3,0x7b3de5ff
	.word	0xffffffbb,0x000090ff
	.word	0x5590009d,0x20e4862f
	.word	0x00007379,0xb0ede7ff
	.word	0xe09cba41,0x2302b620
	.word	0xbbb4aac3,0xffffffff
	.word	0xbb48fd0c,0x000000e3
p0_local5_sec_expect:
	.word	0x000000ff,0x020190ff
	.word	0x7f3c7674,0xbbe96d59
	.word	0x0aaf0000,0x00000000
...
p0_local6_expect:
	.word	0x005700ff,0xffff2205
	.word	0x00000000,0x0000007b
	.word	0xffffafff,0xe30000ff
	.word	0x00000000,0xb2008237
	.word	0x962c1419,0xf369d877
	.word	0x00000000,0xc90a45ff
	.word	0x000000e3,0xd2077973
	.word	0x5aa50000,0x5fffaa86
p0_local6_sec_expect:
	.word	0xffff0000,0xbbb4aac3
	.word	0xbbffffff,0x00000073
	.word	0x82371000,0x00000000
	.word	0x2f86e420,0x9d009055
