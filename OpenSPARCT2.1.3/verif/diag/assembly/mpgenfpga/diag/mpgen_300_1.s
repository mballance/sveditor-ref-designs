...
* 
* OpenSPARC T2 Processor File: mpgen_300_1.s
...
!	mpgen_300_1.s created on Mar 27, 2009 (14:18:49)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_300_1 -p 1 -l 300
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 75200c08241863d2
	bne,a,pn %xcc,p0_reg_l0_fail
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be b0608107894ec78a
	...
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 0000000020000000
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 5b516947 00000020
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be a0ff1f5f 00faf23e
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 740ea328 8acdca4e
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 003e09b0 9bd23bb2
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be e700f527 64c93059
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
...
p0_expected_registers:
	.word	0x75200c08,0x241863d2
	.word	0xb0608107,0x894ec78a
...
p0_local1_expect:
	.word	0xb23bd29b,0xfcd71120
	.word	0xff000000,0x0000002e
	.word	0xff0000ff,0xfffffb75
...
p0_local2_expect:
	...
	.word	0xff00005b,0x2e557796
	.word	0xdf4e814b,0x8acdffab
...
p0_local4_expect:
	.word	0xff11d7fc,0x9bd23bb2
	.word	0x61005a07,0x1e2383c4
	.word	0xedcacd8a,0x60070c7c
...
p0_local5_sec_expect:
	.word	0xfcd71120,0xffffff9e
	.word	0x9bd23bb2,0x00000020
