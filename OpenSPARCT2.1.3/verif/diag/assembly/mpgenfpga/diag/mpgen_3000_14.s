...
* 
* OpenSPARC T2 Processor File: mpgen_3000_14.s
...
!	mpgen_3000_14.s created on Mar 27, 2009 (14:45:33)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_3000_14 -p 1 -l 3000
...
p0_check_registers:
	...
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be ffc9000010000000
	...
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 000000ff000000ff
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 00000000 0000ffff
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be ffffff00 0000000d
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be ffffffff 00000000
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be ff0000ff ffffff00
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 1efcd590 ce6aba12
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 33c35d18 30503069
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 00000000 db000000
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be ff800000 00000000
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be ff000000 ff000000
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 00000000 00000028
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be bf7fdfff e0000000
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 4b9a0001 2ab73dc9
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 000d0000 55100000
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_fp_regs:
	...
	.word	0xffffff00,0x0000000d
	.word	0xffffffff,0x00000000
	.word	0xff0000ff,0xffffff00
	.word	0x1efcd590,0xce6aba12
	.word	0x33c35d18,0x30503069
	.word	0x00000000,0xdb000000
	...
	.word	0xbf7fdfff,0xe0000000
	.word	0x4b9a0001,0x2ab73dc9
	.word	0x000d0000,0x55100000
	.word	0x00000036,0x00000400		! %fsr = 0000003600000400
p0_local0_expect:
	.word	0xff003054,0x00000d5e
	.word	0xff000000,0x00000000
	.word	0x00000022,0x0000000d
	.word	0x00ffffff,0xff000000
	.word	0x00000000,0xff0000ff
	.word	0xdb000000,0x69305047
	.word	0x0000ff00,0x00000000
	.word	0xff000028,0x0d000000
p0_local0_sec_expect:
	.word	0xffff0000,0x0000000d
...
p0_local1_expect:
	.word	0x0d000000,0x0000ffff
	.word	0xffdf7fbf,0xffffffff
	.word	0x00000000,0x0d000000
	.word	0x000000ff,0x000000ff
	.word	0x000000ff,0x90d5fc1e
	.word	0x69305030,0x185dc333
	.word	0xfffffebb,0x00003054
	.word	0x629a26a4,0x00001055
p0_local1_sec_expect:
	.word	0x28000000,0x0000ffff
	.word	0xffffffff,0x000075ff
	.word	0xff000000,0x00000000
	.word	0xff000000,0xff000000
	.word	0x1efcd590,0xce6aba12
	.word	0x33c35d18,0x30503069
	.word	0x54300000,0xbbfeffff
	.word	0x55100000,0xa4269a62
p0_local2_expect:
	.word	0x0d000000,0x00000000
	.word	0xffffffff,0x0d000000
	.word	0x000000ff,0x00000000
	.word	0x92df3465,0x00003ea5
	.word	0x185dc333,0x00000000
	.word	0xffbd8189,0x10000000
	.word	0x9a5dffff,0xdb000000
	.word	0xffff0072,0x94c2fd7c
p0_local2_sec_expect:
	.word	0x1efcd590,0x00000000
	.word	0xffff0000,0x000000db
...
p0_local3_expect:
	...
	.word	0x9a000000,0x8981bd0d
	.word	0x95793ced,0x000000db
	.word	0xff00005e,0xa4269a4b
	.word	0x1e0dd590,0x00000000
p0_local3_sec_expect:
	.word	0x00000000,0x000000ff
	.word	0x00000028,0x00000000
	.word	0xff000000,0xff000000
	.word	0x80000000,0x00000000
	.word	0x0000000d,0x00000028
	.word	0xbf7fdfff,0xe0000000
	.word	0x4b9a0001,0x2ab73dc9
	.word	0x000d0000,0x55100000
p0_local4_expect:
	.word	0x4b9a0001,0x2ab73dc9
	.word	0xff000000,0x00000000
	.word	0xffffffff,0xff00ffff
	.word	0x0dbd8189,0x8aa63b93
	.word	0xff793ced,0x1000ffff
	.word	0x00000011,0x000000ff
	.word	0xf05e1d00,0x3357ee94
	.word	0xffc90000,0x10000000
p0_local4_sec_expect:
	.word	0xff72c4b0,0xce6a300c
	.word	0xff0000ff,0x000000ff
	.word	0xff00000d,0xfffffebb
...
p0_local5_expect:
	.word	0x933ba68a,0x000000ff
	.word	0x00000000,0x00000000
	.word	0xff000000,0xff000000
	.word	0x000000aa,0xffeeffbe
	.word	0x0dbd4d89,0x8aa63b93
	.word	0x8ddb922c,0x00000000
	.word	0x00000000,0xffffffa8
	.word	0x0c306ace,0xb0c47210
p0_local5_sec_expect:
	.word	0x0000ff00,0x00000000
	.word	0x7cfdc294,0x8981bd0d
	.word	0x00ff0000,0x00000028
	.word	0x00000010,0xaa0000ff
	.word	0x00000000,0x000000ff
	.word	0x7cfd00ff,0x000000ff
	.word	0x12ba6ace,0xd66d7210
	.word	0xd66d0000,0x00000000
p0_local6_expect:
	.word	0x00000089,0xff0000ff
	.word	0xff001055,0x00000d00
	.word	0x00000000,0x00000000
	.word	0xff000000,0xaa00ffff
	.word	0x00000000,0xffff0000
	.word	0x7cfdff94,0x72000000
	.word	0xff000000,0xff000000
...
p0_local6_sec_expect:
	...
	.word	0x00000000,0x000000ff
	.word	0x00000000,0x00000000
	.word	0x0dbd8189,0xff793ced
	.word	0x81d5c92d,0x9a5dffbe
	.word	0x4b9a26a4,0x11ff0000
	.word	0x0d000000,0x00000000
share0_expect:
