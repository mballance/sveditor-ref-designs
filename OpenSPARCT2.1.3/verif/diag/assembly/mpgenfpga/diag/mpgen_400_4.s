...
* 
* OpenSPARC T2 Processor File: mpgen_400_4.s
...
!	mpgen_400_4.s created on Mar 27, 2009 (14:18:54)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_400_4 -p 1 -l 400
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 96b53316679ef63e
	...
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be 00000000b0134105
	bne,a,pn %xcc,p0_reg_l3_fail
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 000000000000c7ca
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 0000000071000000
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be 00000000b0134f1e
	bne,a,pn %xcc,p0_reg_l6_fail
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 00000000bf8f82ca
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 19fc7f67 000051f9
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be bf8f82ca e3e67613
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 51f971ff dffc1e20
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be da474434 346baf2d
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 550cb30d 3784d41a
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be eddf916a d61c6945
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be ccd5654e 00000039
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 1e43669c bf8f82ca
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 5675ac46 41576fd9
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 266e3c69 cb79f4a9
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 0f238cf9 305a24e0
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0x00000000,0xb0134105
	.word	0x00000000,0x0000c7ca
	.word	0x00000000,0x71000000
	.word	0x00000000,0xb0134f1e
	.word	0x00000000,0xbf8f82ca
p0_expected_fp_regs:
	.word	0x19fc7f67,0x000051f9
	.word	0x0000ffff,0x00000038
	.word	0x9f389757,0xd15dff42
	.word	0x0a129924,0x39cdbd71
	.word	0xce1743ff,0xd6691cd6
	.word	0xbf8f82ca,0xe3e67613
	.word	0x2c50a665,0x4dde8ac6
	.word	0x51f971ff,0xdffc1e20
	.word	0xda474434,0x346baf2d
	.word	0x550cb30d,0x3784d41a
	.word	0xeddf916a,0xd61c6945
	.word	0xccd5654e,0x00000039
	.word	0x1e43669c,0xbf8f82ca
	.word	0x5675ac46,0x41576fd9
	.word	0x266e3c69,0xcb79f4a9
	.word	0x0f238cf9,0x305a24e0
	.word	0x00000010,0x00000400		! %fsr = 0000001000000400
p0_local0_expect:
	.word	0xffff9619,0x0000637c
	.word	0x51f98fbf,0x9c66431e
...
p0_local1_expect:
	.word	0xffffffff,0x000000f1
	.word	0xff5b4980,0xb841cf15
	.word	0xff3752c5,0xd5a68a47
	.word	0xda474434,0x346baf2d
	.word	0x0a129924,0x39cdbd71
...
p0_local2_sec_expect:
	.word	0x00000000,0x70cf63a9
	.word	0x00000000,0xe5519f9c
	.word	0xff904d0b,0x4cb752c5
...
p0_local3_expect:
	...
	.word	0xf9510000,0x677ffc19
	.word	0xff71f951,0x2df395c3
	.word	0x550cb30d,0x3784d41a
...
p0_local5_expect:
	.word	0xbf8f82ca,0xe3e67613
	.word	0x0019654e,0x00000039
	.word	0xff75ac46,0x41576fd9
...
p0_local5_sec_expect:
	.word	0x74ec8c42,0x47ed6337
	.word	0x39000000,0x4e65d5cc
	.word	0xff4f13b0,0x85841456
...
p0_local6_sec_expect:
	...
	.word	0xffff005d,0x1f7cb8ad
	.word	0x00000000,0x00099ab0
