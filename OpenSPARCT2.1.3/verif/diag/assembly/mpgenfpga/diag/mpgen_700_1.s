...
* 
* OpenSPARC T2 Processor File: mpgen_700_1.s
...
!	mpgen_700_1.s created on Mar 27, 2009 (14:18:50)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_700_1 -p 1 -l 700
...
p0_check_registers:
	...
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 000000000000fa00
	...
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 000000000000d37c
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 05000000 8fb30934
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 1d58cd57 7cd000ff
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 7cd06654 71eb05b0
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be bd987101 c2598cf4
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 51fb82b7 ff4fb8c7
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 00000000 f48c59c2
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be d8e4ffff c5ffffff
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be b894409b 30faffff
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 467e21a6 ff000000
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 9489d6ab f006fa37
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 3c3252cc f6916cba
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 00003dff 00642d67
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be caf77e8d 23fef9ff
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0x00000000,0x000000ff
p0_expected_fp_regs:
	.word	0x05000000,0x8fb30934
	.word	0xcaf77e8d,0x23fef9ff
	.word	0x1d58cd57,0x7cd000ff
	.word	0x000000ea,0x1b86ff56
	.word	0x00000000,0x00000000
	.word	0x7cd06654,0x71eb05b0
	.word	0xbd987101,0xc2598cf4
	.word	0x51fb82b7,0xff4fb8c7
	.word	0x00000000,0xf48c59c2
	.word	0xd8e4ffff,0xc5ffffff
	.word	0xb894409b,0x30faffff
	.word	0x467e21a6,0xff000000
	.word	0x9489d6ab,0xf006fa37
	.word	0x3c3252cc,0xf6916cba
	.word	0x00003dff,0x00642d67
	.word	0xcaf77e8d,0x23fef9ff
...
p0_local2_sec_expect:
	.word	0xff4fa0d5,0x2bdcee9e
	.word	0x3a000000,0x001b0000
	.word	0xff0000e4,0xe4d8ffff
...
p0_local5_expect:
	.word	0xf48c59c2,0x017198bd
	.word	0xf9ff0000,0xf2af9a9e
	.word	0x000000fa,0x44e48ca9
