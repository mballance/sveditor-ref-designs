...
* 
* OpenSPARC T2 Processor File: mpgen_200_2.s
...
!	mpgen_200_2.s created on Mar 27, 2009 (14:18:51)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_200_2 -p 1 -l 200
...
p0_check_registers:
	...
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 0000000000008a15
	bne,a,pn %xcc,p0_reg_l1_fail
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 00000000158aaa9e
	bne,a,pn %xcc,p0_reg_l2_fail
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be 000000000000388d
	bne,a,pn %xcc,p0_reg_l3_fail
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 0000000012000000
	...
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 0000000017810000
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be c54a691c ff606bd5
	bne	%xcc,p0_f8_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be ec9086a7 89385b71
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be d8b3a781 9eaa8a15
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be ff606bd5 82733771
	bne	%xcc,p0_f26_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 25396da4 d56b60ff
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_fp_regs:
	...
	.word	0xec9086a7,0x89385b71
	.word	0xd8b3a781,0x9eaa8a15
	.word	0xff606bd5,0x82733771
	.word	0x8aac0410,0x263fbd6e
	.word	0x25396da4,0xd56b60ff
	.word	0x00000021,0x00000800		! %fsr = 0000002100000800
p0_local0_expect:
...
p0_local3_expect:
	.word	0x0b005f8f,0x66000000
	.word	0x0000bad9,0x00000000
...
p0_local6_sec_expect:
	.word	0xff0034d4,0x2f067da9
	.word	0x97000000,0x00000000
	.word	0xd56b604f,0x46f89bf9
