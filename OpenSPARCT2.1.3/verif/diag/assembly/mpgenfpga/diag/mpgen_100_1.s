...
* 
* OpenSPARC T2 Processor File: mpgen_100_1.s
...
!	mpgen_100_1.s created on Mar 27, 2009 (14:18:49)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_100_1 -p 1 -l 100
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 9f7196df1cecadff
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be b23bd29bfcd71120
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 000000005cf99de5
	bne,a,pn %xcc,p0_reg_l5_fail
	mov	%l5,%g3
	ldx	[%g1+0x030],%g2
	cmp	%l6,%g2			! %l6 should be 00000000b3354bb5
	bne,a,pn %xcc,p0_reg_l6_fail
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 0951d5c23bdb7cb6
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 2011d7fc 9bd23bb2
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 52d75a07 1e2383c4
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 4ecacd8a 60070c7c
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be a4563c50 1ad51c87
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 0a38f4ab 01ea11b0
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be b8b92e18 8dc07560
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 12000000 b12a0000
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 00faf23e be510f69
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be c483231e 075ad7d2
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be b011ea01 abf4380a
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be e00648ec 182eb9b8
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
...
p0_expected_registers:
	.word	0x9f7196df,0x1cecadff
	.word	0x00000000,0x00000020
	.word	0x00000000,0x0000007c
	.word	0x00000000,0x0000002e
	.word	0xb23bd29b,0xfcd71120
	.word	0x00000000,0x5cf99de5
	.word	0x00000000,0xb3354bb5
	.word	0x0951d5c2,0x3bdb7cb6
p0_expected_fp_regs:
	.word	0x2011d7fc,0x9bd23bb2
	.word	0x52d75a07,0x1e2383c4
	.word	0x4ecacd8a,0x60070c7c
	.word	0xa4563c50,0x1ad51c87
	.word	0x0a38f4ab,0x01ea11b0
	.word	0xb8b92e18,0x8dc07560
	.word	0x12000000,0xb12a0000
	.word	0x00faf23e,0xbe510f69
	.word	0xb23bd29b,0xfcd71120
	.word	0xc483231e,0x075ad7d2
...
p0_local2_expect:
	...
	.word	0xc9201377,0x2e557796
	.word	0xff0c0760,0x8acdca4e
	.word	0xe22473a4,0x984a4799
	.word	0xfd309453,0x0168627b
...
p0_local3_expect:
	...
	.word	0x7c0c0760,0x00000020
	.word	0x9f7196df,0x1cecadff
	.word	0x8950e1f0,0x4be97d13
	.word	0xb446531f,0x6faac087
	.word	0xef909986,0xde425201
	.word	0x00000000,0x5a26c80a
...
p0_local6_expect:
	.word	0x9775f574,0x98c410c4
	.word	0x20c9c734,0x63294e77
	.word	0xffcba8c8,0x02f4e2e0
