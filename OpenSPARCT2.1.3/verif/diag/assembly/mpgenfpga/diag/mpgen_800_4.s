...
* 
* OpenSPARC T2 Processor File: mpgen_800_4.s
...
!	mpgen_800_4.s created on Mar 27, 2009 (14:18:55)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_800_4 -p 1 -l 800
...
p0_check_registers:
	...
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 00000000ffff0000
	bne,a,pn %xcc,p0_reg_l2_fail
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be 0235f1213e268089
	bne,a,pn %xcc,p0_reg_l3_fail
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 0000000000006977
	...
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 000000006853bd89
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be bac0dba2 97917b00
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be cc020661 fb438732
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be ff000000 0000618e
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
...
p0_expected_registers:
	...
	.word	0x00000000,0x00006977
	.word	0x00000000,0x00ff0000
	.word	0x00000000,0xffffffff
	.word	0x00000000,0x6853bd89
p0_expected_fp_regs:
	...
	.word	0xbac0dba2,0x97917b00
	.word	0xcc020661,0xfb438732
	.word	0xff000000,0x0000618e
...
p0_local0_expect:
	.word	0x09f39689,0x0c37ffed
	.word	0x00000000,0x22a877e1
	.word	0x00005d00,0xa9aa2662
	.word	0xffffd578,0xf9ff6d1d
...
p0_local1_expect:
	...
	.word	0x0000ce00,0x315317c0
	.word	0xffff0000,0x42ab6605
	.word	0xe9770090,0x49d1610e
...
p0_local2_expect:
	...
	.word	0xff952800,0xb1ff26e2
	.word	0x0000212c,0xffffffff
...
p0_local4_expect:
	.word	0x328743fb,0x610602cc
	.word	0x8e610000,0x000000ff
	.word	0xffffffff,0x00ce0000
	.word	0x002895ff,0xe0911c78
	.word	0x0000618e,0x0000ff48
	.word	0x4c8ca9a3,0x3bc0a656
	.word	0x09f39689,0xa9aa2662
	.word	0x0235f121,0x3e268089
p0_local4_sec_expect:
	.word	0x00ce0000,0x10c5f634
	.word	0x09f39689,0x78d52e95
	.word	0xff5df761,0x59398f40
...
p0_local6_expect:
	.word	0x09f396ac,0x00000009
	.word	0xffffd578,0xf9ff6d1d
	.word	0xffffb395,0x48000000
	.word	0xdc71b4ff,0xdd2aa0c2
