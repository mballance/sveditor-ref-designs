...
* 
* OpenSPARC T2 Processor File: mpgen_2000_13.s
...
!	mpgen_2000_13.s created on Mar 27, 2009 (14:45:31)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_2000_13 -p 1 -l 2000
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 000000000000db94
	...
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 0000000000009625
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be 0000000000002bfb
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 7f800000 014b43ca
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 0d0000ff b5db09f5
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 564ce1f4 00000000
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 0f000000 00000000
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 564ce1f4 000000f4
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 58ffff12 000000ff
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be bca1ff70 ba01ffff
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 0000000d ca434b01
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 7fffffff ca434b01
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 00000000 65db8bff
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be d14f1fda fb191258
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 36000000 9cffffff
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 579dfb69 00000000
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	.word	0x00000000,0x0000db94
	.word	0x00000000,0x000000ff
	.word	0x00000000,0x00009625
	.word	0x00000000,0x00000000
	.word	0x00000000,0x00002bfb
	.word	0x00000000,0x00000000
	.word	0x00000000,0x0000000d
	.word	0x00000000,0x00000000
p0_expected_fp_regs:
	.word	0x7f800000,0x014b43ca
	.word	0x00000000,0x00000000
	.word	0x0d0000ff,0xb5db09f5
	.word	0x00000000,0x00000000
	.word	0x564ce1f4,0x00000000
	.word	0x0f000000,0x00000000
	.word	0x564ce1f4,0x000000f4
	.word	0x00000000,0x00000000
	.word	0x58ffff12,0x000000ff
	.word	0xbca1ff70,0xba01ffff
	.word	0x0000000d,0xca434b01
	.word	0x7fffffff,0xca434b01
	.word	0x00000000,0x65db8bff
	.word	0xd14f1fda,0xfb191258
	.word	0x36000000,0x9cffffff
	.word	0x579dfb69,0x00000000
	.word	0x0000001d,0x00000800		! %fsr = 0000001d00000800
p0_local0_expect:
	.word	0x00000000,0x00000000
	.word	0x65db8bff,0x00000000
	.word	0x00000000,0x65db8bff
	.word	0xd14fffda,0x46109074
	.word	0x901ae3ff,0x0000db94
	.word	0x579d0000,0x2f8b875d
	.word	0xff9fff14,0xffe3ff0d
	.word	0x466c4463,0xd14f1fda
p0_local0_sec_expect:
	.word	0x00000000,0x00000004
	.word	0xff000000,0x00000000
	.word	0xff09dbb5,0xff00000d
...
p0_local1_expect:
	.word	0x6416064b,0x000000ff
	.word	0xff000000,0xf4e14c56
	.word	0x00000000,0x00000000
...
p0_local1_sec_expect:
	.word	0xffffffff,0x014b43ca
	.word	0x00000000,0x00000000
	.word	0x0d0000ff,0xb5db09f5
	.word	0x014b43ca,0xffffff7f
	.word	0x564ce1f4,0x00000000
	.word	0x0f000000,0x00000000
	.word	0xff000000,0x14ff9fe8
	.word	0xff8bdb65,0x69fb9d57
p0_local2_expect:
	.word	0x0d000000,0xffffffff
	.word	0x581219fb,0x80000000
	.word	0x00000000,0x000000f4
	.word	0x00000000,0xc4f79625
	.word	0x00000000,0xf4e14c56
	.word	0x00000000,0x0000000f
	.word	0xe89fff14,0x000000ff
	.word	0x579dfb69,0x2f8b875d
p0_local2_sec_expect:
	.word	0x00000000,0x0000000d
	.word	0xfff8ffff,0xffffff9c
	.word	0x6416064b,0xc7f8ffff
	.word	0x7490e1f4,0x001f4f00
	.word	0x94dba373,0xd0cb1a90
	.word	0x5d878b2f,0x69fb9d57
	.word	0x0dffe3ff,0x14ff9fe8
	.word	0x57a0fbe2,0x63db6c46
p0_local3_expect:
	.word	0x7e000000,0x12ffff58
	.word	0x94db0000,0x00000000
	.word	0x564c0000,0x00000000
	.word	0xff000000,0xff8bffff
	.word	0x0f36e1f4,0xffffffff
	.word	0x00000000,0x14ff9fe8
	.word	0x00000000,0x000000ff
	.word	0x00000000,0xc7f8ffff
p0_local3_sec_expect:
	.word	0x000000f4,0x00000000
	.word	0x69000000,0xffffffe3
...
p0_local4_expect:
	...
	.word	0x00000000,0x00000000
	.word	0xe3ff00ff,0x00000000
	.word	0x0d000000,0xff5aa57e
	.word	0x00000000,0x0000000d
	.word	0x0d0000ff,0x00000094
	.word	0xff9fff14,0x000000ff
	.word	0x80ffadb4,0xff800d00
p0_local4_sec_expect:
	.word	0x007ef804,0x0000007e
	.word	0xff000000,0x00000000
	.word	0x2596f7c4,0x0000000d
...
p0_local5_expect:
	.word	0x2596f7c4,0xff5aa57e
	.word	0xff000000,0x000000ff
	.word	0xff2b0000,0x65db8bff
	.word	0xff44ffee,0xfff8ffff
	.word	0xffffffff,0xffffff0d
	.word	0xf804ff00,0xa23900ff
	.word	0x524b7e2e,0x010000c6
	.word	0xff7c9f24,0x45be3a33
p0_local5_sec_expect:
	.word	0x00000036,0x000000e8
	.word	0xd2df0000,0x00000000
...
p0_local6_expect:
	.word	0xf4000000,0xf4e14c56
	.word	0x0000db94,0xda1f4fd1
...
p0_local6_sec_expect:
	.word	0x94db0000,0xffffffff
	.word	0xd2dfffe9,0x06e3359c
	.word	0xffdb0000,0x00000000
