...
* 
* OpenSPARC T2 Processor File: mpgen_100_4.s
...
!	mpgen_100_4.s created on Mar 27, 2009 (14:18:54)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_100_4 -p 1 -l 100
...
p0_check_registers:
	...
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be ffffffff809bb4f1
	bne,a,pn %xcc,p0_reg_l1_fail
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 0000000015cf41b8
	bne,a,pn %xcc,p0_reg_l2_fail
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be 552859e6f9904d0b
	...
	mov	%l6,%g3
	ldx	[%g1+0x038],%g2
	cmp	%l7,%g2			! %l7 should be 00000000cffddf71
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 8b6f97b6 9989b211
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 201efcdf ce1743fa
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be fa4317ce 7efb4a67
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be 5aade7e6 6a91dfed
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be b2c08171 a617ecd0
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 5b227545 b841cf15
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 495b4980 36db386f
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 90b292cc 9a09b211
	bne	%xcc,p0_f14_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 38341df1 dffc1e20
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 6ae6c631 6de02c31
	bne	%xcc,p0_f20_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be 72f6bd89 2c9ee77b
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 01ee8e9b 68de1a18
	bne	%xcc,p0_f26_fail
	nop
...
p0_expected_registers:
	...
	.word	0xffffffff,0x809bb4f1
	.word	0x00000000,0x15cf41b8
	.word	0x552859e6,0xf9904d0b
	.word	0x00000000,0x00000000
	.word	0x00000000,0x00000000
	.word	0x00000000,0x00000041
	.word	0x00000000,0xcffddf71
p0_expected_fp_regs:
	.word	0x8b6f97b6,0x9989b211
	.word	0x201efcdf,0xce1743fa
	.word	0xfa4317ce,0x7efb4a67
	.word	0x5aade7e6,0x6a91dfed
	.word	0xb2c08171,0xa617ecd0
	.word	0x5b227545,0xb841cf15
	.word	0x495b4980,0x36db386f
	.word	0x90b292cc,0x9a09b211
	.word	0x45818645,0x0501eaf7
	.word	0x38341df1,0xdffc1e20
	.word	0x6ae6c631,0x6de02c31
	.word	0xc1e4a434,0x10339a82
	.word	0x72f6bd89,0x2c9ee77b
	.word	0x01ee8e9b,0x68de1a18
	.word	0x7cf116da,0x1db7aeeb
	.word	0xe60468ff,0x206e5963
	.word	0x00000000,0x00000000		! %fsr = 0000000000000000
p0_local0_expect:
	.word	0x6f38db36,0x80495b49
	.word	0x38341df1,0xdffc1e20
	.word	0x67fdfb7e,0xce1743fa
	.word	0xeddf916a,0xe6e7ad5a
	.word	0xd0ec17a6,0x7181c0b2
	.word	0x15cf41b8,0x4575225b
	.word	0x6f38db36,0x80495b49
	.word	0x9c5cea45,0xccffb290
p0_local0_sec_expect:
	.word	0x7cbebdb9,0xb5e38baf
	.word	0x18afd200,0x0cce24ee
	.word	0xffb259ce,0xfb574c82
...
p0_local1_expect:
	.word	0xcf000000,0x0000be7c
	.word	0xf1b49b80,0x8a7cb835
...
p0_local1_sec_expect:
	.word	0x71000034,0x78c0cd34
	.word	0x71df95d7,0x4586818f
	.word	0xe00530a2,0x4a3af422
...
p0_local2_expect:
	.word	0x4a0820eb,0xf2c175af
	.word	0xfa4317ce,0xdffc1e20
	.word	0xe2d27354,0x5e1c08c6
	.word	0xf53826b1,0x4778f75e
	.word	0x354a6e52,0xa50f26bc
	.word	0xc9795f9c,0xac151532
	.word	0xca36f1d4,0xda9b8138
	.word	0x622d25aa,0xd98cec74
p0_local2_sec_expect:
	.word	0xd7000000,0x70cf63a9
	.word	0x7931a24b,0xe5519f9c
	.word	0x5c7c0d78,0x4f46c50e
...
p0_local3_expect:
	...
	.word	0xf1979ea5,0x2df395c3
	.word	0x550cb30d,0x3784d41a
	.word	0x90832cf2,0xf914d93a
	.word	0x93e2b43d,0xa06405b6
	.word	0xf773a6c9,0xcbfd058d
	.word	0xaaded28c,0x4083bfcb
p0_local3_sec_expect:
	.word	0x571a294a,0x1d46ffe2
	.word	0xd98cec74,0x4689d745
	.word	0x55b21996,0x0627173d
...
p0_local5_expect:
	.word	0x00000041,0xcffddf71
	.word	0xccd5654e,0x01ee8e9b
	.word	0xfdcf25f2,0xa565cc26
	.word	0xf637b056,0x3085e48d
	.word	0x19fc7f67,0x9ff04a09
	.word	0x0041cb86,0x71dfe059
	.word	0xf3a43f4b,0x8a12aa7e
	.word	0x730cc897,0x2bd22e08
p0_local5_sec_expect:
	.word	0x9f9a8675,0x47ed6337
	.word	0xc1e4a434,0x10339a82
