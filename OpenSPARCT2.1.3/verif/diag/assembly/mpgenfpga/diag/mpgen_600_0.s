...
* 
* OpenSPARC T2 Processor File: mpgen_600_0.s
...
!	mpgen_600_0.s created on Mar 27, 2009 (14:18:48)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_600_0 -p 1 -l 600
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be 000000f43e9932b4
	bne,a,pn %xcc,p0_reg_l0_fail
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be 000000007b2a0a90
	bne,a,pn %xcc,p0_reg_l1_fail
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 000000009418e363
	bne,a,pn %xcc,p0_reg_l2_fail
	mov	%l2,%g3
	ldx	[%g1+0x018],%g2
	cmp	%l3,%g2			! %l3 should be a0ec86d956f91289
	bne,a,pn %xcc,p0_reg_l3_fail
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be ffffffff9b000000
	bne,a,pn %xcc,p0_reg_l4_fail
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 00000000ffbf034b
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 9e24b68e f950bcff
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 9bffffff 5f0e5d88
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 48c07927 2d306f00
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be afa39a2d 8cff2e4c
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 2ba50556 5c2c53d4
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 134fe9f1 3fb695ea
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 3e3ccd59 4b03bf43
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 900a2a7b 60657eba
	bne	%xcc,p0_f14_fail
	std	%f16,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 02bfcef0 b87baf9d
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be 2d306f00 3ec9c6b0
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be c7e4577d c0000000
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be eebb22ff 0000af9d
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be fff69a3a 374bd17b
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be f82766a9 63e31894
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_registers:
	...
	.word	0x00000000,0x7b2a0a90
	.word	0x00000000,0x9418e363
	.word	0xa0ec86d9,0x56f91289
	.word	0xffffffff,0x9b000000
	.word	0x00000000,0xffbf034b
	.word	0x00000000,0x0000003e
	.word	0x00000000,0x0000005f
p0_expected_fp_regs:
	.word	0x9e24b68e,0xf950bcff
	.word	0x9bffffff,0x5f0e5d88
	.word	0x48c07927,0x2d306f00
	.word	0xafa39a2d,0x8cff2e4c
	.word	0x2ba50556,0x5c2c53d4
	.word	0x134fe9f1,0x3fb695ea
	.word	0x3e3ccd59,0x4b03bf43
	.word	0x900a2a7b,0x60657eba
	.word	0x02bfcef0,0xb87baf9d
	.word	0x175b7c18,0xb432993e
	.word	0x000005ff,0xffe10275
	.word	0x2d306f00,0x3ec9c6b0
	.word	0xc7e4577d,0xc0000000
	.word	0xeebb22ff,0x0000af9d
	.word	0xfff69a3a,0x374bd17b
	.word	0xf82766a9,0x63e31894
	.word	0x0000000b,0x00000000		! %fsr = 0000000b00000000
p0_local0_expect:
	.word	0x000000c0,0x7d57e4c7
	.word	0x9418e363,0x3a539281
...
p0_local0_sec_expect:
	.word	0xea000049,0xdb2c30b0
	.word	0xb0c6c93e,0x006f302d
	.word	0x000000f2,0xbc30419f
...
p0_local2_expect:
	.word	0x00000000,0xbb593bff
	.word	0x8ebe3471,0xff3b59bb
	.word	0xffffffa7,0xa6141aa7
	.word	0xb142343a,0xf3a9fe7b
	.word	0x0000003e,0x0000005f
	.word	0xe3ce8a8a,0xe25c7110
	.word	0xbbb86424,0x6879e6cd
	.word	0x5a567c35,0xba26725f
...
p0_local3_expect:
	.word	0x8ebe3471,0x3700a29b
	.word	0xba7e6560,0x7b2a0a90
	.word	0xff2766a9,0x0768f29d
...
p0_local4_sec_expect:
	.word	0x0000009b,0xb432993e
	.word	0x636627f8,0xe9f41e28
	.word	0x000000f4,0x3e9932b4
...
p0_local5_expect:
	...
	.word	0x9418e363,0x56f91289
	.word	0xff0000ff,0x3785c07b
	.word	0x42e6f7e0,0xd63e790a
	.word	0xffffffff,0xea95b63f
	.word	0xffae909b,0x00000000
	.word	0x87f242f8,0x281ef4e9
	.word	0xa0ec86d9,0x56f91289
p0_local5_sec_expect:
	.word	0xfff69a3a,0x80000000
	.word	0xc7e4577d,0xc0000000
	.word	0x3ec9c6b0,0x8f65764f
...
p0_local6_expect:
	...
	.word	0x006f302d,0x2779c048
	.word	0x4c2eff8c,0x2d9aa3af
	.word	0xd4532c5c,0x5605a52b
	.word	0xea95b63f,0xf1e94f13
	.word	0x43bf034b,0x59cd3c3e
	.word	0xba7e6560,0x7b2a0a90
