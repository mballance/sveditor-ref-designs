...
* 
* OpenSPARC T2 Processor File: mpgen_200_4.s
...
!	mpgen_200_4.s created on Mar 27, 2009 (14:18:54)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_200_4 -p 1 -l 200
...
p0_check_registers:
	...
	ldx	[%g1+0x000],%g2
	cmp	%l0,%g2			! %l0 should be ffffffffc55237dc
	bne,a,pn %xcc,p0_reg_l0_fail
	mov	%l0,%g3
	ldx	[%g1+0x008],%g2
	cmp	%l1,%g2			! %l1 should be edb93837813d3a7a
	bne,a,pn %xcc,p0_reg_l1_fail
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be 00000000ffa6e529
	...
	mov	%l4,%g3
	ldx	[%g1+0x028],%g2
	cmp	%l5,%g2			! %l5 should be 000000000000637c
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 8b6f97b6 80000000
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	cmp	%l0,%l1			! %f2  should be 55b21996 df3db7a6
	bne	%xcc,p0_f2_fail
	std	%f4,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be 1376e6e3 51f971ff
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	cmp	%l0,%l1			! %f8  should be 19967354 cffddf71
	bne	%xcc,p0_f8_fail
	std	%f10,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be ffffb2d6 66d0495f
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	cmp	%l0,%l1			! %f14 should be 8f818645 d795df71
	bne	%xcc,p0_f14_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 38341df1 ff2d265a
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be fdcf25f2 a565cc26
	bne	%xcc,p0_f28_fail
	nop
...
p0_expected_registers:
	.word	0xffffffff,0xc55237dc
	.word	0xedb93837,0x813d3a7a
	.word	0x00000000,0xffa6e529
	.word	0xffffffff,0xfffffff1
	.word	0xffffffff,0xffffffc7
	.word	0x00000000,0x0000637c
	.word	0x00000000,0x0000007c
	.word	0x00000000,0x000000f1
p0_expected_fp_regs:
	.word	0x8b6f97b6,0x80000000
	.word	0x55b21996,0xdf3db7a6
	.word	0x1376e6e3,0x51f971ff
	.word	0x5aade7e6,0x6a91dfed
	.word	0x19967354,0xcffddf71
	.word	0xffffb2d6,0x66d0495f
	.word	0x495b4980,0x36db386f
	.word	0x8f818645,0xd795df71
	.word	0x45818645,0x0501eaf7
	.word	0x38341df1,0xff2d265a
	...
	.word	0x00000000,0x00000400		! %fsr = 0000000000000400
p0_local0_expect:
	.word	0xf17c0d78,0x0000b255
...
p0_local2_expect:
	.word	0x51f971ff,0x1376e6e3
	.word	0xff4317ce,0xdffc1e20
	.word	0x19967354,0x5e1c08c6
	.word	0xf538b255,0x4778f75e
...
p0_local3_expect:
	.word	0xff2d265a,0x00000034
	.word	0xff71f951,0xe3e67613
	.word	0x13769ea5,0x2df395c3
