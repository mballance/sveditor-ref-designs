...
* 
* OpenSPARC T2 Processor File: mpgen_600_3.s
...
!	mpgen_600_3.s created on Mar 27, 2009 (14:18:53)
!	RC file : random.rc
!	cmd = /import/n2-tools/release/tools/mpgen/mpgen,1.051220 -rc random.rc -o mpgen_600_3 -p 1 -l 600
...
p0_check_registers:
	...
	mov	%l1,%g3
	ldx	[%g1+0x010],%g2
	cmp	%l2,%g2			! %l2 should be ffffffffffffb929
	...
	mov	%l3,%g3
	ldx	[%g1+0x020],%g2
	cmp	%l4,%g2			! %l4 should be ffffffffffffffb1
...
p0_check_fp_registers:
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x00],%l0
	cmp	%l0,%l1			! %f0  should be 789eac55 127ec3ff
	bne	%xcc,p0_f0_fail
	std	%f2,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x08],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x10],%l0
	cmp	%l0,%l1			! %f4  should be b1833bb1 00000019
	bne	%xcc,p0_f4_fail
	std	%f6,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x18],%l0
	cmp	%l0,%l1			! %f6  should be 17d51292 ff552722
	bne	%xcc,p0_f6_fail
	std	%f8,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x20],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x28],%l0
	cmp	%l0,%l1			! %f10 should be 31000000 00000000
	bne	%xcc,p0_f10_fail
	std	%f12,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x30],%l0
	cmp	%l0,%l1			! %f12 should be 1900143d ffffff00
	bne	%xcc,p0_f12_fail
	std	%f14,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x38],%l0
	...
	ldx	[%g1],%l1
	ldx	[%g3+0x40],%l0
	cmp	%l0,%l1			! %f16 should be 00ac0960 47f1f3b8
	bne	%xcc,p0_f16_fail
	std	%f18,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x48],%l0
	cmp	%l0,%l1			! %f18 should be 00000036 27ffa4ac
	bne	%xcc,p0_f18_fail
	std	%f20,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x50],%l0
	cmp	%l0,%l1			! %f20 should be 7fffffff 000165cc
	bne	%xcc,p0_f20_fail
	std	%f22,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x58],%l0
	cmp	%l0,%l1			! %f22 should be d6272079 8735c17c
	bne	%xcc,p0_f22_fail
	std	%f24,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x60],%l0
	cmp	%l0,%l1			! %f24 should be ff000000 6f14a65c
	bne	%xcc,p0_f24_fail
	std	%f26,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x68],%l0
	cmp	%l0,%l1			! %f26 should be 00000000 0000f700
	bne	%xcc,p0_f26_fail
	std	%f28,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x70],%l0
	cmp	%l0,%l1			! %f28 should be 87998ea9 7350c0a3
	bne	%xcc,p0_f28_fail
	std	%f30,[%g1]
	ldx	[%g1],%l1
	ldx	[%g3+0x78],%l0
	cmp	%l0,%l1			! %f30 should be 44b79e24 f97ba361
	bne	%xcc,p0_f30_fail
	nop
...
p0_expected_fp_regs:
	.word	0x789eac55,0x127ec3ff
	.word	0x8314efa9,0x327e141c
	.word	0xb1833bb1,0x00000019
	.word	0x17d51292,0xff552722
	.word	0x80000000,0x00000000
	.word	0x31000000,0x00000000
	.word	0x1900143d,0xffffff00
	.word	0xe9833bb1,0x127ec32e
	.word	0x00ac0960,0x47f1f3b8
	.word	0x00000036,0x27ffa4ac
	.word	0x7fffffff,0x000165cc
...
p0_local1_expect:
	.word	0xff000000,0xc71998b3
	.word	0x00000017,0xbd3d7f6e
...
p0_local2_expect:
	...
	.word	0x3d0326e5,0x0000002e
	.word	0x000165cc,0xffffff00
	.word	0x87998ea9,0x7350c0a3
	.word	0x00000046,0xc71998b3
	.word	0x5d3a04c9,0x30ff2000
	.word	0x9e06b803,0x84ec10b3
	.word	0x27ffa4ac,0xff3b83e9
p0_local2_sec_expect:
	.word	0x00000000,0x71d4c2bc
	.word	0xff000000,0x76c0166d
...
p0_local3_expect:
	.word	0xff000000,0x6f14a65c
	.word	0x167cf44a,0x00000000
	.word	0xb40013ff,0xa7d6e5f3
	.word	0xacfd6bdb,0x465287a9
	.word	0x0611982e,0x0bf46051
...
p0_local4_sec_expect:
	.word	0xaca4ff27,0x30872293
	.word	0xff000000,0x00003100
	.word	0xff000000,0x000000f7
...
p0_local5_expect:
	.word	0x00000000,0x0000b929
	.word	0xb13b83e9,0x27ffa4ac
...
p0_local6_expect:
	.word	0xaad46247,0x30872293
	.word	0xff318fae,0xd663614a
	.word	0xb1833bb1,0x0000ff19
