...
* 
* OpenSPARC T2 Processor File: PCIeCFGRd.s
...
!#define CFG0_RD_ADDR mpeval(N2_PCIE_BASE_ADDR + (IOCFG_OFFSET_BASE_REG_DATA & 0x7fffffffffffffff),16,16)
#define CFG0_RD_ADDR  N2_PCIE_BASE_ADDR
!#define CFG1_RD_ADDR mpeval(CFG0_RD_ADDR + CFG1_ACCESS_PA,16,16)
...
SECTION       .DATA1 DATA_VA=CFG0_RD_ADDR
attr_data {     
      Name = .DATA1,
      hypervisor,
      compressimage
