...
* 
* OpenSPARC T2 Processor File: PCIeIommu4U8kTr.s
...
#define DMA_DATA_ADDR		   0xf8000000

#define IOMMU_TTE_ADDR		   0x40000000

! Bit 8 = Page Size: 0=8KB, 1=64KB;  Bits 3:0 = TSB Table size:	9=512k entries 
#define MMU_TSB_CNTRL_REG_DATA	   mpeval(IOMMU_TTE_ADDR | 0x000 | 9)
...
! load address of the TSB table, and the page size (8KB)
...
! Created 09/11/2005 17:24:41 by /home/somePerson/bin/genDMAs.pl 
	setx  0xf8000000, %g1, %g2	! DMA start address
	setx  0x00002000, %g1, %g3	! page size
#define DMA_ADDR_01 mpeval(0xf8000000 + 0,16,16)
#define DMA_ADDR_02 mpeval(0xf8000000 + 64,16,16)
#define DMA_ADDR_03 mpeval(0xf8000000 + 128,16,16)
DMA0: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA0)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_01, DMA_ADDR_02, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_11 mpeval(0xf8002000 + 0,16,16)
#define DMA_ADDR_12 mpeval(0xf8002000 + 64,16,16)
#define DMA_ADDR_13 mpeval(0xf8002000 + 128,16,16)
DMA1: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA1)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_11, DMA_ADDR_12, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_21 mpeval(0xf8004000 + 0,16,16)
#define DMA_ADDR_22 mpeval(0xf8004000 + 64,16,16)
#define DMA_ADDR_23 mpeval(0xf8004000 + 128,16,16)
DMA2: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA2)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_21, DMA_ADDR_22, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_31 mpeval(0xf8006000 + 0,16,16)
#define DMA_ADDR_32 mpeval(0xf8006000 + 64,16,16)
#define DMA_ADDR_33 mpeval(0xf8006000 + 128,16,16)
DMA3: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA3)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_31, DMA_ADDR_32, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_41 mpeval(0xf8008000 + 0,16,16)
#define DMA_ADDR_42 mpeval(0xf8008000 + 64,16,16)
#define DMA_ADDR_43 mpeval(0xf8008000 + 128,16,16)
DMA4: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA4)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_41, DMA_ADDR_42, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_51 mpeval(0xf800a000 + 0,16,16)
#define DMA_ADDR_52 mpeval(0xf800a000 + 64,16,16)
#define DMA_ADDR_53 mpeval(0xf800a000 + 128,16,16)
DMA5: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA5)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_51, DMA_ADDR_52, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_61 mpeval(0xf800c000 + 0,16,16)
#define DMA_ADDR_62 mpeval(0xf800c000 + 64,16,16)
#define DMA_ADDR_63 mpeval(0xf800c000 + 128,16,16)
DMA6: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA6)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_61, DMA_ADDR_62, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_71 mpeval(0xf800e000 + 0,16,16)
#define DMA_ADDR_72 mpeval(0xf800e000 + 64,16,16)
#define DMA_ADDR_73 mpeval(0xf800e000 + 128,16,16)
DMA7: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA7)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_71, DMA_ADDR_72, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_81 mpeval(0xf8010000 + 0,16,16)
#define DMA_ADDR_82 mpeval(0xf8010000 + 64,16,16)
#define DMA_ADDR_83 mpeval(0xf8010000 + 128,16,16)
DMA8: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA8)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_81, DMA_ADDR_82, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_91 mpeval(0xf8012000 + 0,16,16)
#define DMA_ADDR_92 mpeval(0xf8012000 + 64,16,16)
#define DMA_ADDR_93 mpeval(0xf8012000 + 128,16,16)
DMA9: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA9)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_91, DMA_ADDR_92, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_101 mpeval(0xf8014000 + 0,16,16)
#define DMA_ADDR_102 mpeval(0xf8014000 + 64,16,16)
#define DMA_ADDR_103 mpeval(0xf8014000 + 128,16,16)
DMA10: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA10)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_101, DMA_ADDR_102, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_111 mpeval(0xf8016000 + 0,16,16)
#define DMA_ADDR_112 mpeval(0xf8016000 + 64,16,16)
#define DMA_ADDR_113 mpeval(0xf8016000 + 128,16,16)
DMA11: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA11)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_111, DMA_ADDR_112, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_121 mpeval(0xf8018000 + 0,16,16)
#define DMA_ADDR_122 mpeval(0xf8018000 + 64,16,16)
#define DMA_ADDR_123 mpeval(0xf8018000 + 128,16,16)
DMA12: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA12)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_121, DMA_ADDR_122, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_131 mpeval(0xf801a000 + 0,16,16)
#define DMA_ADDR_132 mpeval(0xf801a000 + 64,16,16)
#define DMA_ADDR_133 mpeval(0xf801a000 + 128,16,16)
DMA13: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA13)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_131, DMA_ADDR_132, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_141 mpeval(0xf801c000 + 0,16,16)
#define DMA_ADDR_142 mpeval(0xf801c000 + 64,16,16)
#define DMA_ADDR_143 mpeval(0xf801c000 + 128,16,16)
DMA14: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA14)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_141, DMA_ADDR_142, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_151 mpeval(0xf801e000 + 0,16,16)
#define DMA_ADDR_152 mpeval(0xf801e000 + 64,16,16)
#define DMA_ADDR_153 mpeval(0xf801e000 + 128,16,16)
DMA15: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA15)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_151, DMA_ADDR_152, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_161 mpeval(0xf8020000 + 0,16,16)
#define DMA_ADDR_162 mpeval(0xf8020000 + 64,16,16)
#define DMA_ADDR_163 mpeval(0xf8020000 + 128,16,16)
DMA16: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA16)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_161, DMA_ADDR_162, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_171 mpeval(0xf8022000 + 0,16,16)
#define DMA_ADDR_172 mpeval(0xf8022000 + 64,16,16)
#define DMA_ADDR_173 mpeval(0xf8022000 + 128,16,16)
DMA17: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA17)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_171, DMA_ADDR_172, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_181 mpeval(0xf8024000 + 0,16,16)
#define DMA_ADDR_182 mpeval(0xf8024000 + 64,16,16)
#define DMA_ADDR_183 mpeval(0xf8024000 + 128,16,16)
DMA18: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA18)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_181, DMA_ADDR_182, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_191 mpeval(0xf8026000 + 0,16,16)
#define DMA_ADDR_192 mpeval(0xf8026000 + 64,16,16)
#define DMA_ADDR_193 mpeval(0xf8026000 + 128,16,16)
DMA19: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA19)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_191, DMA_ADDR_192, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_201 mpeval(0xf8028000 + 0,16,16)
#define DMA_ADDR_202 mpeval(0xf8028000 + 64,16,16)
#define DMA_ADDR_203 mpeval(0xf8028000 + 128,16,16)
DMA20: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA20)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_201, DMA_ADDR_202, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_211 mpeval(0xf802a000 + 0,16,16)
#define DMA_ADDR_212 mpeval(0xf802a000 + 64,16,16)
#define DMA_ADDR_213 mpeval(0xf802a000 + 128,16,16)
DMA21: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA21)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_211, DMA_ADDR_212, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_221 mpeval(0xf802c000 + 0,16,16)
#define DMA_ADDR_222 mpeval(0xf802c000 + 64,16,16)
#define DMA_ADDR_223 mpeval(0xf802c000 + 128,16,16)
DMA22: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA22)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_221, DMA_ADDR_222, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_231 mpeval(0xf802e000 + 0,16,16)
#define DMA_ADDR_232 mpeval(0xf802e000 + 64,16,16)
#define DMA_ADDR_233 mpeval(0xf802e000 + 128,16,16)
DMA23: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA23)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_231, DMA_ADDR_232, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_241 mpeval(0xf8030000 + 0,16,16)
#define DMA_ADDR_242 mpeval(0xf8030000 + 64,16,16)
#define DMA_ADDR_243 mpeval(0xf8030000 + 128,16,16)
DMA24: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA24)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_241, DMA_ADDR_242, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_251 mpeval(0xf8032000 + 0,16,16)
#define DMA_ADDR_252 mpeval(0xf8032000 + 64,16,16)
#define DMA_ADDR_253 mpeval(0xf8032000 + 128,16,16)
DMA25: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA25)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_251, DMA_ADDR_252, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_261 mpeval(0xf8034000 + 0,16,16)
#define DMA_ADDR_262 mpeval(0xf8034000 + 64,16,16)
#define DMA_ADDR_263 mpeval(0xf8034000 + 128,16,16)
DMA26: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA26)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_261, DMA_ADDR_262, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_271 mpeval(0xf8036000 + 0,16,16)
#define DMA_ADDR_272 mpeval(0xf8036000 + 64,16,16)
#define DMA_ADDR_273 mpeval(0xf8036000 + 128,16,16)
DMA27: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA27)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_271, DMA_ADDR_272, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_281 mpeval(0xf8038000 + 0,16,16)
#define DMA_ADDR_282 mpeval(0xf8038000 + 64,16,16)
#define DMA_ADDR_283 mpeval(0xf8038000 + 128,16,16)
DMA28: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA28)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_281, DMA_ADDR_282, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_291 mpeval(0xf803a000 + 0,16,16)
#define DMA_ADDR_292 mpeval(0xf803a000 + 64,16,16)
#define DMA_ADDR_293 mpeval(0xf803a000 + 128,16,16)
DMA29: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA29)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_291, DMA_ADDR_292, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_301 mpeval(0xf803c000 + 0,16,16)
#define DMA_ADDR_302 mpeval(0xf803c000 + 64,16,16)
#define DMA_ADDR_303 mpeval(0xf803c000 + 128,16,16)
DMA30: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA30)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_301, DMA_ADDR_302, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_311 mpeval(0xf803e000 + 0,16,16)
#define DMA_ADDR_312 mpeval(0xf803e000 + 64,16,16)
#define DMA_ADDR_313 mpeval(0xf803e000 + 128,16,16)
DMA31: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA31)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_311, DMA_ADDR_312, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_321 mpeval(0xf8040000 + 0,16,16)
#define DMA_ADDR_322 mpeval(0xf8040000 + 64,16,16)
#define DMA_ADDR_323 mpeval(0xf8040000 + 128,16,16)
DMA32: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA32)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_321, DMA_ADDR_322, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_331 mpeval(0xf8042000 + 0,16,16)
#define DMA_ADDR_332 mpeval(0xf8042000 + 64,16,16)
#define DMA_ADDR_333 mpeval(0xf8042000 + 128,16,16)
DMA33: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA33)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_331, DMA_ADDR_332, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_341 mpeval(0xf8044000 + 0,16,16)
#define DMA_ADDR_342 mpeval(0xf8044000 + 64,16,16)
#define DMA_ADDR_343 mpeval(0xf8044000 + 128,16,16)
DMA34: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA34)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_341, DMA_ADDR_342, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_351 mpeval(0xf8046000 + 0,16,16)
#define DMA_ADDR_352 mpeval(0xf8046000 + 64,16,16)
#define DMA_ADDR_353 mpeval(0xf8046000 + 128,16,16)
DMA35: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA35)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_351, DMA_ADDR_352, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_361 mpeval(0xf8048000 + 0,16,16)
#define DMA_ADDR_362 mpeval(0xf8048000 + 64,16,16)
#define DMA_ADDR_363 mpeval(0xf8048000 + 128,16,16)
DMA36: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA36)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_361, DMA_ADDR_362, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_371 mpeval(0xf804a000 + 0,16,16)
#define DMA_ADDR_372 mpeval(0xf804a000 + 64,16,16)
#define DMA_ADDR_373 mpeval(0xf804a000 + 128,16,16)
DMA37: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA37)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_371, DMA_ADDR_372, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_381 mpeval(0xf804c000 + 0,16,16)
#define DMA_ADDR_382 mpeval(0xf804c000 + 64,16,16)
#define DMA_ADDR_383 mpeval(0xf804c000 + 128,16,16)
DMA38: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA38)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_381, DMA_ADDR_382, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_391 mpeval(0xf804e000 + 0,16,16)
#define DMA_ADDR_392 mpeval(0xf804e000 + 64,16,16)
#define DMA_ADDR_393 mpeval(0xf804e000 + 128,16,16)
DMA39: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA39)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_391, DMA_ADDR_392, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_401 mpeval(0xf8050000 + 0,16,16)
#define DMA_ADDR_402 mpeval(0xf8050000 + 64,16,16)
#define DMA_ADDR_403 mpeval(0xf8050000 + 128,16,16)
DMA40: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA40)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_401, DMA_ADDR_402, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_411 mpeval(0xf8052000 + 0,16,16)
#define DMA_ADDR_412 mpeval(0xf8052000 + 64,16,16)
#define DMA_ADDR_413 mpeval(0xf8052000 + 128,16,16)
DMA41: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA41)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_411, DMA_ADDR_412, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_421 mpeval(0xf8054000 + 0,16,16)
#define DMA_ADDR_422 mpeval(0xf8054000 + 64,16,16)
#define DMA_ADDR_423 mpeval(0xf8054000 + 128,16,16)
DMA42: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA42)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_421, DMA_ADDR_422, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_431 mpeval(0xf8056000 + 0,16,16)
#define DMA_ADDR_432 mpeval(0xf8056000 + 64,16,16)
#define DMA_ADDR_433 mpeval(0xf8056000 + 128,16,16)
DMA43: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA43)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_431, DMA_ADDR_432, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_441 mpeval(0xf8058000 + 0,16,16)
#define DMA_ADDR_442 mpeval(0xf8058000 + 64,16,16)
#define DMA_ADDR_443 mpeval(0xf8058000 + 128,16,16)
DMA44: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA44)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_441, DMA_ADDR_442, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_451 mpeval(0xf805a000 + 0,16,16)
#define DMA_ADDR_452 mpeval(0xf805a000 + 64,16,16)
#define DMA_ADDR_453 mpeval(0xf805a000 + 128,16,16)
DMA45: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA45)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_451, DMA_ADDR_452, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_461 mpeval(0xf805c000 + 0,16,16)
#define DMA_ADDR_462 mpeval(0xf805c000 + 64,16,16)
#define DMA_ADDR_463 mpeval(0xf805c000 + 128,16,16)
DMA46: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA46)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_461, DMA_ADDR_462, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_471 mpeval(0xf805e000 + 0,16,16)
#define DMA_ADDR_472 mpeval(0xf805e000 + 64,16,16)
#define DMA_ADDR_473 mpeval(0xf805e000 + 128,16,16)
DMA47: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA47)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_471, DMA_ADDR_472, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_481 mpeval(0xf8060000 + 0,16,16)
#define DMA_ADDR_482 mpeval(0xf8060000 + 64,16,16)
#define DMA_ADDR_483 mpeval(0xf8060000 + 128,16,16)
DMA48: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA48)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_481, DMA_ADDR_482, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_491 mpeval(0xf8062000 + 0,16,16)
#define DMA_ADDR_492 mpeval(0xf8062000 + 64,16,16)
#define DMA_ADDR_493 mpeval(0xf8062000 + 128,16,16)
DMA49: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA49)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_491, DMA_ADDR_492, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_501 mpeval(0xf8064000 + 0,16,16)
#define DMA_ADDR_502 mpeval(0xf8064000 + 64,16,16)
#define DMA_ADDR_503 mpeval(0xf8064000 + 128,16,16)
DMA50: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA50)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_501, DMA_ADDR_502, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_511 mpeval(0xf8066000 + 0,16,16)
#define DMA_ADDR_512 mpeval(0xf8066000 + 64,16,16)
#define DMA_ADDR_513 mpeval(0xf8066000 + 128,16,16)
DMA51: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA51)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_511, DMA_ADDR_512, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_521 mpeval(0xf8068000 + 0,16,16)
#define DMA_ADDR_522 mpeval(0xf8068000 + 64,16,16)
#define DMA_ADDR_523 mpeval(0xf8068000 + 128,16,16)
DMA52: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA52)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_521, DMA_ADDR_522, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_531 mpeval(0xf806a000 + 0,16,16)
#define DMA_ADDR_532 mpeval(0xf806a000 + 64,16,16)
#define DMA_ADDR_533 mpeval(0xf806a000 + 128,16,16)
DMA53: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA53)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_531, DMA_ADDR_532, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_541 mpeval(0xf806c000 + 0,16,16)
#define DMA_ADDR_542 mpeval(0xf806c000 + 64,16,16)
#define DMA_ADDR_543 mpeval(0xf806c000 + 128,16,16)
DMA54: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA54)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_541, DMA_ADDR_542, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_551 mpeval(0xf806e000 + 0,16,16)
#define DMA_ADDR_552 mpeval(0xf806e000 + 64,16,16)
#define DMA_ADDR_553 mpeval(0xf806e000 + 128,16,16)
DMA55: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA55)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_551, DMA_ADDR_552, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_561 mpeval(0xf8070000 + 0,16,16)
#define DMA_ADDR_562 mpeval(0xf8070000 + 64,16,16)
#define DMA_ADDR_563 mpeval(0xf8070000 + 128,16,16)
DMA56: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA56)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_561, DMA_ADDR_562, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_571 mpeval(0xf8072000 + 0,16,16)
#define DMA_ADDR_572 mpeval(0xf8072000 + 64,16,16)
#define DMA_ADDR_573 mpeval(0xf8072000 + 128,16,16)
DMA57: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA57)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_571, DMA_ADDR_572, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_581 mpeval(0xf8074000 + 0,16,16)
#define DMA_ADDR_582 mpeval(0xf8074000 + 64,16,16)
#define DMA_ADDR_583 mpeval(0xf8074000 + 128,16,16)
DMA58: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA58)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_581, DMA_ADDR_582, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_591 mpeval(0xf8076000 + 0,16,16)
#define DMA_ADDR_592 mpeval(0xf8076000 + 64,16,16)
#define DMA_ADDR_593 mpeval(0xf8076000 + 128,16,16)
DMA59: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA59)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_591, DMA_ADDR_592, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_601 mpeval(0xf8078000 + 0,16,16)
#define DMA_ADDR_602 mpeval(0xf8078000 + 64,16,16)
#define DMA_ADDR_603 mpeval(0xf8078000 + 128,16,16)
DMA60: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA60)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_601, DMA_ADDR_602, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_611 mpeval(0xf807a000 + 0,16,16)
#define DMA_ADDR_612 mpeval(0xf807a000 + 64,16,16)
#define DMA_ADDR_613 mpeval(0xf807a000 + 128,16,16)
DMA61: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA61)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_611, DMA_ADDR_612, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_621 mpeval(0xf807c000 + 0,16,16)
#define DMA_ADDR_622 mpeval(0xf807c000 + 64,16,16)
#define DMA_ADDR_623 mpeval(0xf807c000 + 128,16,16)
DMA62: nop
! $EV trig_pc_d(1,@VA(.MAIN.DMA62)) -> EnablePCIeIgCmd("DMAWR", DMA_ADDR_621, DMA_ADDR_622, "64'h100",1)
	...
	ldx  [%g2 + 192], %g6
	add  %g2, %g3, %g2
#define DMA_ADDR_631 mpeval(0xf807e000 + 0,16,16)
#define DMA_ADDR_632 mpeval(0xf807e000 + 64,16,16)
#define DMA_ADDR_633 mpeval(0xf807e000 + 128,16,16)
DMA63: nop
...
.data
!!	.skip 511*1024*8
	.skip 0x3e0000		!!! (0xf800_0000 / 0x2000) * 8
	init_mem(0x00000000f8000003, 1024, 8, +, 0, +, 0x0000000000002000)
