...
* 
* OpenSPARC T2 Processor File: PCIeDMAWrAdr32.s
...
#define DMA_ADDR_1		   mpeval(DMA_DATA_ADDR + 0*64, 16, 16)
#define DMA_ADDR_2		   mpeval(DMA_DATA_ADDR + 1*64, 16, 16)
#define DMA_ADDR_3		   mpeval(DMA_DATA_ADDR + 2*64, 16, 16)
#define DMA_ADDR_4		   mpeval(DMA_DATA_ADDR + 3*64, 16, 16)
#define DMA_ADDR_5		   mpeval(DMA_DATA_ADDR + 4*64, 16, 16)
#define DMA_ADDR_6		   mpeval(DMA_DATA_ADDR + 5*64, 16, 16)
#define DMA_ADDR_7		   mpeval(DMA_DATA_ADDR + 6*64, 16, 16)
#define DMA_ADDR_8		   mpeval(DMA_DATA_ADDR + 7*64, 16, 16)
#define DMA_ADDR_9		   mpeval(DMA_DATA_ADDR + 8*64, 16, 16)
#define DMA_ADDR_10		   mpeval(DMA_DATA_ADDR + 10*64, 16, 16)
#define DMA_ADDR_11		   mpeval(DMA_DATA_ADDR + 8*256, 16, 16)
#define DMA_ADDR_12		   mpeval(DMA_DATA_ADDR + 9*256, 16, 16)
#define DMA_ADDR_13		   mpeval(DMA_DATA_ADDR + 10*256, 16, 16)
#define DMA_ADDR_14		   mpeval(DMA_DATA_ADDR + 12*256, 16, 16)
#define DMA_ADDR_15		   mpeval(DMA_DATA_ADDR + 16*256, 16, 16)
#define DMA_ADDR_16		   mpeval(DMA_DATA_ADDR + 24*256, 16, 16)
