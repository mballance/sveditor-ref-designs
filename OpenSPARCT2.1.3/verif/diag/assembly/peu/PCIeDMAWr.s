...
* 
* OpenSPARC T2 Processor File: PCIeDMAWr.s
...
XmtUsrEvnt2:  nop; 
	! $EV trig_pc_d(1, @VA(.MAIN.XmtUsrEvnt2)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR2, DMA_DATA_BYP_ADDR2, "64'h40", 1 )
	ldx	[%g2], %g3
	ldx	[%g2], %g3
	ldx	[%g2], %g3
	ldx	[%g2], %g3
...
XmtUsrEvnt3:  nop; 
	! $EV trig_pc_d(1, @VA(.MAIN.XmtUsrEvnt3)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR3, DMA_DATA_BYP_ADDR3, "64'h80", 1 )
	ldx	[%g2], %g3
	ldx	[%g2], %g3
	ldx	[%g2], %g3
	ldx	[%g2], %g3
