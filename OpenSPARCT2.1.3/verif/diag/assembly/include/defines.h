...
* 
* OpenSPARC T2 Processor File: defines.h
...
#undef TSB_SEARCH_BURST
#define TSB_SEARCH_BURST      0x1
#endif
#ifdef TSB_SEARCH_PREDICTION
#undef TSB_SEARCH_PREDICTION
#define TSB_SEARCH_PREDICTION 0x2
#endif

#ifndef MMU_REAL_RANGE_0
#define MMU_REAL_RANGE_0 0x800007fff8000000
#endif

#ifndef MMU_REAL_RANGE_1
#define MMU_REAL_RANGE_1 0x80007ffff8004000
#endif

#ifndef MMU_REAL_RANGE_2
#define MMU_REAL_RANGE_2 0x8007fffff8040000
#endif

#ifndef MMU_REAL_RANGE_3
#define MMU_REAL_RANGE_3 0x807ffffff8400000
#endif
...
#include "cache_assocdis.h"
#endif /*__HBOOT_S__ */

#ifndef __HBOOT_S__
#define EXIT_GOOD                   setx good_trap, %g1, %g2; jmp %g2; nop
#define EXIT_BAD                    setx bad_trap, %g1, %g2; jmp %g2; nop
#ifndef DIAG_DATA_AREA
#define DIAG_DATA_AREA              0x0000000000080000
#endif
#ifndef DIAG_TEXT_AREA
#define DIAG_TEXT_AREA              0x0000000020000000
#endif

#ifndef HTBA
#define HTBA                        0x0000000000000000
#endif /* HTBA */
#endif /*__HBOOT_S__ */

/* obsolete, use ta T_RD_THID */
/*#define TID_ADDR                    0x9a00000000 */
/* ta T_RD_THID to get id in %o1 */
#define T_RD_THID				    0x2e


#ifdef __HBOOT_S__

#define EXIT_GOOD                   nop; nop; ta T_GOOD_TRAP; nop; nop
#define EXIT_BAD                    nop; nop; ta T_BAD_TRAP ; nop; nop

#ifdef CMP_THREAD_START 
#if (CMP_THREAD_START == ALL)
#undef CMP_THREAD_START
#ifdef ALL_THREADS
#define CMP_THREAD_START ALL_THREADS
#else
#define CMP_THREAD_START 0xffffffffffffffff
#endif
! __FILE__: Setting THREAD START to CMP_THREAD START (CMP_THREAD_START)
#endif
#if (CMP_THREAD_START != 1)
#define THREAD_MASK CMP_THREAD_START
! __FILE__: Setting THREAD MASK (THREAD_MASK) to CMP_START THREAD (CMP_THREAD_START)
#else
! __FILE__: Preserving THREAD MASK  (THREAD_MASK) for CMP_START THREAD
#endif
#endif

#if (defined THREAD_MASK && !defined THREAD_COUNT)
...
! __FILE__: Defining THREAD COUNT (THREAD_COUNT) from THREAD MASK (THREAD_MASK)

#elif (!defined THREAD_MASK)
...
#elif (THREAD_COUNT == 33)
#define THREAD_MASK 0x0001ffffffff
#elif (THREAD_COUNT == 34)
#define THREAD_MASK 0x0003ffffffff
#elif (THREAD_COUNT == 35)
#define THREAD_MASK 0x0007ffffffff
#elif (THREAD_COUNT == 36)
#define THREAD_MASK 0x000fffffffff
#elif (THREAD_COUNT == 37)
#define THREAD_MASK 0x001fffffffff
#elif (THREAD_COUNT == 38)
#define THREAD_MASK 0x003fffffffff
#elif (THREAD_COUNT == 39)
#define THREAD_MASK 0x007fffffffff
#elif (THREAD_COUNT == 40)
#define THREAD_MASK 0x00ffffffffff
#elif (THREAD_COUNT == 41)
#define THREAD_MASK 0x01ffffffffff
#elif (THREAD_COUNT == 42)
#define THREAD_MASK 0x03ffffffffff
#elif (THREAD_COUNT == 43)
#define THREAD_MASK 0x07ffffffffff
#elif (THREAD_COUNT == 44)
#define THREAD_MASK 0x0fffffffffff
#elif (THREAD_COUNT == 45)
#define THREAD_MASK 0x1fffffffffff
#elif (THREAD_COUNT == 46)
#define THREAD_MASK 0x3fffffffffff
#elif (THREAD_COUNT == 47)
#define THREAD_MASK 0x7fffffffffff
#elif (THREAD_COUNT == 48)
#define THREAD_MASK 0xffffffffffff
#elif (THREAD_COUNT == 49)
#define THREAD_MASK 0x0001ffffffffffff
#elif (THREAD_COUNT == 50)
#define THREAD_MASK 0x0003ffffffffffff
#elif (THREAD_COUNT == 51)
#define THREAD_MASK 0x0007ffffffffffff
#elif (THREAD_COUNT == 52)
#define THREAD_MASK 0x000fffffffffffff
#elif (THREAD_COUNT == 53)
#define THREAD_MASK 0x001fffffffffffff
#elif (THREAD_COUNT == 54)
#define THREAD_MASK 0x003fffffffffffff
#elif (THREAD_COUNT == 55)
#define THREAD_MASK 0x007fffffffffffff
#elif (THREAD_COUNT == 56)
#define THREAD_MASK 0x00ffffffffffffff
#elif (THREAD_COUNT == 57)
#define THREAD_MASK 0x01ffffffffffffff
#elif (THREAD_COUNT == 58)
#define THREAD_MASK 0x03ffffffffffffff
#elif (THREAD_COUNT == 59)
#define THREAD_MASK 0x07ffffffffffffff
#elif (THREAD_COUNT == 60)
#define THREAD_MASK 0x0fffffffffffffff
#elif (THREAD_COUNT == 61)
#define THREAD_MASK 0x1fffffffffffffff
#elif (THREAD_COUNT == 62)
#define THREAD_MASK 0x3fffffffffffffff
#elif (THREAD_COUNT == 63)
#define THREAD_MASK 0x7fffffffffffffff
#elif (THREAD_COUNT == 64)
#define THREAD_MASK 0xffffffffffffffff
#endif

! __FILE__: Defining THREAD MASK (THREAD_MASK) from THREAD COUNT (THREAD_COUNT)
#endif
! Address space
!------------------------------------------
! SECTION	VA		RA/PA
...
#define PRIV_RESET_VA		0x134000
#endif 

#ifndef PRIV_RESET_RA
#define PRIV_RESET_RA		0x134000
#endif 
...
#ifndef USER_HEAP_DATA_VA
# define USER_HEAP_DATA_VA	0x68020000
#endif

#ifndef USER_HEAP_DATA_RA
# define USER_HEAP_DATA_RA	0x0178020000
#endif
...
#define MAIN_BASE_DATA_VA	0x60040000
#endif
...
define(cregs_tick_r64, `0x'dnl
mpeval(CREGS_TICK, 16))

#ifndef CREGS_STICK_NPT
#define CREGS_STICK_NPT 1
#endif
...
define(cregs_stick_r64, eval(CREGS_STICK))dnl
...
#ifndef	CREGS_TSTATE_GL
#define CREGS_TSTATE_GL 0
#endif	
...
define(cregs_tstate_r64, `0x'dnl
mpeval(CREGS_TSTATE, 16))

#ifdef L2_OFF
#define DISABLE_ALL_CACHES 1
#define L2_REG_PROG 1
#endif

#ifdef  DISABLE_ALL_CACHES
#define CREGS_L2_CTL_REG_DIS 1
...
#ifndef NOSPEC_EN
#ifndef	CREGS_LSU_CTL_REG_SE
#define CREGS_LSU_CTL_REG_SE 1
#endif	
#else
#define CREGS_LSU_CTL_REG_SE 0
#endif
...
#define CREGS_LSU_CTL_REG (\
    ...
    (CREGS_LSU_CTL_REG_DM << 3) | (CREGS_LSU_CTL_REG_SE << 4) | (CREGS_LSU_CTL_REG_VW << 21) |\
    (CREGS_LSU_CTL_REG_VR << 22) | (CREGS_LSU_CTL_REG_PW << 23) | (CREGS_LSU_CTL_REG_PR << 24) |\
    (CREGS_LSU_CTL_REG_VM << 25) | (CREGS_LSU_CTL_REG_PM << 33))

#endif	

define(cregs_lsu_ctl_reg_r64, eval(CREGS_LSU_CTL_REG))dnl
...
/**************************************************************************/
#ifndef	CREGS_L2_CTL_REG_ERRORSTEER
#define CREGS_L2_CTL_REG_ERRORSTEER 0
#endif	

#ifndef	CREGS_L2_CTL_REG_SCRUBINTERVAL
#define CREGS_L2_CTL_REG_SCRUBINTERVAL 0
#endif	

#ifndef	CREGS_L2_CTL_REG_SCRUBENABLE
#define CREGS_L2_CTL_REG_SCRUBENABLE 0
#endif	
...
#define CREGS_L2_CTL_REG (\
	CREGS_L2_CTL_REG_DIS | (CREGS_L2_CTL_REG_ASSOCDIS << 1) |\
	(CREGS_L2_CTL_REG_SCRUBENABLE << 2) |\
	(CREGS_L2_CTL_REG_SCRUBINTERVAL << 3) |\
	(CREGS_L2_CTL_REG_ERRORSTEER << 15) )
#endif

define(cregs_l2_ctl_reg_r64, eval(CREGS_L2_CTL_REG))dnl

/**************************************************************************/
#ifndef	CREGS_L2_ERR_EN_REG_CEEN
#define CREGS_L2_ERR_EN_REG_CEEN 1
#endif	

#ifndef	CREGS_L2_ERR_EN_REG_NCEEN
#define CREGS_L2_ERR_EN_REG_NCEEN 1
#endif	

#ifndef CREGS_L2_ERR_EN_REG
#define CREGS_L2_ERR_EN_REG (\
	CREGS_L2_ERR_EN_REG_CEEN | (CREGS_L2_ERR_EN_REG_NCEEN << 1))
#endif

define(cregs_l2_error_en_reg_r64, eval(CREGS_L2_ERR_EN_REG))dnl

#ifndef CREGS_TICK_ENABLE
#define CREGS_TICK_ENABLE 1
#endif

#ifndef CREGS_PWRMGMT
#define CREGS_PWRMGMT 0xffff
#endif

#ifndef CREGS_PCR_REG_OV1
#define CREGS_PCR_REG_OV1 0
#endif

#ifndef CREGS_PCR_REG_SL1
#define CREGS_PCR_REG_SL1 2
#endif

#ifndef CREGS_PCR_REG_MASK1
#define CREGS_PCR_REG_MASK1 0x3f
#endif

#ifndef CREGS_PCR_REG_OV0
#define CREGS_PCR_REG_OV0 0
#endif

#ifndef CREGS_PCR_REG_SL0
#define CREGS_PCR_REG_SL0 2
#endif

#ifndef CREGS_PCR_REG_MASK0
#define CREGS_PCR_REG_MASK0 0x3f
#endif

#ifndef CREGS_PCR_REG_TOE
#define CREGS_PCR_REG_TOE 0
#endif

#ifndef CREGS_PCR_REG_HT
#define CREGS_PCR_REG_HT 1
#endif

#ifndef CREGS_PCR_REG_UT
#define CREGS_PCR_REG_UT 1
#endif

#ifndef CREGS_PCR_REG_ST
#define CREGS_PCR_REG_ST 1
#endif


#ifndef CREGS_PCR_REG_PRIV
#define CREGS_PCR_REG_PRIV 0
#endif


#ifndef CREGS_PCR_REG
#define CREGS_PCR_REG (\
        (CREGS_PCR_REG_OV1 << 31) | (CREGS_PCR_REG_SL1 << 27) | \
        (CREGS_PCR_REG_MASK1 << 19) | (CREGS_PCR_REG_OV0 << 18) | \
        (CREGS_PCR_REG_SL0 << 14) | (CREGS_PCR_REG_MASK0 << 6) |\
        (CREGS_PCR_REG_TOE << 4) | (CREGS_PCR_REG_HT << 3) | \
        (CREGS_PCR_REG_UT << 2) | (CREGS_PCR_REG_ST << 1) | \
        (CREGS_PCR_REG_PRIV) )
#endif

define(cregs_pcr_reg, eval(CREGS_PCR_REG & 0x7ffbffff))dnl
...
#endif							
#ifndef	PCONTEXT1
#define PCONTEXT1	0x41
#endif	
#ifndef	SCONTEXT1
#define SCONTEXT1	0x51
#endif							
...
#define T_IAE_Privilege_Violation   	0x008
#define T_Instruction_Access_Mmu_Miss	0x009
#define T_Instruction_Access_Error		0x00a
#define T_IAE_Unauth_Access			0x00b
#define T_IAE_Nfo_Page  			0x00c
#define T_Instruction_Address_Range  0x00d
...
#define T_DAE_Invalid_Asi			0x014
#define T_DAE_Privilege_Violation   0x015
#define T_DAE_Nc_Page    			0x016
#define T_DAE_Nfo_Page   			0x017
...
#define T_Instruction_Invalid_TSB_Entry	0x02a
#define T_Data_Invalid_TSB_Entry	0x02b
#define T_Reserved_Vec_2c			0x02c
#define T_Reserved_Vec_2d			0x02d
#define T_Mem_Address_Range         0x02e
#define T_Reserved_Vec_2f			0x02f

#define T_Data_Access_Exception	    0x030
#define T_DAE_So_Page          		0x030
...
#define T_Control_Word_Queue_Interrupt	0x03c
#define T_Modular_Arithmetic_Interrupt	0x03d
#define T_Reserved_Vec_3e			0x03e
#define T_Reserved_Vec_3f			0x03f
#define T_Sw_Recoverable_Error		0x040
...
#define T_Hw_Corrected_Error		0x063
...
#define T_Instruction_Access_MMU_Error	0x071
#define T_Data_Access_MMU_Error	    0x072
#define T_Control_Transfer_Instr	0x074
#define T_Instruction_VA_Watchpoint	0x075
#define T_Instruction_Breakpoint    0x076
#define T_Cpu_Mondo_Trap            0x07c
#define T_Dev_Mondo_Trap            0x07d
...
!!
!! T_HGOOD_TRAP               (HT_0x1a0)           (HT_0x1a0) N/A
!! T_HBAD_TRAP                (HT_0x1a1)           (HT_0x1a1) N/A
!!
...
#define T_HGOOD_TRAP                            0xa0
#define T_HBAD_TRAP                             0xa1
...
#ifdef ENABLE_T0_Instruction_Access_MMU_Miss_0x09
...
#ifdef ENABLE_T0_VA_Watchpoint_0x62		
...
#ifdef ENABLE_T0_Control_Transfer_Instr_0x74		
#define E0_0x74 MAX_TRAP_CNT
#else
#define E0_0x74 0
#endif

#ifdef ENABLE_T0_Instruction_VA_Watchpoint_0x75		
...
#ifdef ENABLE_T0_Cpu_Mondo_Trap_0x7c		
#define E0_0x7c MAX_TRAP_CNT
#else
#define E0_0x7c 0
#endif

#ifdef ENABLE_T0_Dev_Mondo_Trap_0x7d		
#define E0_0x7d MAX_TRAP_CNT
#else
#define E0_0x7d 0
#endif

#ifdef ENABLE_T0_Resumable_Error_0x7e		
...
#ifdef ENABLE_T1_Privileged_Opcode_0x11		
...
#ifdef ENABLE_T1_Fp_Disabled_0x20		
#define E1_0x20 MAX_TRAP_CNT
#else
#define E1_0x20 0
#endif

#ifdef ENABLE_T1_Fp_Exception_Ieee_754_0x21		
#define E1_0x21 MAX_TRAP_CNT
#else
#define E1_0x21 0
#endif

#ifdef ENABLE_T1_Fp_Exception_Other_0x22		
#define E1_0x22 MAX_TRAP_CNT
#else
#define E1_0x22 0
#endif

#ifdef ENABLE_T1_Tag_Overflow_0x23		
#define E1_0x23 MAX_TRAP_CNT
#else
#define E1_0x23 0
#endif

#ifdef ENABLE_T1_Clean_Window_0x24		
#define E1_0x24 MAX_TRAP_CNT
#else
#define E1_0x24 0
#endif

#ifdef ENABLE_T1_Clean_Window_0x25		
#define E1_0x25 MAX_TRAP_CNT
#else
#define E1_0x25 0
#endif

#ifdef ENABLE_T1_Clean_Window_0x26		
#define E1_0x26 MAX_TRAP_CNT
#else
#define E1_0x26 0
#endif

#ifdef ENABLE_T1_Clean_Window_0x27		
#define E1_0x27 MAX_TRAP_CNT
#else
#define E1_0x27 0
#endif

#ifdef ENABLE_T1_Division_By_Zero_0x28		
...
#ifdef ENABLE_T1_Interrupt_Level_1_0x41		
#define E1_0x41 MAX_TRAP_CNT
#else
#define E1_0x41 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_2_0x42		
#define E1_0x42 MAX_TRAP_CNT
#else
#define E1_0x42 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_3_0x43		
#define E1_0x43 MAX_TRAP_CNT
#else
#define E1_0x43 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_4_0x44		
#define E1_0x44 MAX_TRAP_CNT
#else
#define E1_0x44 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_5_0x45		
#define E1_0x45 MAX_TRAP_CNT
#else
#define E1_0x45 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_6_0x46		
#define E1_0x46 MAX_TRAP_CNT
#else
#define E1_0x46 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_7_0x47		
#define E1_0x47 MAX_TRAP_CNT
#else
#define E1_0x47 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_8_0x48		
#define E1_0x48 MAX_TRAP_CNT
#else
#define E1_0x48 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_9_0x49		
#define E1_0x49 MAX_TRAP_CNT
#else
#define E1_0x49 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_10_0x4a		
#define E1_0x4a MAX_TRAP_CNT
#else
#define E1_0x4a 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_11_0x4b		
#define E1_0x4b MAX_TRAP_CNT
#else
#define E1_0x4b 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_12_0x4c		
#define E1_0x4c MAX_TRAP_CNT
#else
#define E1_0x4c 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_13_0x4d		
#define E1_0x4d MAX_TRAP_CNT
#else
#define E1_0x4d 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_14_0x4e		
#define E1_0x4e MAX_TRAP_CNT
#else
#define E1_0x4e 0
#endif

#ifdef ENABLE_T1_Interrupt_Level_15_0x4f		
...
#ifdef ENABLE_T1_VA_Watchpoint_0x62		
...
#ifdef ENABLE_T1_Control_Transfer_Instr_0x74		
#define E1_0x74 MAX_TRAP_CNT
#else
#define E1_0x74 0
#endif

#ifdef ENABLE_T1_Instruction_VA_Watchpoint_0x75		
...
#ifdef ENABLE_T1_Cpu_Mondo_Trap_0x7c		
#define E1_0x7c MAX_TRAP_CNT
#else
#define E1_0x7c 0
#endif

#ifdef ENABLE_T1_Dev_Mondo_Trap_0x7d		
#define E1_0x7d MAX_TRAP_CNT
#else
#define E1_0x7d 0
#endif

#ifdef ENABLE_T1_Resumable_Error_0x7e		
...
#ifdef ENABLE_T1_Window_Spill_0_Normal_0x80		
...
#ifdef ENABLE_T1_Window_Spill_1_Normal_0x84		
...
#ifdef ENABLE_T1_Window_Spill_2_Normal_0x88		
...
#ifdef ENABLE_T1_Window_Spill_3_Normal_0x8c		
...
#ifdef ENABLE_T1_Window_Spill_4_Normal_0x90		
...
#ifdef ENABLE_T1_Window_Spill_5_Normal_0x94		
...
#ifdef ENABLE_T1_Window_Spill_6_Normal_0x98		
...
#ifdef ENABLE_T1_Window_Spill_7_Normal_0x9c		
...
#ifdef ENABLE_T1_Window_Spill_0_Other_0xa0		
...
#ifdef ENABLE_T1_Window_Spill_1_Other_0xa4		
...
#ifdef ENABLE_T1_Window_Spill_2_Other_0xa8		
...
#ifdef ENABLE_T1_Window_Spill_3_Other_0xac		
...
#ifdef ENABLE_T1_Window_Spill_4_Other_0xb0		
...
#ifdef ENABLE_T1_Window_Spill_5_Other_0xb4		
...
#ifdef ENABLE_T1_Window_Spill_6_Other_0xb8		
...
#ifdef ENABLE_T1_Window_Spill_7_Other_0xbc		
...
#ifdef ENABLE_T1_Window_Fill_0_Normal_0xc0		
...
#ifdef ENABLE_T1_Window_Fill_1_Normal_0xc4		
...
#ifdef ENABLE_T1_Window_Fill_2_Normal_0xc8		
...
#ifdef ENABLE_T1_Window_Fill_3_Normal_0xcc		
...
#ifdef ENABLE_T1_Window_Fill_4_Normal_0xd0		
...
#ifdef ENABLE_T1_Window_Fill_5_Normal_0xd4		
...
#ifdef ENABLE_T1_Window_Fill_6_Normal_0xd8		
...
#ifdef ENABLE_T1_Window_Fill_7_Normal_0xdc		
...
#ifdef ENABLE_T1_Window_Fill_0_Other_0xe0		
...
#ifdef ENABLE_T1_Window_Fill_1_Other_0xe4		
...
#ifdef ENABLE_T1_Window_Fill_2_Other_0xe8		
...
#ifdef ENABLE_T1_Window_Fill_3_Other_0xec		
...
#ifdef ENABLE_T1_Window_Fill_4_Other_0xf0		
...
#ifdef ENABLE_T1_Window_Fill_5_Other_0xf4		
...
#ifdef ENABLE_T1_Window_Fill_6_Other_0xf8		
...
#ifdef ENABLE_T1_Window_Fill_7_Other_0xfc		
...
#ifdef ENABLE_HT0_Watchdog_Reset_0x07		
#define HE0_0x02 MAX_TRAP_CNT
#else
#define HE0_0x02 0
#endif

#ifdef ENABLE_HT0_Externally_Initiated_Reset_0x03		
#define HE0_0x03 MAX_TRAP_CNT
#else
#define HE0_0x03 0
#endif

#ifdef ENABLE_HT0_Software_Initiated_Reset_0x04		
...
#ifdef ENABLE_HT0_Store_Error_0x07		
#define HE0_0x07 MAX_TRAP_CNT
#else
#define HE0_0x07 0
#endif

#ifdef ENABLE_HT0_IAE_Privilege_Violation_0x08
#define HE0_0x08 MAX_TRAP_CNT
#else
#define HE0_0x08 0
#endif

#ifdef ENABLE_HT0_Instruction_Access_MMU_Miss_0x09
...
#ifdef ENABLE_HT0_IAE_Unauth_Access_0x0b		
#define HE0_0x0b MAX_TRAP_CNT
#else
#define HE0_0x0b 0
#endif

#ifdef ENABLE_HT0_IAE_Nfo_Page_0x0c		
#define HE0_0x0c MAX_TRAP_CNT
#else
#define HE0_0x0c 0
#endif

#ifdef ENABLE_HT0_Instruction_Address_Range_0x0d		
...
#ifdef ENABLE_HT0_DAE_Invalid_Asi_0x14		
#define HE0_0x14 MAX_TRAP_CNT
#else
#define HE0_0x14 0
#endif

#ifdef ENABLE_HT0_DAE_Privilege_Violation_0x15		
#define HE0_0x15 MAX_TRAP_CNT
#else
#define HE0_0x15 0
#endif

#ifdef ENABLE_HT0_DAE_Nc_Page_0x16		
#define HE0_0x16 MAX_TRAP_CNT
#else
#define HE0_0x16 0
#endif

#ifdef ENABLE_HT0_DAE_Nfo_Page_0x17		
...
#ifdef ENABLE_HT0_Instruction_Invalid_TSB_Entry_0x2a		
#define HE0_0x2a MAX_TRAP_CNT
#else
#define HE0_0x2a 0
#endif

#ifdef ENABLE_HT0_Data_Invalid_TSB_Entry_0x2b		
...
#ifdef ENABLE_HT0_Mem_Address_Range_0x2e		
...
#ifdef ENABLE_HT0_DAE_so_page_0x30		
...
#ifdef ENABLE_HT0_Control_Word_Queue_Interrupt_0x3c		
#define HE0_0x3c MAX_TRAP_CNT
#else
#define HE0_0x3c 0
#endif

#ifdef ENABLE_HT0_Modular_Arithmetic_Interrupt_0x3d		
...
#ifdef ENABLE_HT0_Sw_Recoverable_Error_0x40		
...
#ifdef ENABLE_HT0_Hstick_Match_0x5e		
...
#ifdef ENABLE_HT0_PA_Watchpoint_0x61		
#define HE0_0x61 MAX_TRAP_CNT
#else
#define HE0_0x61 0
#endif

#ifdef ENABLE_HT0_VA_Watchpoint_0x62		
#define HE0_0x62 MAX_TRAP_CNT
#else
#define HE0_0x62 0
#endif

#ifdef ENABLE_HT0_Hw_Corrected_Error_0x63		
...
#ifdef ENABLE_HT0_Instruction_Access_MMU_Error_0x71		
#define HE0_0x71 MAX_TRAP_CNT
#else
#define HE0_0x71 0
#endif

#ifdef ENABLE_HT0_Data_Access_MMU_Error_0x72		
...
#ifdef ENABLE_HT0_Control_Transfer_Instr_0x74		
#define HE0_0x74 MAX_TRAP_CNT
#else
#define HE0_0x74 0
#endif

#ifdef ENABLE_HT0_Instruction_VA_Watchpoint_0x75		
#define HE0_0x75 MAX_TRAP_CNT
#else
#define HE0_0x75 0
#endif

#ifdef ENABLE_HT0_Instruction_Breakpoint_0x76		
...
#ifdef ENABLE_HT1_Privileged_Opcode_0x11		
...
#ifdef ENABLE_HT1_Fp_Disabled_0x20		
#define HE1_0x20 MAX_TRAP_CNT
#else
#define HE1_0x20 0
#endif

#ifdef ENABLE_HT1_Fp_Exception_Ieee_754_0x21		
#define HE1_0x21 MAX_TRAP_CNT
#else
#define HE1_0x21 0
#endif

#ifdef ENABLE_HT1_Fp_Exception_Other_0x22		
#define HE1_0x22 MAX_TRAP_CNT
#else
#define HE1_0x22 0
#endif

#ifdef ENABLE_HT1_Tag_Overflow_0x23		
#define HE1_0x23 MAX_TRAP_CNT
#else
#define HE1_0x23 0
#endif

#ifdef ENABLE_HT1_Clean_Window_0x24		
#define HE1_0x24 MAX_TRAP_CNT
#else
#define HE1_0x24 0
#endif

#ifdef ENABLE_HT1_Clean_Window_0x25		
#define HE1_0x25 MAX_TRAP_CNT
#else
#define HE1_0x25 0
#endif

#ifdef ENABLE_HT1_Clean_Window_0x26		
#define HE1_0x26 MAX_TRAP_CNT
#else
#define HE1_0x26 0
#endif

#ifdef ENABLE_HT1_Clean_Window_0x27		
#define HE1_0x27 MAX_TRAP_CNT
#else
#define HE1_0x27 0
#endif

#ifdef ENABLE_HT1_Division_By_Zero_0x28		
...
#ifdef ENABLE_HT1_Interrupt_Level_1_0x41		
#define HE1_0x41 MAX_TRAP_CNT
#else
#define HE1_0x41 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_2_0x42		
#define HE1_0x42 MAX_TRAP_CNT
#else
#define HE1_0x42 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_3_0x43		
#define HE1_0x43 MAX_TRAP_CNT
#else
#define HE1_0x43 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_4_0x44		
#define HE1_0x44 MAX_TRAP_CNT
#else
#define HE1_0x44 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_5_0x45		
#define HE1_0x45 MAX_TRAP_CNT
#else
#define HE1_0x45 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_6_0x46		
#define HE1_0x46 MAX_TRAP_CNT
#else
#define HE1_0x46 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_7_0x47		
#define HE1_0x47 MAX_TRAP_CNT
#else
#define HE1_0x47 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_8_0x48		
#define HE1_0x48 MAX_TRAP_CNT
#else
#define HE1_0x48 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_9_0x49		
#define HE1_0x49 MAX_TRAP_CNT
#else
#define HE1_0x49 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_10_0x4a		
#define HE1_0x4a MAX_TRAP_CNT
#else
#define HE1_0x4a 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_11_0x4b		
#define HE1_0x4b MAX_TRAP_CNT
#else
#define HE1_0x4b 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_12_0x4c		
#define HE1_0x4c MAX_TRAP_CNT
#else
#define HE1_0x4c 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_13_0x4d		
#define HE1_0x4d MAX_TRAP_CNT
#else
#define HE1_0x4d 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_14_0x4e		
#define HE1_0x4e MAX_TRAP_CNT
#else
#define HE1_0x4e 0
#endif

#ifdef ENABLE_HT1_Interrupt_Level_15_0x4f		
...
#ifdef ENABLE_HT1_VA_Watchpoint_0x62		
...
#ifdef ENABLE_HT1_Instruction_VA_Watchpoint_0x75		
...
#ifdef ENABLE_HT1_Cpu_Mondo_Trap_0x7c		
#define HE1_0x7c MAX_TRAP_CNT
#else
#define HE1_0x7c 0
#endif

#ifdef ENABLE_HT1_Dev_Mondo_Trap_0x7d		
#define HE1_0x7d MAX_TRAP_CNT
#else
#define HE1_0x7d 0
#endif

#ifdef ENABLE_HT1_Resumable_Error_0x7e		
...
#ifdef ENABLE_HT1_Window_Spill_0_Normal_0x80		
...
#ifdef ENABLE_HT1_Window_Spill_1_Normal_0x84		
...
#ifdef ENABLE_HT1_Window_Spill_2_Normal_0x88		
...
#ifdef ENABLE_HT1_Window_Spill_3_Normal_0x8c		
...
#ifdef ENABLE_HT1_Window_Spill_4_Normal_0x90		
...
#ifdef ENABLE_HT1_Window_Spill_5_Normal_0x94		
...
#ifdef ENABLE_HT1_Window_Spill_6_Normal_0x98		
...
#ifdef ENABLE_HT1_Window_Spill_7_Normal_0x9c		
...
#ifdef ENABLE_HT1_Window_Spill_0_Other_0xa0		
...
#ifdef ENABLE_HT1_Window_Spill_1_Other_0xa4		
...
#ifdef ENABLE_HT1_Window_Spill_2_Other_0xa8		
...
#ifdef ENABLE_HT1_Window_Spill_3_Other_0xac		
...
#ifdef ENABLE_HT1_Window_Spill_4_Other_0xb0		
...
#ifdef ENABLE_HT1_Window_Spill_5_Other_0xb4		
...
#ifdef ENABLE_HT1_Window_Spill_6_Other_0xb8		
...
#ifdef ENABLE_HT1_Window_Spill_7_Other_0xbc		
...
#ifdef ENABLE_HT1_Window_Fill_0_Normal_0xc0		
...
#ifdef ENABLE_HT1_Window_Fill_1_Normal_0xc4		
...
#ifdef ENABLE_HT1_Window_Fill_2_Normal_0xc8		
...
#ifdef ENABLE_HT1_Window_Fill_3_Normal_0xcc		
...
#ifdef ENABLE_HT1_Window_Fill_4_Normal_0xd0		
...
#ifdef ENABLE_HT1_Window_Fill_5_Normal_0xd4		
...
#ifdef ENABLE_HT1_Window_Fill_6_Normal_0xd8		
...
#ifdef ENABLE_HT1_Window_Fill_7_Normal_0xdc		
...
#ifdef ENABLE_HT1_Window_Fill_0_Other_0xe0		
...
#ifdef ENABLE_HT1_Window_Fill_1_Other_0xe4		
...
#ifdef ENABLE_HT1_Window_Fill_2_Other_0xe8		
...
#ifdef ENABLE_HT1_Window_Fill_3_Other_0xec		
...
#ifdef ENABLE_HT1_Window_Fill_4_Other_0xf0		
...
#ifdef ENABLE_HT1_Window_Fill_5_Other_0xf4		
...
#ifdef ENABLE_HT1_Window_Fill_6_Other_0xf8		
...
#ifdef ENABLE_HT1_Window_Fill_7_Other_0xfc		
