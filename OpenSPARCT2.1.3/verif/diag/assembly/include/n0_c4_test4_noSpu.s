...
main_th_32:
	TEST
	setx	t32_data_area, %g1, %l7
	setx	t32_blk_area,%g1,%g5;
	setx    0x5555555555555555, %g3, %g4

	!# Enable PMU to count instructions...
	setx	t32_t38_perf,%g3,%g6;
	ldx	[%g6],%g6;
	wr	%g0, %g0, %pic
	wr	%g6, %g0, %pcr
...
main_th_33:
	TEST
	setx	t33_data_area, %g1, %l7
	setx	t33_blk_area,%g1,%g5;
...
main_th_34:
	TEST
	setx	t34_data_area, %g1, %l7
	setx	t34_blk_area,%g1,%g5;
...
main_th_35:
	TEST
	setx	t35_data_area, %g1, %l7
	setx	t35_blk_area,%g1,%g5;
...
main_th_36:
	TEST
	setx	t36_data_area, %g1, %l7
	setx	t36_blk_area,%g1,%g5;
...
main_th_37:
	TEST
	setx	t37_data_area, %g1, %l7
	setx	t37_blk_area,%g1,%g5;
...
main_th_38:
	TEST
	setx	t38_data_area, %g1, %l7
	setx	t38_blk_area,%g1,%g5;
...
main_th_39:
	TEST
        ...
        setx    0x412345000, %g7, %l0  ! bits [16:8] selects index in 4 bank mode
        setx    0x423456040, %g7, %l1
        setx    0x434567080, %g7, %l2
        setx    0x4456780c0, %g7, %l3
        setx    0x456789100, %g7, %l4
        setx    0x46789a140, %g7, %l5
        setx    0x4789ab180, %g7, %l6
        setx    0x489abc1c0, %g7, %l7
