...
* 
* OpenSPARC T2 Processor File: isa3_trap_0x3f.s
...
#define MY_USER_TEXT_RA   0x00000000400a0000
#define MY_USER_TEXT_PA   0x00000010400a0000
#define MY_USER_DATA_VA   0xb0000
#define MY_USER_DATA_RA   0x00000000400b0000
#define MY_USER_DATA_PA   0x00000010400b0000
...
#define My_HT0_Data_Real_Tran_Miss_0x3f	\
...
main:		/* test begin */
	!!! We are assuming DM bit is set at this point!
	ta T_CHANGE_HPRIV
	! Can't do the read and xor to flip the DM bit because of a bug in Simics
	! Hard-code the value for lsu_ctl_reg with DM=0
	!ldxa [%g0] ASI_LSU_CTL_REG, %l1
	!xor %l1, 8, %l1 ! clearing DM bit
	setx 0x017, %l1, %l2
	stxa %l2, [%g0] ASI_LSU_CTL_REG
	setx user_data_begin, %l1, %l2
...
SECTION .My_User_Data_Section DATA_VA=MY_USER_DATA_VA
attr_data {
	Name = .My_User_Data_Section,
	VA = MY_USER_DATA_VA,
        RA = MY_USER_DATA_RA,
        PA = MY_USER_DATA_PA,
	part_0_ctx_nonzero_tsb_config_0,
...
.text
.global user_data_begin

user_data_begin:	
	.xword 0101010101010101	
	.xword 0202020202020202	
	.xword 0303030303030303	
	.xword 0404040404040404	
