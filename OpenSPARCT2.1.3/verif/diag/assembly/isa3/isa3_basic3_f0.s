...
* 
* OpenSPARC T2 Processor File: isa3_basic3_f0.s
...
*/
.ident "Using Instruction Hash for Focus :$Id: isa3_basic3_f0.s,v 1.1 2007/05/11 17:22:20 drp Exp $"
#include "defines.h"
#include "nmacros.h"
#include "old_boot.s"
...
main_t0:
	...
	set	-0x0FC5,	%o7
	!# Float registers
	INIT_TH_FP_REG(%l7,%f0,0x469802EB49A27288)
	INIT_TH_FP_REG(%l7,%f2,0x90525E846784900D)
	INIT_TH_FP_REG(%l7,%f4,0x6A7C607B71B2DC25)
	INIT_TH_FP_REG(%l7,%f6,0xD54DB1731CBD1C0A)
	INIT_TH_FP_REG(%l7,%f8,0xCA89CC51E5F4D596)
	INIT_TH_FP_REG(%l7,%f10,0x677BE04DAF1ED46B)
	INIT_TH_FP_REG(%l7,%f12,0xF93C7856A632E02C)
	INIT_TH_FP_REG(%l7,%f14,0x0DB4639B2595876B)
	INIT_TH_FP_REG(%l7,%f16,0xAB90EBDCF7C69456)
	INIT_TH_FP_REG(%l7,%f18,0x5CE242370B1ED976)
	INIT_TH_FP_REG(%l7,%f20,0x7FA25A8F6B44C881)
	INIT_TH_FP_REG(%l7,%f22,0x839779E8708DC4DD)
	INIT_TH_FP_REG(%l7,%f24,0x3DBFA09E22DD1FD5)
	INIT_TH_FP_REG(%l7,%f26,0x2D222954EC47748E)
	INIT_TH_FP_REG(%l7,%f28,0x8DD308234EF46320)
	INIT_TH_FP_REG(%l7,%f30,0xE5C86227B8FB8DF6)
	!# Other state
...
loop_3:
	...
	movne	%icc,	%l6,	%i3
	wr	%g0,	0x10,	%asi
	lduba	[%l7 + 0x60] %asi,	%o1
	wr	%g0,	0x80,	%asi
	lduha	[%l7 + 0x56] %asi,	%i5
	andncc	%o0,	%l3,	%g2
	ldd	[%l7 + 0x08],	%f22
	fbuge	%fcc3,	loop_4
	fornot1s	%f7,	%f10,	%f10
...
loop_79:
	...
	wr	%g0,	0x18,	%asi
	ldsha	[%l7 + 0x08] %asi,	%l4
	or	%g4,	0x183A,	%g5
	edge8ln	%o4,	%g2,	%i7
	bgu,pn	%icc,	loop_80
	movrgz	%o3,	0x0E5,	%g6
	wr	%g0,	0x89,	%asi
	lduha	[%l7 + 0x76] %asi,	%o2
loop_80:
	tle	%icc,	0x1
	ta	%icc,	0x7
	add	%l7,	0x28,	%l6
...
loop_198:
	fmovsl	%xcc,	%f12,	%f21
	taddcctv	%o2,	0x0915,	%i2
	taddcctv	%o5,	0x154F,	%g6
	alignaddrl	%l6,	%i5,	%l5
	movpos	%icc,	%i3,	%g2
	popc	%l3,	%o6
	mulscc	%l1,	0x18F5,	%g4
...
loop_269:
	...
	nop 	! 	nop 	! 	ldxa	[%g0 + 0x3d8] %asi,	%l1 ripped by fixASI40.pl ripped by fixASI40.pl
	movg	%icc,	%l3,	%o1
	movre	%g7,	%i5,	%g2
	fbg	%fcc1,	loop_270
	taddcc	%o0,	%i3,	%o7
...
loop_482:
	...
	sdivx	%g5,	0x0D39,	%l1
	set	0x170, %l0
	nop 	! 	nop 	! 	ldxa	[%g0 + %l0] 0x40,	%o3 ripped by fixASI40.pl ripped by fixASI40.pl
	edge32ln	%i5,	%o1,	%i3
...
loop_641:
	tpos	%icc,	0x3
	wr	%g0,	0x11,	%asi
	ldsha	[%l7 + 0x58] %asi,	%i7
	wr	%g0,	0x81,	%asi
	ldstuba	[%l7 + 0x70] %asi,	%i1
	tvc	%icc,	0x0
	fmovsvc	%icc,	%f15,	%f2
	tgu	%icc,	0x2
...
loop_1147:
	...
	fmovrse	%l1,	%f13,	%f14
	wr	%g0,	0x19,	%asi
	lduha	[%l7 + 0x6A] %asi,	%o5
loop_1148:
	xnorcc	%l5,	0x107C,	%o0
	mulscc	%i0,	0x10EA,	%g2
	taddcctv	%i1,	0x023A,	%i4
	bne	%xcc,	loop_1149
	movrlez	%i2,	0x005,	%g1
	addc	%l4,	%g4,	%l6
	orncc	%o7,	%g5,	%i5
...
loop_1162:
	...
	fmovda	%xcc,	%f0,	%f24
	set	0x4B, %o7
	ldstuba	[%l7 + %o7] 0x11,	%g7
	lduw	[%l7 + 0x5C],	%i3
	movn	%xcc,	%o4,	%o6
	add	%o3,	0x117E,	%l1
	xnorcc	%i6,	0x0133,	%i1
	tsubcctv	%i4,	0x16D7,	%o5
	fmovsl	%icc,	%f7,	%f24
	xnor	%i2,	%i0,	%g2
	addc	%l6,	0x1366,	%l4
	addccc	%l5,	%o0,	%o7
...
loop_1292:
	umul	%g4,	0x0C89,	%l4
	ld	[%l7 + 0x70],	%f22
	taddcctv	%o0,	0x174C,	%o4
loop_1293:
	array8	%g5,	%g3,	%l0
	sub	%i5,	0x093D,	%i0
	wr	%g0,	0x81,	%asi
	lduha	[%l7 + 0x2C] %asi,	%g2
	sir	0x08D1
...
loop_1329:
	nop
	wr	%g0,	0x04,	%asi
	lduba	[%l7 + 0x55] %asi,	%l0
	wr	%g0,	0x88,	%asi
	ldsha	[%l7 + 0x1E] %asi,	%o6
	srlx	%o0,	0x0C,	%l4
	sdivcc	%i7,	0x157D,	%o4
	tneg	%xcc,	0x5
...
loop_1352:
	nop
	nop 	! 	nop 	! 	wr	%g0,	0x40,	%asi ripped by fixASI40.pl ripped by fixASI40.pl
	nop 	! 	nop 	! 	stxa	%l3,	[%g0 + 0x368] %asi ripped by fixASI40.pl ripped by fixASI40.pl
loop_1353:
	tl	%icc,	0x2
	movl	%xcc,	%l0,	%i5
	lduh	[%l7 + 0x64],	%l4
...
loop_1370:
	...
	tn	%xcc,	0x4
	umulcc	%g7,	%g2,	%o7
	taddcctv	%o2,	0x077E,	%o5
	movle	%xcc,	%o1,	%i6
	wr	%g0,	0x10,	%asi
	swapa	[%l7 + 0x74] %asi,	%l2
	srl	%l1,	0x03,	%i3
	edge16ln	%i2,	%i4,	%i1
...
loop_1389:
	...
	lduba	[%l7 + %o1] 0x19,	%o2
	set	0x360, %g5
	nop 	! 	nop 	! 	ldxa	[%g0 + %g5] 0x40,	%i6 ripped by fixASI40.pl ripped by fixASI40.pl
	restored
	rdpr    %cwp,           %g1
	rdpr    %cansave,       %g2
	rdpr    %canrestore,    %g3
...
loop_1741:
	...
	tne	%icc,	0x6
	wr	%g0,	0x80,	%asi
	ldswa	[%l7 + 0x64] %asi,	%l5
	stb	%o5,	[%l7 + 0x48]
	udivx	%i1,	0x0F44,	%l4
	for	%f6,	%f20,	%f16
	swap	[%l7 + 0x5C],	%o7
	tsubcctv	%i6,	0x0898,	%l2
	addccc	%l1,	%g5,	%o1
	edge32ln	%g2,	%i4,	%o6
	addcc	%i5,	0x1D32,	%g7
	nop
...
loop_1772:
	...
	membar	#Sync
	nop 	! 	nop 	! 	wr	%g0,	0x40,	%asi ripped by fixASI40.pl ripped by fixASI40.pl
	nop 	! 	nop 	! 	stxa	%l3,	[%g0 + 0x1d8] %asi ripped by fixASI40.pl ripped by fixASI40.pl
	alignaddrl	%o5,	%g6,	%o1
	srax	%i1,	%g7,	%o6
	addccc	%g1,	%g2,	%l4
	sth	%l2,	[%l7 + 0x32]
...
loop_1911:
	...
	movrgez	%g4,	0x2DD,	%l4
	set	0x25, %l0
	ldstuba	[%l7 + %l0] 0x81,	%g1
	taddcctv	%o7,	0x1C03,	%o3
	restored
	rdpr    %cwp,           %g1
	rdpr    %cansave,       %g2
	rdpr    %canrestore,    %g3
...
loop_1947:
	...
	add	%g1,	0x03A6,	%g4
	orn	%o7,	%l6,	%g2
	tsubcctv	%i1,	0x1EE9,	%o1
	and	%l5,	0x136C,	%i5
	srax	%l3,	%g5,	%g3
	fmovscc	%xcc,	%f31,	%f10
	set	0x75, %i7
	ldstuba	[%l7 + %i7] 0x89,	%l0
	edge8l	%g7,	%i4,	%l2
	tcc	%icc,	0x4
	tl	%xcc,	0x3
	ld	[%l7 + 0x24],	%f16
	...
	set	0x380, %l1
	nop 	! 	nop 	! 	ldxa	[%g0 + %l1] 0x40,	%o6 ripped by fixASI40.pl ripped by fixASI40.pl
	sra	%l1,	%o2,	%g6
	ldstub	[%l7 + 0x09],	%i2
	movgu	%icc,	%i7,	%o5
	xnor	%o4,	0x081D,	%i0
...
loop_2235:
	...
	fmovdcs	%xcc,	%f31,	%f2
	wr	%g0,	0x80,	%asi
	lduba	[%l7 + 0x12] %asi,	%l0
	fbe,a	%fcc2,	loop_2236
	and	%o7,	%i3,	%o5
	fmovrdne	%l1,	%f10,	%f4
	taddcctv	%g2,	0x17C3,	%i0
loop_2236:
	movrlz	%g3,	0x28A,	%o3
	srlx	%i7,	0x0F,	%o0
	addc	%i6,	0x0820,	%i4
...
loop_2288:
	...
	fnot1	%f28,	%f26
	tsubcctv	%i4,	0x03E5,	%i0
	set	0x10, %l2
	prefetcha	[%l7 + %l2] 0x15,	 0x3
loop_2289:
	fmovsge	%xcc,	%f29,	%f1
	fnegs	%f12,	%f24
	set	0x28, %o2
...
loop_2453:
	...
	array8	%i2,	%i1,	%g5
	movg	%xcc,	%i3,	%g4
	taddcctv	%g2,	0x1CBC,	%l6
	fandnot2s	%f19,	%f23,	%f2
	edge8n	%i5,	%l4,	%o7
	taddcctv	%o5,	0x0689,	%i7
	edge32ln	%g7,	%g3,	%i0
	movge	%xcc,	%o6,	%g1
	tcs	%icc,	0x2
	movrlez	%l5,	0x3F2,	%o2
...
loop_2487:
	...
	udivx	%i7,	0x1849,	%i5
	movcs	%icc,	%g4,	%o6
	tsubcctv	%l4,	0x1CD6,	%o3
	orn	%i3,	%o2,	%g3
	fpadd16	%f22,	%f28,	%f24
	wr	%g0,	0x10,	%asi
	lduha	[%l7 + 0x54] %asi,	%l3
	edge16l	%g7,	%i0,	%o1
	movcs	%icc,	%i6,	%o0
	udivcc	%o7,	0x14EC,	%l5
	brlz,a	%g5,	loop_2488
...
loop_2609:
	...
	fornot2s	%f0,	%f18,	%f31
	wr	%g0,	0x88,	%asi
	ldswa	[%l7 + 0x2C] %asi,	%o7
	tsubcctv	%g2,	0x0207,	%l1
	flush	%l7 + 0x64
	sethi	0x02F1,	%o0
	sdivcc	%i4,	0x0742,	%i6
	sdivx	%i1,	0x00BE,	%l2
...
loop_2682:
	...
	membar	#Sync
	edge16	%l4,	%l1,	%g6
	tsubcctv	%o7,	0x183B,	%g1
	wr	%g0,	0x81,	%asi
	ldsba	[%l7 + 0x4E] %asi,	%i4
	add	%i1,	%i7,	%g4
	edge8l	%o2,	%g7,	%l2
	fcmpne16	%f6,	%f18,	%o0
	movle	%icc,	%i0,	%i3
...
loop_2833:
	...
	sth	%i5,	[%l7 + 0x56]
	wr	%g0,	0x0c,	%asi
	lduha	[%l7 + 0x4A] %asi,	%o7
	wr	%g0,	0x18,	%asi
	swapa	[%l7 + 0x40] %asi,	%l4
	fmovsle	%icc,	%f24,	%f26
	subc	%l5,	%l0,	%o6
	andncc	%g3,	%o0,	%i7
	edge8	%l6,	%o4,	%i6
