...
* 
* OpenSPARC T2 Processor File: isa3_basic3_f19.s
...
*/
.ident "Using Instruction Hash for Focus :$Id: isa3_basic3_f19.s,v 1.1 2007/05/11 17:22:22 drp Exp $"
#include "defines.h"
#include "nmacros.h"
#include "old_boot.s"
...
main_t0:
	...
	set	0x18EB,	%o7
	!# Float registers
	INIT_TH_FP_REG(%l7,%f0,0x0B663962AC0398C5)
	INIT_TH_FP_REG(%l7,%f2,0x7F44CB19CED3F52B)
	INIT_TH_FP_REG(%l7,%f4,0xF2B07564F000ECAC)
	INIT_TH_FP_REG(%l7,%f6,0xACE12360FA5F753A)
	INIT_TH_FP_REG(%l7,%f8,0x95D122EE1CB53569)
	INIT_TH_FP_REG(%l7,%f10,0x776EB4718AC83642)
	INIT_TH_FP_REG(%l7,%f12,0x2B3FC3DCEC073AF7)
	INIT_TH_FP_REG(%l7,%f14,0x09586C62949BE19F)
	INIT_TH_FP_REG(%l7,%f16,0x8B996E883D81DE51)
	INIT_TH_FP_REG(%l7,%f18,0x13D38509C7C93947)
	INIT_TH_FP_REG(%l7,%f20,0x9BD8DFD3C23C6A0B)
	INIT_TH_FP_REG(%l7,%f22,0xF0A2437785E0A1DA)
	INIT_TH_FP_REG(%l7,%f24,0xF22BE9E392E0A650)
	INIT_TH_FP_REG(%l7,%f26,0xAF4434176C4DBEC1)
	INIT_TH_FP_REG(%l7,%f28,0x742F54223CD23BCA)
	INIT_TH_FP_REG(%l7,%f30,0x515C09D85109F8E1)
	!# Other state
...
loop_94:
	...
	swapa	[%l7 + %l4] 0x10,	%i3
	wr	%g0,	0x89,	%asi
	lduba	[%l7 + 0x33] %asi,	%l6
	movrgez	%g4,	%l1,	%l5
	brlz,a	%l3,	loop_95
	srl	%o6,	0x07,	%i1
	fmovdge	%icc,	%f15,	%f14
	taddcctv	%g1,	0x1B12,	%l4
loop_95:
	movgu	%icc,	%o7,	%o3
	ba,pt	%xcc,	loop_96
	fcmpd	%fcc3,	%f30,	%f4
...
loop_555:
	...
	fmovdcs	%icc,	%f6,	%f13
	wr	%g0,	0x0c,	%asi
	swapa	[%l7 + 0x3C] %asi,	%o4
	wr	%g0,	0x10,	%asi
	swapa	[%l7 + 0x30] %asi,	%o7
	array32	%g3,	%g5,	%o1
	xor	%g7,	%l5,	%g6
	xor	%i6,	%g4,	%i5
	movneg	%xcc,	%o5,	%o3
...
loop_812:
	...
	srl	%g5,	0x08,	%o6
	wr	%g0,	0x80,	%asi
	ldsba	[%l7 + 0x2E] %asi,	%l3
	fsrc1	%f8,	%f24
	alignaddr	%i3,	%g3,	%i7
	wr	%g0,	0x80,	%asi
	ldstuba	[%l7 + 0x1F] %asi,	%o1
	ld	[%l7 + 0x3C],	%f16
	subc	%l6,	0x1222,	%i5
	tsubcc	%i4,	0x1974,	%g6
	tne	%icc,	0x3
...
loop_1208:
	movge	%icc,	%g1,	%o7
	taddcctv	%g2,	0x1B60,	%g4
	tle	%icc,	0x0
	st	%f11,	[%l7 + 0x1C]
	fmovdne	%xcc,	%f2,	%f27
	wr	%g0,	0x11,	%asi
	lduwa	[%l7 + 0x24] %asi,	%i7
	edge16ln	%g3,	%o3,	%i1
	tle	%xcc,	0x1
	move	%icc,	%l4,	%o2
	edge16n	%o6,	%g7,	%o1
...
loop_1239:
	...
	stba	%o0,	[%l7 + %i5] 0xea
	membar	#Sync
	taddcctv	%i6,	0x1952,	%i5
	mova	%icc,	%l1,	%o7
	wr	%g0,	0x18,	%asi
	lduwa	[%l7 + 0x70] %asi,	%l6
	xorcc	%g1,	%l0,	%g2
	udiv	%i1,	0x1215,	%l4
	saved
	rdpr    %cwp,           %g1
...
loop_1371:
	...
	popc	%l3,	%l5
	wr	%g0,	0x80,	%asi
	lduha	[%l7 + 0x66] %asi,	%g7
loop_1372:
	xnor	%i1,	0x1A45,	%l4
	wr	%g0,	0x19,	%asi
	ldsha	[%l7 + 0x26] %asi,	%l1
	set	0x3D, %i3
...
loop_1917:
	...
	fmovdvc	%icc,	%f16,	%f0
	fbue	%fcc2,	loop_1919
	tsubcctv	%i2,	0x12BA,	%i0
loop_1918:
	nop
	wr	%g0,	0x18,	%asi
	lduba	[%l7 + 0x3D] %asi,	%g4
loop_1919:
	ta	%icc,	0x2
	fmovsl	%icc,	%f1,	%f27
	fmovdgu	%xcc,	%f25,	%f15
...
loop_2304:
	...
	set	0x60, %g4
	ldd	[%l7 + %g4],	%i0
	taddcctv	%i4,	0x089D,	%l5
	srax	%o0,	%g1,	%l3
	tcs	%icc,	0x3
	wr	%g0,	0x04,	%asi
	lduha	[%l7 + 0x68] %asi,	%i3
	ldsh	[%l7 + 0x3C],	%g3
	edge8ln	%o3,	%o1,	%o7
	xnorcc	%g4,	0x10E1,	%l6
	taddcc	%o5,	0x17CF,	%o2
...
loop_2311:
	...
	set	0x6C, %l5
	stb	%o2,	[%l7 + %l5]
	tsubcctv	%g5,	0x109C,	%g7
	popc	0x001F,	%l2
	andn	%o5,	%l0,	%l4
	wr	%g0,	0x10,	%asi
	ldsba	[%l7 + 0x41] %asi,	%i7
	wr	%g0,	0x23,	%asi
	stba	%g2,	[%l7 + 0x7B] %asi
	membar	#Sync
	movne	%xcc,	%i0,	%i5
...
loop_2437:
	fmovse	%icc,	%f1,	%f12
	set	0x18, %o2
	prefetcha	[%l7 + %o2] 0x88,	 0x0
	tsubcc	%o2,	%o0,	%i1
	srl	%o5,	0x02,	%o4
	set	0x40, %i1
	prefetcha	[%l7 + %i1] 0x0c,	 0x3
	fmovscc	%icc,	%f29,	%f14
	xorcc	%l4,	0x07F1,	%o7
	fmovsneg	%icc,	%f23,	%f8
	fmovdg	%icc,	%f17,	%f28
...
loop_2462:
	...
	mova	%xcc,	%i5,	%i3
	wr	%g0,	0x11,	%asi
	lduba	[%l7 + 0x7A] %asi,	%o4
	subc	%i0,	%g5,	%o5
	fmovrdgz	%o3,	%f20,	%f18
	sll	%l0,	%g7,	%l4
	wr	%g0,	0x81,	%asi
	ldswa	[%l7 + 0x78] %asi,	%o6
	movle	%xcc,	%l1,	%i7
	movvs	%xcc,	%o7,	%g1
	movneg	%icc,	%g4,	%l2
	swap	[%l7 + 0x08],	%l5
...
loop_2480:
	...
	fsrc1	%f30,	%f22
	set	0x178, %l6
	nop 	! 	nop 	! 	ldxa	[%g0 + %l6] 0x40,	%g4 ripped by fixASI40.pl ripped by fixASI40.pl
loop_2481:
	movpos	%icc,	%l3,	%l1
	movrgz	%o0,	%o1,	%g6
	nop
...
loop_2507:
	...
	stha	%g4,	[%l7 + 0x36] %asi
	wr	%g0,	0x11,	%asi
	ldsba	[%l7 + 0x62] %asi,	%o1
	fnot2	%f6,	%f24
	wr	%g0,	0x10,	%asi
	lduha	[%l7 + 0x0A] %asi,	%i7
	movvs	%xcc,	%g1,	%l4
	fabsd	%f14,	%f12
	ldx	[%l7 + 0x78],	%g2
	edge8l	%l5,	%g6,	%i3
...
loop_2516:
	movre	%l5,	0x3A6,	%o2
	wr	%g0,	0x04,	%asi
	lduha	[%l7 + 0x2A] %asi,	%i5
loop_2517:
	nop
	wr	%g0,	0x04,	%asi
	ldstuba	[%l7 + 0x7C] %asi,	%i1
	andcc	%l6,	0x1F31,	%i3
	nop
...
loop_2600:
	...
	subccc	%l1,	%l2,	%i3
	taddcctv	%g2,	0x007F,	%l6
	fand	%f24,	%f26,	%f4
loop_2601:
	nop
	wr	%g0,	0x80,	%asi
	ldstuba	[%l7 + 0x60] %asi,	%i0
	movcs	%xcc,	%l0,	%o5
	edge16ln	%g4,	%i2,	%o7
	fmovdgu	%xcc,	%f18,	%f22
...
loop_2702:
	nop
	wr	%g0,	0x89,	%asi
	ldstuba	[%l7 + 0x6E] %asi,	%g4
	wr	%g0,	0x81,	%asi
	ldswa	[%l7 + 0x34] %asi,	%l0
	fmovdgu	%xcc,	%f7,	%f13
	tne	%xcc,	0x3
	fzeros	%f1
...
loop_2865:
	...
	movvc	%icc,	%g2,	%g5
	wr	%g0,	0x89,	%asi
	swapa	[%l7 + 0x50] %asi,	%o7
	taddcctv	%o3,	0x0023,	%i3
	edge8	%i0,	%l1,	%o4
	movleu	%icc,	%g1,	%o5
	movneg	%icc,	%o1,	%i2
	ldd	[%l7 + 0x58],	%l4
