...
* 
* OpenSPARC T2 Processor File: err_tcc_stick_halt_diag.s
...
set_stick_cmpr:
    wr %g0, %g3, %sys_tick_cmpr		!! err will be injected
...
!! Chk softint register is clear. We can chk for only SM bit not being set, but
!! since there is nothing in the diag to set the TM or int_level bits, the register
!! shd be clear.
    rd %softint, %l1
    brnz %l1, FAIL
    nop
