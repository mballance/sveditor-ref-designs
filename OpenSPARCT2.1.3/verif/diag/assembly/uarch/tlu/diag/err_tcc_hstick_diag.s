...
* 
* OpenSPARC T2 Processor File: err_tcc_hstick_diag.s
...
set_hstick_cmpr:
    add %g2, 0x200, %g2
    wrhpr %g2, %hsys_tick_cmpr		!! err will be injected

    mov 0x200, %g1                    ! Should get interrupt in 100
loop_wait_for_int:
...
! Turn on IE bit 
  ...
  wrpr %l1, 0x2, %pstate
   ...
   add %i2, 10, %i3
    ...
    brnz %i0, FAIL    ! chk hstick_cmpr trap not taken
