...
* 
* OpenSPARC T2 Processor File: err_dttp_diag.s
...
#define SUN_H_HT0_DAE_so_page_0x30 \
        done;nop;nop;nop;nop;nop;nop;nop

#define  H_HT0_data_access_protection_0x6c
#define My_HT0_data_access_protection_0x6c \
        done;nop;nop;nop;nop;nop;nop;nop
...
main:		/* test begin */
  setx user_data_start, %g2, %l7
  ldx [%l7], %g1  !! ld the pg in the TLB without err
  ta    T_CHANGE_HPRIV

  !! Enable error injection
  setx DMTU_ERR_EN, %l0, %l1
  stxa %l1, [%g0]ASI_ERR_INJ

  ta T_CHANGE_NONHPRIV

  mov %g0, %l1   !!no trap
  mov %g0, %i0   !!no trap, data_access_mmu_err trap changes the value to ff
  mov %g0, %l2   !! mode (0 = user, 1 = priv, 2 = hpriv)
  mov %g0, %l3   !! iteration #.
...
begin_thread_1:
        setx user_code_begin_016, %g2, %g3
        jmp  %g3
        nop
        EXIT_BAD

begin_thread_2:
        setx user_code_begin_032, %g2, %g3
        jmp  %g3
        nop
        EXIT_BAD

begin_thread_3:
        setx user_code_begin_046, %g2, %g3
        jmp  %g3
        nop
        EXIT_BAD

begin_thread_4:
        setx user_code_begin_062, %g2, %g3
        jmp  %g3
        nop
        EXIT_BAD

begin_thread_5:
        setx user_code_begin_078, %g2, %g3
        jmp  %g3
        nop
        EXIT_BAD

begin_thread_6:
        setx user_code_begin_094, %g2, %g3
        jmp  %g3
        nop
        EXIT_BAD

begin_thread_7:
        setx user_code_begin_110, %g2, %g3
        jmp  %g3
        nop
        EXIT_BAD
...
user_code_begin_000:
	...
	nop
	mov 0, %i0
	setx user_code_begin_001, %g1, %l0
	jmp  %l0
	nop
FAIL:	EXIT_BAD
	nop
...
user_code_begin_001:
	...
	nop
	mov %g0, %i0
	setx user_code_begin_002, %g1, %l0
	jmp  %l0
	nop
FAIL:	EXIT_BAD
	nop
...
user_code_begin_002:
	...
	nop
	mov 0, %i0
	setx user_code_begin_003, %g1, %l0
	jmp  %l0
	nop
FAIL:	EXIT_BAD
	nop
...
user_code_begin_003:
        ...
        nop
        mov 0, %i0
        setx user_code_begin_004, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
user_code_begin_004:
        setx user_data_begin_004, %g1, %l4
        ldswa [%l4]ASI_SL, %l5
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov 0, %i0
        setx user_code_begin_005, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
user_code_begin_005:
        ...
        nop
        mov 0, %i0
        setx user_code_begin_006, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
user_code_begin_006:
        setx user_data_begin_006, %g1, %l4
        ldda [%l4]ASI_FL8_P, %d0
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov 0, %i0
        setx user_code_begin_007, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
user_code_begin_007:
        setx user_data_begin_007, %g1, %l4
        stba %l5, [%l4]ASI_P
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov 0, %i0
        setx user_code_begin_008, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
user_code_begin_008:
        setx user_data_begin_008, %g1, %l4
        stha %l5, [%l4]ASI_S
        cmp     %i0, %l1
        bne     FAIL
        !ldxa [%l4]ASI_S, %l6
        mov 0, %i0
        setx user_code_begin_009, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
user_code_begin_009:
        setx user_data_begin_009, %g1, %l4
        stba %l5, [%l4]ASI_BLK_INIT_ST_QUAD_LDD_P
        cmp     %i0, %l1
        bne     FAIL
	ldx	[%l4], %l6
        mov 0, %i0
        setx user_code_begin_010, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
! dae_invalid_asi and data_access_err on same inst.
attr_text {
NAME = .My_User_Section_4v010,
  hypervisor
}
...
user_code_begin_010:
	mov %l1, %o2	! if data_acess_err trap is taken first then the cmp will fail.
	mov %g0, %l1
        setx user_data_begin_010, %g1, %l4
        ldxa [%l4]ASI_BLK_INIT_ST_QUAD_LDD_P, %l5
        cmp     %i0, %l1
        bne     FAIL
	mov %g0, %i0
        setx user_code_begin_011, %g1, %l0
        jmp  %l0
        mov %o2, %l1
FAIL:   EXIT_BAD
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA010,
	PA = ra2pa(MY_USER_DATA_RA010, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_011:
        setx user_data_begin_011, %g1, %l4
        ldxa [%l4]ASI_PNF, %l5
        cmp     %i0, %l1
        bne     FAIL
	mov %g0, %i0
        setx user_code_begin_012, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA011,
	PA = ra2pa(MY_USER_DATA_RA011, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 1,
	TTE_L       = 0,
...
user_code_begin_012:
        setx user_data_begin_012, %g1, %l4
        stda %d0, [%l4]ASI_PST8_P
        cmp     %i0, %l1
        bne     FAIL
	mov %g0, %i0
        setx user_code_begin_013, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA012,
	PA = ra2pa(MY_USER_DATA_RA012, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_013:
        setx user_data_begin_013, %g1, %l4
        stda %d0, [%l4]ASI_PST8_P
        cmp     %i0, %l1
        bne     FAIL
	mov %g0, %i0
        setx user_code_begin_014, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA013,
	PA = ra2pa(MY_USER_DATA_RA013, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_text {
	...
	RA = MY_USER_TEXT_RA014,
	PA = ra2pa(MY_USER_TEXT_RA014, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_014:
        setx user_data_begin_014, %g1, %l4
        ldda [%l4]ASI_BLK_P, %d0
        cmp     %i0, %l1
        bne     FAIL
	mov %g0, %i0
        setx user_code_begin_015, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA014,
	PA = ra2pa(MY_USER_DATA_RA014, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_015:
        setx user_data_begin_015, %g1, %l4
        stda %d0, [%l4]ASI_BLK_P
        cmp     %i0, %l1
        bne     FAIL
	mov %g0, %i0
...
TH0_WT_LOOP:
        ...
        ldx [%l4 + 0x4], %o1  !take mem_addr_aligned trap
        st %l5, [%l7]   !! enable other threads

        xor %l1, 0x1, %l1
        cmp %l2, 2
        bz,a .+8
        mov %g0, %l1    !! no trap in HP mode
...
GO_BACK:setx user_code_begin_000, %g2, %g3
        jmp  %g3
        nop
...
user_code_begin_016:
	add %l7, 8, %l7
        setx user_data_begin_016, %g1, %l4
	subcc %g0, 0x1ff, %l5
        stba %l5, [%l4]ASI_PL
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_017, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
user_code_begin_017:
        setx user_data_begin_017, %g1, %l4
	subcc %l5, 0x1ff, %l5
        swap [%l4 + %g0], %l5
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_018, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
user_code_begin_018:
        setx user_data_begin_018, %g1, %l4
	subcc %l5, 0x1ff, %l5
        ldstub [%l4 + %g0], %l5
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_019, %g1, %l0
        jmp  %l0
        nop
FAIL:   EXIT_BAD
        nop
...
user_code_begin_019:
        setx user_data_begin_019, %g1, %l4
	subcc %l5, 0x1ff, %l5
        casa [%l4]0x80, %l5, %g2
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_020, %g1, %l0
        jmp  %l0
        nop
...
attr_text {
	...
	RA = MY_USER_TEXT_RA020,
	PA = ra2pa(MY_USER_TEXT_RA020, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_020:
        setx user_data_begin_020, %g1, %l4
	subcc %l5, 0x1ff, %l5
        casxa [%l4]0x80, %l5, %g2
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_021, %g1, %l0
        jmp  %l0
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA020,
	PA = ra2pa(MY_USER_DATA_RA020, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_text {
	...
	RA = MY_USER_TEXT_RA021,
	PA = ra2pa(MY_USER_TEXT_RA021, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_021:
        setx user_data_begin_021, %g1, %l4
	subcc %l5, 0x1ff, %l5
        ldda [%l4]0xE2, %o6	! bis ld
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_022, %g1, %l0
        jmp  %l0
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA021,
	PA = ra2pa(MY_USER_DATA_RA021, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_text {
	...
	RA = MY_USER_TEXT_RA022,
	PA = ra2pa(MY_USER_TEXT_RA022, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_022:
        setx user_data_begin_022, %g1, %l4
	subcc %l5, 0x1ff, %l5
        stba %l5, [%l4]0xE2
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_023, %g1, %l0
        jmp  %l0
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA022,
	PA = ra2pa(MY_USER_DATA_RA022, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_text {
	...
	RA = MY_USER_TEXT_RA023,
	PA = ra2pa(MY_USER_TEXT_RA023, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_023:
        setx user_data_begin_023, %g1, %l4
	subcc %l5, 0x1ff, %l5
        stxa %l5, [%l4]0xE2
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_024, %g1, %l0
        jmp  %l0
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA023,
	PA = ra2pa(MY_USER_DATA_RA023, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_text {
	...
	RA = MY_USER_TEXT_RA024,
	PA = ra2pa(MY_USER_TEXT_RA024, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_024:
        setx user_data_begin_024, %g1, %l4
	subcc %l5, 0x1ff, %l5
        stx %l5, [%l4]
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_025, %g1, %l0
        jmp  %l0
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA024,
	PA = ra2pa(MY_USER_DATA_RA024, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_025:
        setx user_data_begin_025, %g1, %l4
	subcc %l5, 0x1ff, %l5
        std %o6, [%l4]
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_026, %g1, %l0
        jmp  %l0
        nop
...
user_code_begin_026:
        setx user_data_begin_026, %g1, %l4
	subcc %l5, 0x1ff, %l5
	mov %l1, %g1
	mov %g0, %l1	! no trap on prefetch
        prefetch [%l4], 0
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
	mov %g1, %l1
        setx user_code_begin_027, %g1, %l0
        jmp  %l0
        nop
...
user_code_begin_027:
        setx user_data_begin_027, %g1, %l4
	subcc %l5, 0x1ff, %l5
        ldd [%l4], %o6
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_028, %g1, %l0
        jmp  %l0
        nop
...
user_code_begin_028:
        setx user_data_begin_028, %g1, %l4
	subcc %l5, 0x1ff, %l5
        ldda [%l4]ASI_BLK_P, %d0
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_029, %g1, %l0
        jmp  %l0
        nop
...
user_code_begin_029:
        setx user_data_begin_029, %g1, %l4
        stda %d0, [%l4]ASI_BLK_P
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_030, %g1, %l0
        jmp  %l0
        nop
...
attr_text {
	...
	RA = MY_USER_TEXT_RA030,
	PA = ra2pa(MY_USER_TEXT_RA030, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_030:
        setx user_data_begin_030, %g1, %l4
        std %d0, [%l4]
        cmp     %i0, %l1
        bne     FAIL
        nop
        mov %g0, %i0
        setx user_code_begin_031, %g1, %l0
        jmp  %l0
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA030,
	PA = ra2pa(MY_USER_DATA_RA030, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_text {
	...
	RA = MY_USER_TEXT_RA031,
	PA = ra2pa(MY_USER_TEXT_RA031, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
user_code_begin_031:
        setx user_data_begin_031, %g1, %l4
        std %d0, [%l4]
        cmp     %i0, %l1
        bne     FAIL
        nop
...
CHANGE_PRIV_LEVEL:
	...
	ta T_CHANGE_NONHPRIV
        ...
        cmp %l2, 3
        bz,a GO_BACK		!! change to priv mode
        ta T_CHANGE_PRIV

        EXIT_GOOD
        nop

GO_BACK:setx user_code_begin_016, %g2, %l4
        jmp  %l4
        nop
...
attr_data {
	...
	RA = MY_USER_DATA_RA031,
	PA = ra2pa(MY_USER_DATA_RA031, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_text {
	...
	RA = MY_USER_TEXT_RA032,
	PA = ra2pa(MY_USER_TEXT_RA032, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_data {
	...
	RA = MY_USER_DATA_RA032,
	PA = ra2pa(MY_USER_DATA_RA032, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_text {
	...
	RA = MY_USER_TEXT_RA033,
	PA = ra2pa(MY_USER_TEXT_RA033, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_data {
	...
	RA = MY_USER_DATA_RA033,
	PA = ra2pa(MY_USER_DATA_RA033, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_text {
	...
	RA = MY_USER_TEXT_RA034,
	PA = ra2pa(MY_USER_TEXT_RA034, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
attr_data {
	...
	RA = MY_USER_DATA_RA034,
	PA = ra2pa(MY_USER_DATA_RA034, 0),
	TTE_Context = PCONTEXT,
	TTE_V       = 1,
	TTE_NFO     = 0,
	TTE_L       = 0,
...
MEM_ADDR_HANDLER:
        brz  %l3, EN_ERR_DETECTION
	add %g0, CERER_VA, %g1
DEMAP_ALL:
        add %g0, 0x80, %g4
        !! demap all
        stxa %g0, [%g4] ASI_DMMU_DEMAP
  	ldxa [%l7]0x10, %g5  !! ld the pg in the TLB without err

        !! disable error detection
        stxa %g0, [%g1]ASI_CERER
ENABLE_ERR_INJECTION:
        !! Enable err injection
        setx DMTU_ERR_EN, %g2, %g3
        stxa %g3, [%g0]ASI_ERR_INJ
        done
        nop
...
EN_ERR_DETECTION:
        ...
        setx 0x1000000000000, %g2, %g3   !enable DTTP errors
        stxa %g3, [%g1]ASI_CERER
        done
        nop
