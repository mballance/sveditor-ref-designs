...
* 
* OpenSPARC T2 Processor File: err_sbdpu_fc_diag.s
...
main:		/* test begin */
  ...
  !! set CERER.SBDPU, cerer.dcl2nd, cerer.dcdp
  setx 0x4000000a00,  %l1, %o2   !! enable sbdpu errs
  add %g0, CERER_VA, %g3        !!g3 has cerer va

  stxa %o2, [%g3]ASI_CERER

  !! set CETER.DE, ceter.pscce and ceter.dhcce
  mov 7, %o2
  sllx %o2, 60, %o2
  add %g0, CETER_VA, %g3
...
chk_cache_hit: 
	ldx [%l4], %o4	!cache hit, no trap shd be seen
        brnz  %i1, FAIL
chk_cache_miss: 
	ldx [%l4 + 0x10], %o4	!cache miss, trap shd be seen
        brz  %i1, FAIL
        mov %g0, %i1
	ldx [%l4 + 0x20], %o4	!No trap shd be seen
        brnz  %i1, FAIL
	ldx [%l4 + 0x28], %o4	!No trap shd be seen
        brnz  %i1, FAIL
	ldx [%l4 + 0x30], %o4	!No trap shd be seen
        brnz  %i1, FAIL
	ldx [%l4 + 0x38], %o4	!No trap shd be seen
        brnz  %i1, FAIL
chk_cache_miss_0x40: 
        ldx [%l4 + 0x48], %o4   
        brz  %i1, FAIL
        mov %g0, %i1
        ld [%l4 + 0x44], %o4    !trap, line loaded in cache with bad parity
        brz  %i1, FAIL
        mov %g0, %i1
        ldx [%l4 + 0x50], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0x58], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0x60], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0x68], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0x70], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0x78], %o4   !No trap shd be seen
        brnz  %i1, FAIL
chk_cache_miss_0x80: 
        ldub [%l4 + 0x80], %o4 
        brz  %i1, FAIL
        ...
        brz  %i1, FAIL
        mov %g0, %i1
        ldx [%l4 + 0x90], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0x98], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0xa0], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0xa8], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0xb0], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0xb8], %o4   !No trap shd be seen
        brnz  %i1, FAIL
...
chk_cache_miss_0xc0: 
	ld  [%l4 + 0xc0], %o4   !! UE
        brz  %i1, FAIL
        mov %g0, %i1
        ldx [%l4 + 0xd0], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0xd8], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0xe0], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0xe8], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0xf0], %o4   !No trap shd be seen
        brnz  %i1, FAIL
        ldx [%l4 + 0xf8], %o4   !No trap shd be seen
        brnz  %i1, FAIL
...
user_code_begin_001:
  ...
  setx user_data_begin_002, %g1, %l5

  ldx [%l4], %o4	!pg  lookup
  ldx [%l5], %o5	!pg  lookup

	casa [%l4]0x80, %o7, %g1  !! L2$ shd store nd irrepsective of update or not
...
chk_casa: 
	ldub [%l4+%g1], %o4	!cache miss, trap shd be seen
        brz  %i1, FAIL
        mov %g0, %i1
        brz  %i2, FAIL
        mov %g0, %i2
...
user_code_begin_002:
  ...
  setx user_data_begin_003, %g1, %l5
