...
* 
* OpenSPARC T2 Processor File: err_itdp_diag.s
...
main:		/* test begin */
  ...
  !! Enable CERER
  setx 0x4000000000000000, %l0, %o2   !! enable ITDP errs
  add %g0, CERER_VA, %g3	!!g3 has cerer va

  stxa %o2, [%g3]ASI_CERER

  !! Enable error injection
  setx IMDU_ERR_EN, %l0, %l1
...
!! pg _001 has no error. Lable TGT0 represents the last inst. of
!! pg_001 and TGT1 represents the first inst. of next pg.
