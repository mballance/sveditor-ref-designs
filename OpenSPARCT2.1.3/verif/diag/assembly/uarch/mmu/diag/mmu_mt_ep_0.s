...
* 
* OpenSPARC T2 Processor File: mmu_mt_ep_0.s
...
ext_trap_0xb_begin:
	...
	ldxa    [ASI_CORE_ID_VA] %asi, %l7
	and     %l7, 7, %l7	!# %l7 = TID
	setx	trap_0xb_va_list, %l0, %l2
	umul	%l7, 8, %l3
	add	%l2, %l3, %l2
	ldx	[%l2], %l2	!# %l2 = expected fault va
	sub	%l2, %l4, %l2
	brz	%l2, passed
	nop
	EXIT_BAD
...
trap_0xb_va_list:	
.xword	THR0_USER_TEXT_4V_VA000
.xword	THR1_USER_TEXT_4V_VA000
.xword	THR2_USER_TEXT_4V_VA000
.xword	THR3_USER_TEXT_4V_VA000
.xword	THR4_USER_TEXT_4V_VA000
.xword	THR5_USER_TEXT_4V_VA000
.xword	THR6_USER_TEXT_4V_VA000
.xword	THR7_USER_TEXT_4V_VA000
