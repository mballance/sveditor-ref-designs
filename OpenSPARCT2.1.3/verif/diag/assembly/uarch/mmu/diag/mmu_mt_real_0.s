...
* 
* OpenSPARC T2 Processor File: mmu_mt_real_0.s
...
thr0_hred_tsb_z_config_0:
	...
	! Preload D-TLB with real translations
	! Thr0_User_Data_4v100, thr0_nz_ctx_tsb_2
	! First write to Tag Access register
!thr0_load_real_translations:		
!	setx	Thr0_User_Data_4v100_data_begin, %g1, %g2	! %g2 = D_VA
!	or	%g2, 0x02ac, %g1		! %g1 = D_VA + Context
!	or	%g0, 0x30, %g2
!	stxa	%g1, [%g2] 0x58			! Store to D-TAG_ACCESS
!	or	%g0, 0x80, %g3
!	ldxa	[%g3] 0x54, %g2			! %g2 = D_TSB_PTR_2
!	ldda	[%g2] 0x24, %g6			! %g6 = TTE_TAG, %g7 = TTE_DATA
!	xor	%g7, 0x100, %g7
!	setx	0x0002000000, %g5, %g4
!	add	%g7, %g4, %g7			! %g7 = real translation
!	or	%g6, %g0, %o2			! Save TTE_TAG in %o2
!	or	%g7, %g0, %o3			! Save TTE_DATA in %o3
!	or	%g0, 0x0800, %g5
!	stxa	%g7, [%g5] 0x5c			! Store to DTLB DATA IN
