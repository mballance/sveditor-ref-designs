...
* 
* OpenSPARC T2 Processor File: mmu_mt_htba.s
...
#define THR0_HPTRAP_TEXT_PA             0x30000
#define THR1_HPTRAP_TEXT_PA             0x40000
#define THR2_HPTRAP_TEXT_PA             0x50000
#define THR3_HPTRAP_TEXT_PA             0x60000
#define THR4_HPTRAP_TEXT_PA             0x70000
#define THR5_HPTRAP_TEXT_PA             0x80000
#define THR6_HPTRAP_TEXT_PA             0x90000
#define THR7_HPTRAP_TEXT_PA             0xa0000
#define HPTRAPS_EXT_TEXT_PA             0xb0000
#define HPTRAPS_EXT_DATA_PA             0xb8000
...
pwr_mgmt:
	...
	! set hyper trap base addr for T0
	setx	THR0_HPTRAP_TEXT_PA, %l0, %l7
	wrhpr	%l7, %g0, %htba
...
test_thr1:
	...
	! set hyper trap base addr for T1
	setx	THR1_HPTRAP_TEXT_PA, %l0, %l7
	wrhpr	%l7, %g0, %htba
...
test_thr2:
	...
	! set hyper trap base addr for T0
	setx	THR2_HPTRAP_TEXT_PA, %l0, %l7
	wrhpr	%l7, %g0, %htba
...
test_thr3:
	...
	! set hyper trap base addr for T0
	setx	THR3_HPTRAP_TEXT_PA, %l0, %l7
	wrhpr	%l7, %g0, %htba
...
test_thr4:
	...
	! set hyper trap base addr for T0
	setx	THR4_HPTRAP_TEXT_PA, %l0, %l7
	wrhpr	%l7, %g0, %htba
...
test_thr5:
	...
	! set hyper trap base addr for T0
	setx	THR5_HPTRAP_TEXT_PA, %l0, %l7
	wrhpr	%l7, %g0, %htba
...
test_thr6:
	...
	! set hyper trap base addr for T0
	setx	THR6_HPTRAP_TEXT_PA, %l0, %l7
	wrhpr	%l7, %g0, %htba
...
test_thr7:	
	! set hyper trap base addr for T0
	setx	THR7_HPTRAP_TEXT_PA, %l0, %l7
	wrhpr	%l7, %g0, %htba
...
!#*****************************************************************************************
SECTION .THR0_HTRAPS  TEXT_VA=THR0_HPTRAP_TEXT_PA
...
.align	32	!# 2a
	...
	nop
.align	32	!# 2b
	setx	Thr0_ext_trap_0x2b_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 2c
	nop
...
.align	32	!# 63
	nop
.align	32	!# 64
	setx	Thr0_ext_trap_0x64_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 65
	nop
...
.align	32	!# 67
	nop
.align	32	!# 68
        setx    Thr0_ext_trap_0x68_begin, %g1, %g2
        jmp     %g2
	nop
.align	32	!# 69
	nop
...
!#*****************************************************************************************
SECTION .THR1_HTRAPS  TEXT_VA=THR1_HPTRAP_TEXT_PA
...
.align	32	!# 2a
	...
	nop
.align	32	!# 2b
	setx	Thr1_ext_trap_0x2b_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 2c
	nop
...
.align	32	!# 63
	nop
.align	32	!# 64
	setx	Thr1_ext_trap_0x64_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 65
	nop
...
.align	32	!# 67
	nop
.align	32	!# 68
        setx    Thr1_ext_trap_0x68_begin, %g1, %g2
        jmp     %g2
	nop
.align	32	!# 69
	nop
...
!#*****************************************************************************************
SECTION .THR2_HTRAPS  TEXT_VA=THR2_HPTRAP_TEXT_PA
...
.align	32	!# 2a
	...
	nop
.align	32	!# 2b
	setx	Thr2_ext_trap_0x2b_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 2c
	nop
...
.align	32	!# 63
	nop
.align	32	!# 64
	setx	Thr2_ext_trap_0x64_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 65
	nop
...
.align	32	!# 67
	nop
.align	32	!# 68
        setx    Thr2_ext_trap_0x68_begin, %g1, %g2
        jmp     %g2
	nop
.align	32	!# 69
	nop
...
!#*****************************************************************************************
SECTION .THR3_HTRAPS  TEXT_VA=THR3_HPTRAP_TEXT_PA
...
.align	32	!# 2a
	...
	nop
.align	32	!# 2b
	setx	Thr3_ext_trap_0x2b_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 2c
	nop
...
.align	32	!# 63
	nop
.align	32	!# 64
	setx	Thr3_ext_trap_0x64_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 65
	nop
...
.align	32	!# 67
	nop
.align	32	!# 68
        setx    Thr3_ext_trap_0x68_begin, %g1, %g2
        jmp     %g2
	nop
.align	32	!# 69
	nop
...
!#*****************************************************************************************
SECTION .THR4_HTRAPS  TEXT_VA=THR4_HPTRAP_TEXT_PA
...
.align	32	!# 2a
	...
	nop
.align	32	!# 2b
	setx	Thr4_ext_trap_0x2b_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 2c
	nop
...
.align	32	!# 63
	nop
.align	32	!# 64
	setx	Thr4_ext_trap_0x64_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 65
	nop
...
.align	32	!# 67
	nop
.align	32	!# 68
        setx    Thr4_ext_trap_0x68_begin, %g1, %g2
        jmp     %g2
	nop
.align	32	!# 69
	nop
...
!#*****************************************************************************************
SECTION .THR5_HTRAPS  TEXT_VA=THR5_HPTRAP_TEXT_PA
...
.align	32	!# 2a
	...
	nop
.align	32	!# 2b
	setx	Thr5_ext_trap_0x2b_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 2c
	nop
...
.align	32	!# 63
	nop
.align	32	!# 64
	setx	Thr5_ext_trap_0x64_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 65
	nop
...
.align	32	!# 67
	nop
.align	32	!# 68
        setx    Thr5_ext_trap_0x68_begin, %g1, %g2
        jmp     %g2
	nop
.align	32	!# 69
	nop
...
!#*****************************************************************************************
SECTION .THR6_HTRAPS  TEXT_VA=THR6_HPTRAP_TEXT_PA
...
.align	32	!# 2a
	...
	nop
.align	32	!# 2b
	setx	Thr6_ext_trap_0x2b_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 2c
	nop
...
.align	32	!# 63
	nop
.align	32	!# 64
	setx	Thr6_ext_trap_0x64_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 65
	nop
...
.align	32	!# 67
	nop
.align	32	!# 68
        setx    Thr6_ext_trap_0x68_begin, %g1, %g2
        jmp     %g2
	nop
.align	32	!# 69
	nop
...
!#*****************************************************************************************
SECTION .THR7_HTRAPS  TEXT_VA=THR7_HPTRAP_TEXT_PA
...
.align	32	!# 2a
	...
	nop
.align	32	!# 2b
	setx	Thr7_ext_trap_0x2b_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 2c
	nop
...
.align	32	!# 63
	nop
.align	32	!# 64
	setx	Thr7_ext_trap_0x64_begin, %g1, %g2
	jmp	%g2
	nop
.align	32	!# 65
	nop
...
.align	32	!# 67
	nop
.align	32	!# 68
        setx    Thr7_ext_trap_0x68_begin, %g1, %g2
        jmp     %g2
	nop
.align	32	!# 69
	nop
...
.text
.global Thr0_ext_trap_0x2b_begin
.global Thr0_ext_trap_0x64_begin
.global Thr0_ext_trap_0x68_begin
.global Thr1_ext_trap_0x2b_begin
.global Thr1_ext_trap_0x64_begin
.global Thr1_ext_trap_0x68_begin
.global Thr2_ext_trap_0x2b_begin
.global Thr2_ext_trap_0x64_begin
.global Thr2_ext_trap_0x68_begin
.global Thr3_ext_trap_0x2b_begin
.global Thr3_ext_trap_0x64_begin
.global Thr3_ext_trap_0x68_begin
.global Thr4_ext_trap_0x2b_begin
.global Thr4_ext_trap_0x64_begin
.global Thr4_ext_trap_0x68_begin
.global Thr5_ext_trap_0x2b_begin
.global Thr5_ext_trap_0x64_begin
.global Thr5_ext_trap_0x68_begin
.global Thr6_ext_trap_0x2b_begin
.global Thr6_ext_trap_0x64_begin
.global Thr6_ext_trap_0x68_begin
.global Thr7_ext_trap_0x2b_begin
.global Thr7_ext_trap_0x64_begin
.global Thr7_ext_trap_0x68_begin
	
Thr0_ext_trap_0x2b_begin:
        or      ASI_DMMU_TAG_ACCESS_VAL, %g0, %g1
        ldxa    [%g1] ASI_DMMU_TAG_REG, %g2
	sub  	%g0,  1, %g1
	sllx	%g1, 13, %g1
	and	%g2, %g1, %g1
	setx	Thr0_User_Data_4u100_data_begin, %g3, %g4
	cmp	%g1, %g4
	bne	%xcc, Thr0_failed
	nop
	EXIT_GOOD
Thr0_failed:
	EXIT_BAD
Thr0_ext_trap_0x64_begin:
	EXIT_BAD
Thr0_ext_trap_0x68_begin:
	EXIT_BAD
	
Thr1_ext_trap_0x2b_begin:
        or      ASI_DMMU_TAG_ACCESS_VAL, %g0, %g1
        ldxa    [%g1] ASI_DMMU_TAG_REG, %g2
	sub  	%g0,  1, %g1
	sllx	%g1, 13, %g1
	and	%g2, %g1, %g1
	setx	Thr1_User_Data_4v100_data_begin, %g3, %g4
	cmp	%g1, %g4
	bne	%xcc, Thr1_failed
	nop
	EXIT_GOOD
Thr1_failed:
 	EXIT_BAD
Thr1_ext_trap_0x64_begin:
	EXIT_BAD
Thr1_ext_trap_0x68_begin:
	EXIT_BAD
	
Thr2_ext_trap_0x2b_begin:
        or      ASI_DMMU_TAG_ACCESS_VAL, %g0, %g1
        ldxa    [%g1] ASI_DMMU_TAG_REG, %g2
	sub  	%g0,  1, %g1
	sllx	%g1, 13, %g1
	and	%g2, %g1, %g1
	setx	Thr2_User_Data_4v100_data_begin, %g3, %g4
	cmp	%g1, %g4
	bne	%xcc, Thr2_failed
	nop
	EXIT_GOOD
Thr2_failed:
	EXIT_BAD
Thr2_ext_trap_0x64_begin:
	EXIT_BAD
Thr2_ext_trap_0x68_begin:
	EXIT_BAD
	
Thr3_ext_trap_0x2b_begin:
        or      ASI_DMMU_TAG_ACCESS_VAL, %g0, %g1
        ldxa    [%g1] ASI_DMMU_TAG_REG, %g2
	sub  	%g0,  1, %g1
	sllx	%g1, 13, %g1
	and	%g2, %g1, %g1
	setx	Thr3_User_Data_4u100_data_begin, %g3, %g4
	cmp	%g1, %g4
	bne	%xcc, Thr3_failed
	nop
	EXIT_GOOD
Thr3_failed:
	EXIT_BAD
Thr3_ext_trap_0x64_begin:
	EXIT_BAD
Thr3_ext_trap_0x68_begin:
	EXIT_BAD
	
Thr4_ext_trap_0x2b_begin:
        or      ASI_DMMU_TAG_ACCESS_VAL, %g0, %g1
        ldxa    [%g1] ASI_DMMU_TAG_REG, %g2
	sub  	%g0,  1, %g1
	sllx	%g1, 13, %g1
	and	%g2, %g1, %g1
	setx	Thr4_User_Data_4u100_data_begin, %g3, %g4
	cmp	%g1, %g4
	bne	%xcc, Thr4_failed
	nop
	EXIT_GOOD
Thr4_failed:
	EXIT_BAD
Thr4_ext_trap_0x64_begin:
	EXIT_BAD
Thr4_ext_trap_0x68_begin:
	EXIT_BAD
	
Thr5_ext_trap_0x2b_begin:
        or      ASI_DMMU_TAG_ACCESS_VAL, %g0, %g1
        ldxa    [%g1] ASI_DMMU_TAG_REG, %g2
	sub  	%g0,  1, %g1
	sllx	%g1, 13, %g1
	and	%g2, %g1, %g1
	setx	Thr5_User_Data_4v100_data_begin, %g3, %g4
	cmp	%g1, %g4
	bne	%xcc, Thr5_failed
	nop
	EXIT_GOOD
Thr5_failed:
	EXIT_BAD
Thr5_ext_trap_0x64_begin:
	EXIT_BAD
Thr5_ext_trap_0x68_begin:
	EXIT_BAD
	
Thr6_ext_trap_0x2b_begin:
        or      ASI_DMMU_TAG_ACCESS_VAL, %g0, %g1
        ldxa    [%g1] ASI_DMMU_TAG_REG, %g2
	sub  	%g0,  1, %g1
	sllx	%g1, 13, %g1
	and	%g2, %g1, %g1
	setx	Thr6_User_Data_4u100_data_begin, %g3, %g4
	cmp	%g1, %g4
	bne	%xcc, Thr6_failed
	nop
	EXIT_GOOD
Thr6_failed:
	EXIT_BAD
Thr6_ext_trap_0x64_begin:
	EXIT_BAD
Thr6_ext_trap_0x68_begin:
	EXIT_BAD
	
Thr7_ext_trap_0x2b_begin:
        or      ASI_DMMU_TAG_ACCESS_VAL, %g0, %g1
        ldxa    [%g1] ASI_DMMU_TAG_REG, %g2
	sub  	%g0,  1, %g1
	sllx	%g1, 13, %g1
	and	%g2, %g1, %g1
	setx	Thr7_User_Data_4v100_data_begin, %g3, %g4
	cmp	%g1, %g4
	bne	%xcc, Thr7_failed
	nop
	EXIT_GOOD
Thr7_failed:
	EXIT_BAD
Thr7_ext_trap_0x64_begin:
	EXIT_BAD
Thr7_ext_trap_0x68_begin:
	EXIT_BAD
