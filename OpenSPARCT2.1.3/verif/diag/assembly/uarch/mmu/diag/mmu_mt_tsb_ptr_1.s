...
* 
* OpenSPARC T2 Processor File: mmu_mt_tsb_ptr_1.s
...
trap_0x68_pa:
	!and	%g4, SUN4V_MASK, %g5
	!sllx	%g5, 3, %g5			!# %g5 has SUN4v at bit 10
	stxa	%g7, [%g0] ASI_DTLB_DATA_IN	!# Reload ITLB
	setx	ASI_SCRATCHPAD_0, %g1, %g2
	ldxa	[%g2] ASI_SCRATCHPAD, %l0
	setx	ASI_SCRATCHPAD_1, %g1, %g2
	ldxa	[%g2] ASI_SCRATCHPAD, %l1
...
Thr6_User_Text_4u000_text_begin:
	setx	Thr6_User_Data_4u100_data_begin, %l0, %l1
	stx	%l0, [%l1]
	EXIT_GOOD
...
!#*********************************************************************
SECTION .Thr7_User_Data_4v100 DATA_VA=0x0014242000
attr_data {
