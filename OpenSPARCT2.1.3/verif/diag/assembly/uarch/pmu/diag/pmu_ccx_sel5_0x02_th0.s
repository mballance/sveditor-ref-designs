...
* 
* OpenSPARC T2 Processor File: pmu_ccx_sel5_0x02_th0.s
...
!#   nop
  ...
  !# Setup PCR Register
  set 0x0000000020414088, %g2
  wr  %g2, %g0, %pcr

   !# reset pic after pcr written as boot code counts instructions
   wr %g0, %g0, %pic	

   !# init interrupt trap counter
   add %g0, 0, %i6
...
InitialCW_0:
   ...
   setx 0x5555deadbeefbad5, %l5, %l4

    add %l6, 0x0, %l6
   !# set  CWQ data
   setx 0xC1600901000A0035, %l1, %l2			!# CWQ Control Word
   mov %l2, %i7					    !# save initial CW
   ...
   !# Final Authentication State Address (40-bit)
   setx fas_result, %g1, %o2
   stx     %o2, [%l6 + 0x20]
