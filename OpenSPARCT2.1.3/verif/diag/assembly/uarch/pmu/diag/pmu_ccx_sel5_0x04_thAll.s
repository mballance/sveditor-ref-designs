...
* 
* OpenSPARC T2 Processor File: pmu_ccx_sel5_0x04_thAll.s
...
thread_0:
  ...
  !# Setup PCR Register
  set 0x0000000020414108, %g2
  wr  %g2, %g0, %pcr

  or %g0, %g0, %g3 
ccx_ld_th0:
  umul %g3, 32, %g4
  setx DATA0_0x0, %g1, %l5
  ldx   [%l5 + %g4], %l1
  add %g3, 1 , %g3
  cmp %g3, PIC_COUNT_th0
  bne,pn %xcc, ccx_ld_th0 
  nop
...
ccx_ld_th1:
  umul %g3, 32, %g4
  setx DATA1_0x0, %g1, %l5
  ldx   [%l5 + %g4], %l1
  add %g3, 1 , %g3
  cmp %g3, PIC_COUNT_th1
  bne,pn %xcc, ccx_ld_th1 
  nop
...
ccx_ld_th2:
  umul %g3, 32, %g4
  setx DATA2_0x0, %g1, %l5
  ldx   [%l5 + %g4], %l1
  add %g3, 1 , %g3
  cmp %g3, PIC_COUNT_th2
  bne,pn %xcc, ccx_ld_th2 
  nop
...
ccx_ld_th3:
  umul %g3, 32, %g4
  setx DATA3_0x0, %g1, %l5
  ldx   [%l5 + %g4], %l1
  add %g3, 1 , %g3
  cmp %g3, PIC_COUNT_th3
  bne,pn %xcc, ccx_ld_th3 
  nop
...
ccx_ld_th4:
  umul %g3, 32, %g4
  setx DATA4_0x0, %g1, %l5
  ldx   [%l5 + %g4], %l1
  add %g3, 1 , %g3
  cmp %g3, PIC_COUNT_th4
  bne,pn %xcc, ccx_ld_th4 
  nop
...
ccx_ld_th5:
  umul %g3, 32, %g4
  setx DATA5_0x0, %g1, %l5
  ldx   [%l5 + %g4], %l1
  add %g3, 1 , %g3
  cmp %g3, PIC_COUNT_th5
  bne,pn %xcc, ccx_ld_th5 
  nop
...
ccx_ld_th6:
  umul %g3, 32, %g4
  setx DATA6_0x0, %g1, %l5
  ldx   [%l5 + %g4], %l1
  add %g3, 1 , %g3
  cmp %g3, PIC_COUNT_th6
  bne,pn %xcc, ccx_ld_th6 
  nop
...
ccx_ld_th7:
  umul %g3, 32, %g4
  setx DATA7_0x0, %g1, %l5
  ldx   [%l5 + %g4], %l1
  add %g3, 1 , %g3
  cmp %g3, PIC_COUNT_th7
  bne,pn %xcc, ccx_ld_th7 
  nop
