...
* 
* OpenSPARC T2 Processor File: Debug_Quiscen_Mode.s
...
P_TxDMAActivate:
	...
	nop
        setx 0x0,%l6,%l1
        stx %l1,[%l2]    !reset the niu stall bit.
...
P_InitTxDma:
	...
	*************************************/
inj_err:
        nop                     !$EV trig_pc_d(0,@VA(.MAIN.inj_err)) ->IosRandErrInj(NIUSII_CCE, 3, 5)
