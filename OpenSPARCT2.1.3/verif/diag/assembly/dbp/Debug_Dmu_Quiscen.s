...
* 
* OpenSPARC T2 Processor File: Debug_Dmu_Quiscen.s
...
#define DBG_IO_QUISCE	 0x8600000008
#define DBG_IOQ_VAL	 0x1
#define DBG_IOQ_DMUStall 0x1
#define DBG_IOQ_DmuStallDone 0x4
#define DBG_IOQ_DmuStallRst  0x1
...
main:
	...
	setx DBG_IO_QUISCE,%l0,%l2
	setx DBG_IOQ_VAL,%l3,%l4
	stx %l4,[%l2]
	nop
	membar #Sync
	setx 0xf,%g1,%g3
...
!	setx 0x0,%g2,%l1
	setx DBG_IO_QUISCE,%l0,%l2	
	stx %l1,[%l2]    !reset the dmu stall bit.
        nop
	membar #Sync	
