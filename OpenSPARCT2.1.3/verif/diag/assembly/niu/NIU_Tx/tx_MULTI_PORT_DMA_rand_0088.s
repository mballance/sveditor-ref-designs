...
* 
* OpenSPARC T2 Processor File: tx_MULTI_PORT_DMA_rand_0088.s
...
SetTxRingKick_0:
	setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2	 ! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_0)) -> NIU_SetTxRingKick(0, 3, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x3,    %g1, %o0
!       setx    NIU_TX_MULTI_PORT, %g1, %o2
!      	setx    NIU_TX_MULTI_DMA_P0, %g1, %o3
	ldx     [%g2]                  , %g3
...
SetTxRingKick_1:
	setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2	 ! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_1)) -> NIU_SetTxRingKick(1, 7, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x7,    %g1, %o0
!       setx    NIU_TX_MULTI_PORT, %g1, %o2
!       setx    NIU_TX_MULTI_DMA_P1, %g1, %o4
	ldx     [%g2]                  , %g3
