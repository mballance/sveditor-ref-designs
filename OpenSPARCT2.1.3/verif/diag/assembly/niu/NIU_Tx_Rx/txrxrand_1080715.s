...
* 
* OpenSPARC T2 Processor File: txrxrand_1080715.s
...
Gen_Packet:
	nop	 ! $EV trig_pc_d(1, @VA(.MAIN.Gen_Packet)) -> TxPktGen(MAC_ID, f, 0x58)
	nop
...
SetTxRingKick:
	setx    0x100000100, %g1, %g2	 ! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick)) -> NIU_SetTxRingKick(MAC_ID, f)
	setx    0xf,    %g1, %o0
