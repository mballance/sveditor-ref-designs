...
* 
* OpenSPARC T2 Processor File: txrxrand_wrm_macp.s
...
delay_loop_warm:
        ...
        nop
        #call    N2_NIU_INIT
        #setx	xpcs0_control1_addr, %g7, %g2
	#setx	xpcs0_control1_data, %g7, %g3
	#stxa	 %g3, [%g2]ASI_PRIMARY_LITTLE
	#add	 %g2, %l2, %g2
	#stxa	 %g3, [%g2]ASI_PRIMARY_LITTLE
	setx	ipp_config0_addr, %g7, %g2
	setx	ipp_config_data, %g7, %g3
	stxa	%g3, [%g2]ASI_PRIMARY_LITTLE
	best_set_reg(0x8000, %l1, %l2)
	or	%g2, %l2, %g2
	stxa	%g3, [%g2]ASI_PRIMARY_LITTLE
	setx	txc_dma_maxburst_addr, %g7, %g2
	best_set_reg(txc_dma_maxburst_data, %g7, %g3)
	stxa	%g3, [%g2]ASI_PRIMARY_LITTLE

	setx	txc_port0_control_addr, %g7, %g2
	best_set_reg(txc_port0_control_data, %g7, %g3)
	stxa	%g3, [%g2]ASI_PRIMARY_LITTLE
	add	%g2, 0x100, %g2
	stxa	%g3, [%g2]ASI_PRIMARY_LITTLE

	setx	txc_control_addr, %g7, %g2
	best_set_reg(txc_control_data, %g7, %g3)
	stxa	%g3, [%g2]ASI_PRIMARY_LITTLE
	nop
        setx    xmac_config0, %g7, %g2
        ldxa    [%g2]ASI_PRIMARY_LITTLE, %g3
        setx    0x00000100, %g7, %g4
        or      %g4, %g3, %g3
        stxa    %g3, [%g2]ASI_PRIMARY_LITTLE
