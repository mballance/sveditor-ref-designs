...
* 
* OpenSPARC T2 Processor File: FcNiuBasicTxRx_MULTI_FFFF_DMA_FF_DMA.s
...
SetTxRingKick_1:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_1)) -> NIU_SetTxRingKick(0, 1, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x1,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_2:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_2)) -> NIU_SetTxRingKick(0, 2, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x2,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_3:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_3)) -> NIU_SetTxRingKick(0, 3, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x3,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_4:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_4)) -> NIU_SetTxRingKick(0, 4, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x4,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_5:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_5)) -> NIU_SetTxRingKick(0, 5, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x5,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_6:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_6)) -> NIU_SetTxRingKick(0, 6, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x6,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_7:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_7)) -> NIU_SetTxRingKick(0, 7, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x7,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_8:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_8)) -> NIU_SetTxRingKick(1, 8, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x8,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_9:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_9)) -> NIU_SetTxRingKick(1, 9, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0x9,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_a:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_a)) -> NIU_SetTxRingKick(1, a, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0xa,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_b:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_b)) -> NIU_SetTxRingKick(1, b, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0xb,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_c:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_c)) -> NIU_SetTxRingKick(1, c, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0xc,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_d:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_d)) -> NIU_SetTxRingKick(1, d, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0xd,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_e:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_e)) -> NIU_SetTxRingKick(1, e, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0xe,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
SetTxRingKick_f:
        setx    NIU_PKTGEN_CSR_EV2A_TX_RNG_KICK, %g1, %g2		! $EV trig_pc_d(1, @VA(.MAIN.SetTxRingKick_f)) -> NIU_SetTxRingKick(1, f, NIU_TX_MULTI_PORT, NIU_TX_MULTI_DMA_P0, NIU_TX_MULTI_DMA_P1)
	setx    0xf,            %g1, %o0 
        ldx     [%g2]                  , %g3    
        nop
        mulx     %o0, 0x200, %g5
...
/************************************************************************
   NIU RX Template Port 0 ---> DMA(0,2,4,6)
                   Port 1 ---> DMA(1,3,5,7)
 ************************************************************************/
...
P_NIU_RxInitDma_6:
	setx    TX_CS, %g1, %g2
	nop	 ! $EV trig_pc_d(1, @VA(.MAIN.P_NIU_RxInitDma_6)) -> NIU_InitRxDma(6, RX_DESC_RING_LENGTH, RX_COMPL_RING_LEN, RBR_CONFIG_B_DATA, RX_INITIAL_KICK, 0x0, NIU_RX_MULTI_DMA)
        setx    0x5, %g1, %g4
delay_loop_Rx_6:
        ldxa    [%g2]ASI_PRIMARY_LITTLE, %g5
        nop
...
P_NIU_RxInitDma_7:
	nop	 ! $EV trig_pc_d(1, @VA(.MAIN.P_NIU_RxInitDma_7)) -> NIU_InitRxDma(7, RX_DESC_RING_LENGTH, RX_COMPL_RING_LEN, RBR_CONFIG_B_DATA, RX_INITIAL_KICK, 0x0, NIU_RX_MULTI_DMA)
        setx    0x5, %g1, %g4
delay_loop_Rx_7:
        ldxa    [%g2]ASI_PRIMARY_LITTLE, %g5
        nop
...
P_NIU_Rx_GenPkt:
	...
	nop
Rx_pktcnt_loop:
	nop	 ! $EV trig_pc_d(1, @VA(.MAIN.Rx_pktcnt_loop)) -> NIU_RxGenPkt(MAC_ID, 0, RXMAC_PKTCNT, 0x100,0x1, NIU_RX_MULTI_DMA, 1)
	ldxa    [%g2]ASI_PRIMARY_LITTLE, %g5
	nop
	nop
	nop
