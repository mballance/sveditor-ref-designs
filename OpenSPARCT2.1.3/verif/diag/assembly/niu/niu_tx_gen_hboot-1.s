...
* 
* OpenSPARC T2 Processor File: niu_tx_gen_hboot-1.s
...
Gen_Packet:
	nop			! $EV trig_pc_d(1, @VA(.MAIN.Gen_Packet)) -> pktgen(0,10)

	setx    0x0000008100640000, %g1, %g2
	setx    0x0ffff00000000037 , %g1, %g3
	stxa    %g3, [%g2]ASI_PRIMARY_LITTLE
	nop
	setx    0x0000008100640018, %g1, %g2
	setx    0x0010e7a529800084 , %g1, %g3
	stxa    %g3, [%g2]ASI_PRIMARY_LITTLE
	nop
