...
* 
* OpenSPARC T2 Processor File: rx_p0_MULTI_2DMA_rand_0C.s
...
P_NIU_RxInitDma_0:
	setx    TX_CS, %g1, %g2
	nop	 ! $EV trig_pc_d(1, @VA(.MAIN.P_NIU_RxInitDma_0)) -> NIU_InitRxDma(2, RX_DESC_RING_LENGTH, RX_COMPL_RING_LEN, RBR_CONFIG_B_DATA, RX_INITIAL_KICK, 0x0, NIU_RX_MULTI_DMA)
        setx    0x5, %g1, %g4
delay_loop_Rx_0:
...
P_NIU_RxInitDma_1:
	nop	 ! $EV trig_pc_d(1, @VA(.MAIN.P_NIU_RxInitDma_1)) -> NIU_InitRxDma(3, RX_DESC_RING_LENGTH, RX_COMPL_RING_LEN, RBR_CONFIG_B_DATA, RX_INITIAL_KICK, 0x0, NIU_RX_MULTI_DMA)
        setx    0x5, %g1, %g4
delay_loop_Rx_1:
        ldxa    [%g2]ASI_PRIMARY_LITTLE, %g5
        nop
...
P_NIU_Rx_GenPkt:
	...
	nop
Rx_pktcnt_loop:
	nop	 ! $EV trig_pc_d(1, @VA(.MAIN.Rx_pktcnt_loop)) -> NIU_RxGenPkt(MAC_ID, 0, RXMAC_PKTCNT, 0x41,0x0, NIU_RX_MULTI_DMA, 1)
	ldxa    [%g2]ASI_PRIMARY_LITTLE, %g5
	nop
	nop
	nop
