...
* 
* OpenSPARC T2 Processor File: n2_err_siu_niu_tx_trap.s
...
SetTxCs :
	...
	mulx     %o0, 0x200, %g5
		...
		/* Extra Delay for Jumbo packets to go out */
        setx    LDGIMGN, %g1, %g2
...
delay_ras:
        ...
        *************************************/
        ...
        !but dont expect it to be zero; as a follow up
        ! transaction can again set it
read_esr:
        setx    SOC_ESR_REG, %l7, %i0
        ldx     [%i0], %i1
