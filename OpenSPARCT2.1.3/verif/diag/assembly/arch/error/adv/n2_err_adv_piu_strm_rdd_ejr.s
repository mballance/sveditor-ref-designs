...
* 
* OpenSPARC T2 Processor File: n2_err_adv_piu_strm_rdd_ejr.s
...
PIO1_noexp: nop;
! $EV trig_pc_d(1, @VA(.MAIN.PIO1_noexp)) -> EnablePCIeIgCmd ("PIO_NOEXP",0,0,0,1)

PIO1:   nop; nop; nop; nop; nop; nop; nop; nop;nop; nop; nop; nop;




UsrEvnt_rdd_1:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_1)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1, *, * )
...
UsrEvnt_rdd_2:
	...
	nop
	nop
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_2)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR2, DMA_DATA_BYP_ADDR2, "64'h40", 1, *, * )

UsrEvnt_rdd_3:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_3)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR3, DMA_DATA_BYP_ADDR3, "64'h40", 1, *, * )

UsrEvnt_rdd_4:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_4)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR4, DMA_DATA_BYP_ADDR4, "64'h40", 1, *, * )

UsrEvnt_rdd_5:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_5)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR5, DMA_DATA_BYP_ADDR5, "64'h40", 1, *, * )

UsrEvnt_rdd_6:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_6)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR6, DMA_DATA_BYP_ADDR6, "64'h40", 1, *, * )

UsrEvnt_rdd_7:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_7)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR7, DMA_DATA_BYP_ADDR7, "64'h40", 1, *, * )
...
PIO2:   nop; nop; nop; nop; nop; nop; nop; nop;nop; nop; nop; nop;




UsrEvnt_rdd_8:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_8)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR8, DMA_DATA_BYP_ADDR8, "64'h40", 1, *, * )
...
UsrEvnt_rdd_9:
	...
	nop
	nop
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_9)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR9, DMA_DATA_BYP_ADDR9, "64'h40", 1, *, * )

UsrEvnt_rdd_10:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_10)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR10, DMA_DATA_BYP_ADDR10, "64'h40", 1, *, * )

UsrEvnt_rdd_11:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_11)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR11, DMA_DATA_BYP_ADDR11, "64'h40", 1, *, * )

UsrEvnt_rdd_12:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_12)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR12, DMA_DATA_BYP_ADDR12, "64'h40", 1, *, * )

UsrEvnt_rdd_13:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_13)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR13, DMA_DATA_BYP_ADDR13, "64'h40", 1, *, * )
...
PIO3:   nop; nop; nop; nop; nop; nop; nop; nop;nop; nop; nop; nop; nop; nop; nop; nop;

UsrEvnt_rdd_14:
        nop         ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_14)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR14, DMA_DATA_BYP_ADDR14, "64'h40", 1, *, * )
...
UsrEvnt_rdd_15:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_15)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR15, DMA_DATA_BYP_ADDR15, "64'h40", 1, *, * )

UsrEvnt_rdd_16:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_16)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR16, DMA_DATA_BYP_ADDR16, "64'h40", 1, *, * )

UsrEvnt_rdd_17:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_17)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR17, DMA_DATA_BYP_ADDR17, "64'h40", 1, *, * )

UsrEvnt_rdd_18:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_18)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR18, DMA_DATA_BYP_ADDR18, "64'h40", 1, *, * )

UsrEvnt_rdd_19:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_19)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR19, DMA_DATA_BYP_ADDR19, "64'h40", 1, *, * )

UsrEvnt_rdd_20:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_20)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR20, DMA_DATA_BYP_ADDR20, "64'h40", 1, *, * )

UsrEvnt_rdd_21:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd_21)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR21, DMA_DATA_BYP_ADDR21, "64'h40", 1, *, * )
...
pios:
	...
	!only checks that at least one trap taken
err_trap_loop_rdd:
	cmp	%g0, %i7
	be	%xcc, test_failed 
	nop
...
/*
	avoid syndrome chk as error injection is not controlled
check_synd:
	setx	SOC_SII_SYN_REG, %g7, %g1
	ldx	[%g1], %g2
	setx	0x8700000000000000, %g7, %g1
	and	%g2, %g1, %g3
	setx	SII_SYND, %g7, %g4
	cmp	%g3, %g4
	bne	%xcc, test_failed
