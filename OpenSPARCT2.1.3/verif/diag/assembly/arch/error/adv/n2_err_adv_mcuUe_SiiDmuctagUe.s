...
* 
* OpenSPARC T2 Processor File: n2_err_adv_mcuUe_SiiDmuctagUe.s
...
#define TEST_DATA1		0x55555555
#define PA1                     0x2000aa00
#define PA2                     0x1000aa00
...
store_to_L2_way0:
	set  TEST_DATA1, %g5
	set  PA1, %g2  ! bits [21:18] select way
...
write_mcu_channel_0:
	set  PA2, %g3 ! bits [21:18] select way
...
dma_rdd:
	nop
UsrEvnt_rdd:
        nop         ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_rdd)) -> EnablePCIeIgCmd ("DMARD_DROP", ADDR1, ADDR1, "64'h40", 1, *, * )
