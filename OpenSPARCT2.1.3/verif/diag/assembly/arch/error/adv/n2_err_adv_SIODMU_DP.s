...
* 
* OpenSPARC T2 Processor File: n2_err_adv_SIODMU_DP.s
...
inj_err6:
        nop                     !$EV trig_pc_d(0,@VA(.MAIN.inj_err6)) ->IosErrInj(SIODMU_DP, 0001, 123456000)

Wr_Evnt6: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt6) -> EnablePCIeIgCmd ("DMARD_UE", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )

        ldx     [%g2], %g3
esr6:
        setx     0x8000000000002000, %g7, %g5                        ! DmuDP
