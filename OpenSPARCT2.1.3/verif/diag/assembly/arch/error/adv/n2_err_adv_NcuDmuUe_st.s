...
* 
* OpenSPARC T2 Processor File: n2_err_adv_NcuDmuUe_st.s
...
! This store does not complete; Informing Bench Code not to expect this store.
Bench_noExp: nop;
! $EV trig_pc_d(1, @VA(.MAIN.Bench_noExp)) -> EnablePCIeIgCmd ("PIO_NOEXP",0,0,0,1) 

PIO2:	nop; nop; nop; nop; nop; nop; nop; nop; nop; nop; nop; nop; nop; nop;nop; nop; nop; nop; nop; nop;

st_peu_err:
        ! select a CFG address in PCI address range and transmit the command to NCU
        setx    IO_WR_ADDR, %g1, %g2
        setx    0x77777777, %g1, %l0
        stw     %l0, [%g2]
...
read_err_addr:
	! 2nd st which is with error, should not have committed; so ld should get the old value
        setx    IO_WR_ADDR, %g1, %g2
        ld      [%g2], %g1
	set	0x55555555, %g2
	cmp	%g1, %g2
