...
* 
* OpenSPARC T2 Processor File: n2_err_adv_L2SIO_CCE.s
...
inj_err8:
        nop                     !$EV trig_pc_d(0,@VA(.MAIN.inj_err8)) ->IosErrInj(L2SIO_CCE, 0001, 123456000)

Wr_Evnt8: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt8) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )

        ldx     [%g2], %g3
esr8:
        setx     0x8000000004000000, %g7, %g5                        !SioCtagCe
...
eie_8:
        ...
        setx    0x4000000,%g7,  %g1                        ! SioCtagCe
        stx     %g1, [%g2]
        membar  0x40
