...
* 
* OpenSPARC T2 Processor File: n2_err_adv_SIODMU_CCE.s
...
inj_err4:
        nop                     !$EV trig_pc_d(0,@VA(.MAIN.inj_err4)) ->IosErrInj(SIODMU_CCE, 0001, 123456000)

Wr_Evnt4: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt4) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )

        ldx     [%g2], %g3
esr4:
        setx     0x8000000000000400, %g7, %g5                        ! DmuCtagCe
