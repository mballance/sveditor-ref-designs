...
* 
* OpenSPARC T2 Processor File: n2_err_adv_L2SIO_CUE.s
...
inj_err7:
        nop                     !$EV trig_pc_d(0,@VA(.MAIN.inj_err7)) ->IosErrInj(L2SIO_CUE, 0001, 123456000)

Wr_Evnt7: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt7) -> EnablePCIeIgCmd ("DMARD_DROP", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )

        ldx     [%g2], %g3
esr7:
        setx     0x8000000002000000, %g7, %g5                        ! SioCtagUe
...
eie_7:
        ...
        setx    0x2000000,%g7,  %g1                        ! SioCtagUe
        stx     %g1, [%g2]
        membar  0x40
