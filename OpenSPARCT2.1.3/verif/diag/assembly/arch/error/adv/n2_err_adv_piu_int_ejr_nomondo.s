...
* 
* OpenSPARC T2 Processor File: n2_err_adv_piu_int_ejr_nomondo.s
...
intr_wait1:
	setx	0x200, %g1, %g2			! timeout count
...
intr_wait_loop1:
	...
	ld	[%g7], %g5
	cmp	%g5, 1
	be	test_failed		! INT should not be sent to cross bar; so no INT
	nop
