...
* 
* OpenSPARC T2 Processor File: n2_err_adv_DMUSII_AP.s
...
inj_err3: nop
	!$EV trig_pc_d(0,@VA(.MAIN.inj_err3)) ->IosErrInj(DMUSII_AP, 0, 123456000)

Wr_Evnt3: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt3) -> EnablePCIeIgCmd ("DMARD_DROP", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )

        ldx     [%g2], %g3
esr3:
        setx     0x8000000000000080, %g7, %g5                        !SiiDmuAP
