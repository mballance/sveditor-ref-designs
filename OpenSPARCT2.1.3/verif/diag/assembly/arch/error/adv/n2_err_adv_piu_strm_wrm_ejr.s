...
* 
* OpenSPARC T2 Processor File: n2_err_adv_piu_strm_wrm_ejr.s
...
clear_mem:
	setx	0x123410c00, %g7, %g1
	stx	%g0, [%g1]
	setx	0x123411800, %g7, %g1
	stx	%g0, [%g1]
...
UsrEvnt_wrm_1:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_1)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h10", 1 )
...
UsrEvnt_wrm_2:
	...
	nop
	nop
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_2)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR2, DMA_DATA_BYP_ADDR2, "64'h10", 1 )

UsrEvnt_wrm_3:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_3)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR3, DMA_DATA_BYP_ADDR3, "64'h10", 1 )

UsrEvnt_wrm_4:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_4)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR4, DMA_DATA_BYP_ADDR4, "64'h10", 1 )

UsrEvnt_wrm_5:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_5)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR5, DMA_DATA_BYP_ADDR5, "64'h10", 1 )

UsrEvnt_wrm_6:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_6)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR6, DMA_DATA_BYP_ADDR6, "64'h10", 1 )

UsrEvnt_wrm_7:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_7)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR7, DMA_DATA_BYP_ADDR7, "64'h10", 1 )


	!check that the last data from DMA is written to memory
read_ADDR7:
	setx	0x123410c00, %g7, %g1
	ld	[%g1], %g3
	cmp	%g3, %g0
...
UsrEvnt_wrm_8:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_8)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR8, DMA_DATA_BYP_ADDR8, "64'h10", 1 )
...
UsrEvnt_wrm_9:
	...
	nop
	nop
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_9)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR9, DMA_DATA_BYP_ADDR9, "64'h10", 1 )

UsrEvnt_wrm_10:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_10)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR10, DMA_DATA_BYP_ADDR10, "64'h10", 1 )

UsrEvnt_wrm_11:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_11)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR11, DMA_DATA_BYP_ADDR11, "64'h10", 1 )

UsrEvnt_wrm_12:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_12)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR12, DMA_DATA_BYP_ADDR12, "64'h10", 1 )

UsrEvnt_wrm_13:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_13)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR13, DMA_DATA_BYP_ADDR13, "64'h10", 1 )
...
UsrEvnt_wrm_14:
        nop         ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_14)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR14, DMA_DATA_BYP_ADDR14, "64'h10", 1 )
...
UsrEvnt_wrm_15:
	...
	nop
	nop
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_15)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR15, DMA_DATA_BYP_ADDR15, "64'h10", 1 )

UsrEvnt_wrm_16:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_16)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR16, DMA_DATA_BYP_ADDR16, "64'h10", 1 )

UsrEvnt_wrm_17:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_17)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR17, DMA_DATA_BYP_ADDR17, "64'h10", 1 )

UsrEvnt_wrm_18:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_18)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR18, DMA_DATA_BYP_ADDR18, "64'h10", 1 )

UsrEvnt_wrm_19:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_19)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR19, DMA_DATA_BYP_ADDR19, "64'h10", 1 )

UsrEvnt_wrm_20:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_20)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR20, DMA_DATA_BYP_ADDR20, "64'h10", 1 )

UsrEvnt_wrm_21:
	nop	       ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wrm_21)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR21, DMA_DATA_BYP_ADDR21, "64'h10", 1 )
...
check_mcu_esr:
        ...
        ldx   	[%g6], %g3
	setx    0xff30000000000000, %g7, %g1
	and	%g1, %g3, %g2

	mov	1, %g1
	sllx	%g1, DRAM_ES_DBU, %g3

        mov     1, %g1
        sllx    %g1, DRAM_ES_MEB, %g4
...
both_l2_soc:
        ...
        subcc   %g2, %g3, %g4
        brz     %g4, clear_ejr_tt40 
        nop

two_l2_err:
	setx	0xf000000000000000, %l0, %g3
	subcc	%g2, %g3, %g4
	brnz    %g4, test_failed 
	nop
