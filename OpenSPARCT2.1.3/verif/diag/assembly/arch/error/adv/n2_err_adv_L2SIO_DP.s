...
* 
* OpenSPARC T2 Processor File: n2_err_adv_L2SIO_DP.s
...
inj_err2:
        nop                     !$EV trig_pc_d(0,@VA(.MAIN.inj_err2)) ->IosErrInj(L2SIO_DP, 0001, 123456000)

Wr_Evnt2: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt2) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )

        ldx     [%g2], %g3
esr2:
        setx    0x8000000000002000, %g7, %g5			!SiiDmuCtagUe
