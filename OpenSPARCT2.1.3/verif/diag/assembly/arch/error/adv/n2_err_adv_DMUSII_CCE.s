...
* 
* OpenSPARC T2 Processor File: n2_err_adv_DMUSII_CCE.s
...
inj_err1:
        nop                     !$EV trig_pc_d(0,@VA(.MAIN.inj_err1)) ->IosErrInj(DMUSII_CCE, 0, 123456000)

Wr_Evnt1: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt1) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h20", 1 )

        ldx     [%g2], %g3
esr1:
        setx   	0x8000000000000008, %g7, %g5			! SiiDmuCTagCe
