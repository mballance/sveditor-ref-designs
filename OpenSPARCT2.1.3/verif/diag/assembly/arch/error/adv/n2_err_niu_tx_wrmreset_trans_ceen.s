...
* 
* OpenSPARC T2 Processor File: n2_err_niu_tx_wrmreset_trans_ceen.s
...
check_esr_after_wrm:
        setx	SOC_ESR_REG, %l7, %g6
	ldx	[%i0], %g1

	setx	0x8000000000000000, %g7, %g3	!valid bit
	set	0x1, %l2
	sllx	%l2, ERR_FIELD, %g4
	or	%g3, %g4, %g5
