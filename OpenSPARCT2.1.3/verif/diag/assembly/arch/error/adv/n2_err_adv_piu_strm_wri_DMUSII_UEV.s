...
* 
* OpenSPARC T2 Processor File: n2_err_adv_piu_strm_wri_DMUSII_UEV.s
...
inj_err1: nop
	!$EV trig_pc_d(0,@VA(.MAIN.inj_err1)) ->IosErrInj(ERR_TYPE, 0, 123410000)
...
UsrEvnt_wri_2:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wri_2)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR2, DMA_DATA_BYP_ADDR3, "64'h40", 5, *, * )


inj_err3: nop
	!$EV trig_pc_d(0,@VA(.MAIN.inj_err3)) ->IosErrInj(ERR_TYPE, 0, 123410600)
        nop; nop; nop; nop; nop; nop; nop; nop; nop;
        nop; nop; nop;nop; nop; nop;nop; nop; nop;
UsrEvnt_wri_3:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wri_3)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR4, DMA_DATA_BYP_ADDR4, "64'h40", 1, *, * )


UsrEvnt_wri_4:
	nop	    ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wri_4)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR5, DMA_DATA_BYP_ADDR6, "64'h40", 5, *, * )


inj_err5: nop
	!$EV trig_pc_d(0,@VA(.MAIN.inj_err5)) ->IosErrInj(ERR_TYPE, 0, 123410c00)
        nop; nop; nop; nop; nop; nop; nop; nop; nop;
	nop; nop; nop;nop; nop; nop;nop; nop; nop;
UsrEvnt_wri_5:
        nop         ! $EV trig_pc_d(1, @VA(.MAIN.UsrEvnt_wri_5)) -> EnablePCIeIgCmd ("DMAWR", DMA_DATA_BYP_ADDR7, DMA_DATA_BYP_ADDR7, "64'h40", 1, *, * )
	...
	set	0x3, %g1			! 1 Trap; only for NCU DmuDParity
						! For RDD SIU does not send PA39, only sets E bit
						! So no trap from L2 
