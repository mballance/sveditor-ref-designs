...
* 
* OpenSPARC T2 Processor File: n2_err_adv_SIODMU_CUE.s
...
inj_err5:
        nop                     !$EV trig_pc_d(0,@VA(.MAIN.inj_err5)) ->IosErrInj(SIODMU_CUE, 0001, 123456000)

Wr_Evnt5: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt5) -> EnablePCIeIgCmd ("DMARD_DROP", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )
