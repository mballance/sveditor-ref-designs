...
* 
* OpenSPARC T2 Processor File: Ldrc_Mcu_Io_err.s
...
XmtUsrEvnt_ldrc_mec:
        nop         ! $EV trig_pc_d(1, @VA(.MAIN.XmtUsrEvnt_ldrc_mec)) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_SADDR, DMA_DATA_BYP_SADDR, "64'h40", 1, *, * )
