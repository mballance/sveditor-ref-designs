...
* 
* OpenSPARC T2 Processor File: n2_err_pio_DMUSII_CMDP.s
...
inj_err1: nop
	!$EV trig_pc_d(0,@VA(.MAIN.inj_err1)) ->IosErrInj(DMUSII_CMDP, 8000, 000)
...
check_synd:
	...
	ldx	[%g1], %g2
	setx	0x8180000000000000, %g7, %g3		! PA=0x0; CTAG=0x8000; ETAG=0x1
	cmp	%g2, %g3
	bne	%xcc, test_failed
	nop
