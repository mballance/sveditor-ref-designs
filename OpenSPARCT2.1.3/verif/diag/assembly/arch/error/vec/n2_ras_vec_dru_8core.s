...
* 
* OpenSPARC T2 Processor File: n2_ras_vec_dru_8core.s
...
#define	DRAM_ES_W1C_VALUE  	0xffc0000000000000
...
main_th_a:
	...
	setx    0x3330000, %g7, %g3
	stx	%g0, [%g3]
wait_for_other_th:
	ldx	[%g3], %g4
	cmp	%g4, %g0
	be	%xcc, wait_for_other_th
	nop
...
set_L2_Directly_Mapped_Mode_errorsteer:
	...
	set	TH_B, %o3
	sllx	%o3, 15, %o4		! thid of 2nd thread to be core-steering thread
        or      %o5, %o4, %o5
...
cause_trap:
	...
	setx	0x20008000, %g3, %g1
	stx	%g2, [%g1]
	setx	0x80080000, %g3, %g1
	ldx	[%g1], %g2

	setx	0x20000040, %g3, %g1
	stx	 %g2, [%g1]
	setx	0x80080040, %g3, %g1
	ldx	[%g1], %g2

	setx	0x20000080, %g3, %g1
	stx	 %g2, [%g1]
	setx	0x80080000, %g3, %g1
	ldx	[%g1], %g2

	setx	0x200080c0, %g3, %g1
	stx	 %g2, [%g1]
	setx	0x800800c0, %g3, %g1
	ldx	[%g1], %g2

	setx	0x20000100, %g3, %g1
	stx	 %g2, [%g1]
	setx	0x80000100, %g3, %g1
	ldx	[%g1], %g2

	setx	0x20000140, %g3, %g1
	stx	 %g2, [%g1]
	setx	0x80000140, %g3, %g1
	ldx	[%g1], %g2

	setx	0x20000180, %g3, %g1
	stx	 %g2, [%g1]
	setx	0x80000180, %g3, %g1
	ldx	[%g1], %g2

	setx	0x200001c0, %g3, %g1
	stx	 %g2, [%g1]
	setx	0x800001c0, %g3, %g1
	ldx	[%g1], %g2
