...
* 
* OpenSPARC T2 Processor File: n2_ras_vec_mcu_dac_strm.s
...
store_alias:
	...
	/******* Read Errror Addr *************/
        ...
        setx    ERROR_ADDR, %l0, %g2
read_err_addr:
	clr	%o0			! clear %o0 each time before error addr access
        ldx     [%g2], %g7

	/******* wait for trap ****************/
	setx	FILL_ADDR, %l0, %g3
	clr	%i5
trap_wait:
	cmp	%o0, %g0
	bne	%xcc, next_error_addr 
	nop
...
check_l2esr:
	...
	setx	0xb03ffffc00000000, %g7, %g4		! take out MEC, VCID, SYND check
	and	%g2, %g4, %g2

	setx	0x41000000000, %g7, %g3			! VEC, DAC
	cmp	%g2, %g3
	bne	%xcc, test_fail
	nop
...
check_mcuesr:
        ...
        ldx   	[%g1], %g2
	setx	0xbfc0000000000000, %g7, %g4
	and	%g2, %g4, %g2

        setx    0x2000000000000000, %g7, %g3	!DAC
        cmp     %g2, %g3
        bne     %xcc, test_fail
        nop
