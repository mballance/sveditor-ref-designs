...
* 
* OpenSPARC T2 Processor File: n2_ras_vec_l2_da_ue_trap.s
...
check_DSFSR_0x32:
	...
	set	0xf, %l1
	and	%g2, %l1, %l3
	mov	0x1, %l5			! content of D-SFSR Error type field = 0x1 (DCL2U)
	cmp	%l5, %l3
	bne	%xcc, test_fail
	nop
