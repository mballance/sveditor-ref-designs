...
* 
* OpenSPARC T2 Processor File: n2_err_L2_NotData.s
...
check_notData_reg_meu:
  setx  L2_NDDM_REG, %l3, %g5
  ldx   [%g5], %l6

compute_notData_reg_meu:
  setx  0xa00002000aa00, %l0, %l1  ! bits [21:18] select way
  cmp   %l6, %l1
  bne   %xcc, test_fail
  nop
