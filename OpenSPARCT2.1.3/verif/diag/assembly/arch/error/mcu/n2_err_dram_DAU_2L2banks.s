...
* 
* OpenSPARC T2 Processor File: n2_err_dram_DAU_2L2banks.s
...
#define  L2_ERR_STAT_REG1   0xAB00000040
...
store_to_L2_way0:
  setx  0x2020aa00, %l0, %g2  ! bits [21:18] select way
  stx %g5, [%g2]
  stx %g5, [%g2+8]
  membar #Sync
...
write_mcu_channel_0:
  setx  0x2010aa00, %l0, %g3 ! bits [21:18] select way
  stx %g5, [%g3]
  stx %g5, [%g3+8]
  membar #Sync


read_error_address_L20:
!  stx %g5, [%g2]
  ldx   [%g2], %l1
  membar #Sync

read_error_address_L21:
  setx  0x2020aa40, %l0, %g2  ! bits [21:18] select way
  ldx   [%g2], %l1
  membar #Sync
!  ldx   [%g3], %l2
!  membar #Sync
...
check_l2_EAR:
  ...
  setx  0x2020aa00, %l0, %l1  ! bits [21:18] select way
