...
* 
* OpenSPARC T2 Processor File: n2_err_dram_dau_fbr.s
...
#define H_HT0_Data_access_error_0x32     Soc_data_access_error_trap
...
.global  Soc_data_access_error_trap
...
check_mcu_ESR_tt63:
	...
	or	%l6,%l3,%l6
        ...
        setx  0x3fffffffffff0000, %l3, %l0	! MEC bit not checked
        andcc %l0, %l1, %l5
...
setx  0x000000000000000f, %l0, %i5
mov 0x1,%l7
check_clear_dsfsr_Da:
        add     %g0, SFSR_VA, %i7
        ldxa  [%i7]ASI_DSFSR, %i6
       ! setx  0x0000000000000002, %l0, %i5
	mov    0x2,%g7
        cmp    %i6,%g7
        tne  %xcc, T_BAD_TRAP
