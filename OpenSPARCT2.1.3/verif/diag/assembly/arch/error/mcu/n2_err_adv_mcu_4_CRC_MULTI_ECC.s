...
* 
* OpenSPARC T2 Processor File: n2_err_adv_mcu_4_CRC_MULTI_ECC.s
...
set_DRAM_error_inject_mcu0_l2bank0:
  mov   0x2, %l1
  !mov   0x1, %l2
...
set_L2_Direct_Mapped_Mode_bank0:
  clr %l0
  clr %g1
...
check_DRAM_ESR_MCU0_L2BANK0_FBR:
  !clr %l1
  !mov   0x1, %l1
  !sllx  %l1, 54, %l1
  !clr %l2
...
set_DRAM_error_inject_mcu0_l2bank1:
  mov   0x2, %l1
  !mov   0x1, %l2
  !sllx  %l2, DRAM_EI_SSHOT, %l2
  !or    %l1, %l2, %l1
...
set_L2_Direct_Mapped_Mode_bank1:
  clr %l0
  clr %g1
...
check_DRAM_ESR_MCU0_L2BANK1_FBR:
  !clr %l1
  !mov   0x1, %l1
  !sllx  %l1, 54, %l1
  !clr %l2
