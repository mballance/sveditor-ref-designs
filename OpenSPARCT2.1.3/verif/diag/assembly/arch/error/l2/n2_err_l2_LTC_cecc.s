...
* 
* OpenSPARC T2 Processor File: n2_err_l2_LTC_cecc.s
...
store_to_L2_mec:
  setx  0x303000aa00, %l0, %g2  ! bits [21:18] select way
  stx %g5, [%g2]
  stx %g5, [%g2+8]
  membar #Sync
...
reading_back_For_mec:                 !Load to L2 again to get the error
  setx  0x303000aa00, %l0, %g2
  ldx   [%g2], %l6
  membar #Sync
...
!Since L2 ESR is not cleared, the err will log MEC.
check_l2_ESR_mec:
  setx  L2ES_PA0, %l6, %g1
  ldx   [%g1], %l4
  membar #Sync
...
! Since the EAR is not cleared it should have old err addr.
check_l2_EAR_mec:
  setx  L2EA_PA0, %l6, %l3
  ldx   [%l3], %l4
  membar #Sync
