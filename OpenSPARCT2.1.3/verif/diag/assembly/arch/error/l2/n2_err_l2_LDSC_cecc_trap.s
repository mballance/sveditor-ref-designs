...
* 
* OpenSPARC T2 Processor File: n2_err_l2_LDSC_cecc_trap.s
...
*/
#define H_HT0_Hw_Corrected_Error_0x63 My_hw_corrected_error_handler
...
.global My_hw_corrected_error_handler
My_hw_corrected_error_handler:
  rdpr  %tt, %o1
  cmp   %o1, 0x63
...
check_l2_ESR:
  setx  L2ES_PA0, %l6, %g1
  ldx   [%g1], %l4
  setx  mpeval((1<<L2ES_LDSC)+(1<<L2ES_VEC)), %o0, %o1
  cmp   %l4, %o1
