...
* 
* OpenSPARC T2 Processor File: n2_err_L2_trp_pndng_sec_errpkt.s
...
read_back_LTC_InESR:                 !Load to L2 again to get the LTC logged in ESR
  setx  0x202000aa00, %l0, %g2
  ldx   [%g2], %l6
  membar #Sync

read_back_Send_Trap:                 !Load miss to L2 again to get the error trap
