...
* 
* OpenSPARC T2 Processor File: n2_err_l2_LDRC_cecc_trap.s
...
Wr_Evnt: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )
...
Wr_Evnt_mec: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt_mec) -> EnablePCIeIgCmd ("DMARD", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )
clr %l7
set 0x20, %i7
wr_evnt_loop_mec:
  inc %l7
