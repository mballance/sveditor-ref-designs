...
* 
* OpenSPARC T2 Processor File: n2_err_L2_NotData_NDDM_meu_trap.s
...
#define DMA_DATA_BYP_ADDR1  0xfffc00002000aa40
#endif
#ifdef L22
#define L2_BANK_ADDR        0x80
#define DMA_DATA_BYP_ADDR1  0xfffc00002000aa80
#endif
#ifdef L23
#define L2_BANK_ADDR        0xc0
#define DMA_DATA_BYP_ADDR1  0xfffc00002000aac0
#endif
#ifdef L24
#define L2_BANK_ADDR        0x100
#define DMA_DATA_BYP_ADDR1  0xfffc00002000ac00
#endif
#ifdef L25
#define L2_BANK_ADDR        0x140
#define DMA_DATA_BYP_ADDR1  0xfffc00002000ac40
#endif
#ifdef L26
#define L2_BANK_ADDR        0x180
#define DMA_DATA_BYP_ADDR1  0xfffc00002000ac80
#endif
#ifdef L27
#define L2_BANK_ADDR        0x1c0
#define DMA_DATA_BYP_ADDR1  0xfffc00002000acc0
#endif
...
Wr_Evnt_meu: nop;
        ! $EV trig_pc_d(1, @VA(.MAIN.Wr_Evnt_meu) -> EnablePCIeIgCmd ("DMARD_UE", DMA_DATA_BYP_ADDR1, DMA_DATA_BYP_ADDR1, "64'h40", 1 )
...
!  add   %g5, L2_BANK_ADDR, %g5
  stx   %g4, [%g5]          ! Store miss to create fill, thus an error trap
  membar #Sync
...
compute_notData_reg:
  setx  0x200002000aa00, %l0, %l1  ! bits [21:18] select way
  setx  0x3ffffffffffc0, %l0,%o2
  and  %l6, %o2, %l6
  cmp   %l6, %l1
  bne   %xcc, test_fail
  nop
