...
* 
* OpenSPARC T2 Processor File: n2_err_dram_DAC_st_trap_L2_Off.s
...
set_DRAM_error_inject_ch0:
  mov   0x20, %l1                ! ECC Mask (Multi-bit error)
  mov   0x1, %l2 		
...
store_for_miss:
  setx  0x3300aa00, %l0, %g2  ! bits [21:18] select way
  add   %g2, L2_BANK_ADDR, %g2
  !stx %g5, [%g2]
  membar #Sync
...
compute_dram_ESR:
  ...
  set   0x0020, %l3              ! 16-bit Syndrome - for SECC, it's the mask nibble-reversed
