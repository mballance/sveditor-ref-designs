...
* 
* OpenSPARC T2 Processor File: interrupt_niutx.s
...
#define ENABLE_NIU_BG_TX 1
#define ENABLE_NIU_BACKGROUND_PACKETS_IN_BOOT 1
#define NIU_BG_TX_MAC_ID 0
#define NIU_BG_TX_PKT_LEN 64
#define NIU_BG_TX_PKT_COUNT 0xa
...
intr_wait_loop_top:
    ...
    best_set_reg(mpeval(TDMC_INTR_DBG+(NIU_TX_DMA_NUM*TDMC_STEP)),
                 %l1, %l0)
