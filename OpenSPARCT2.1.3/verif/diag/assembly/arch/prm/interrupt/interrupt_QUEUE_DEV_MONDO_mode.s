...
* 
* OpenSPARC T2 Processor File: interrupt_QUEUE_DEV_MONDO_mode.s
...
user_mode:
	...
	! Read and write ASI_QUEUE_DEV_MONDO_HEAD/TAIL registers
	! Privileged Action traps expected.
user_read:
	setx	ASI_DEVICE_QUEUE_HEAD, %g1, %g7
	setx	ASI_DEVICE_QUEUE_TAIL, %g1, %g6
...
super_mode:
	...
	! Read and write ASI_QUEUE_DEV_MONDO_HEAD reg., expect no traps
super_head:
	setx	ASI_DEVICE_QUEUE_HEAD, %g1, %g7
...
super_head_trap_check:
	...
	! Read ASI_QUEUE_DEV_MONDO_TAIL reg.
	! Expect no trap.
super_tail_read:
	setx	ASI_DEVICE_QUEUE_TAIL, %g1, %g6
...
super_tail_read_trap_check:
	...
	! Write ASI_QUEUE_DEV_MONDO_TAIL reg.
...
super_tail_write_trap_check:
	...
	! Did the contents of ASI_DEV_MONDO_QUEUE_TAIL reg change?
super_change_check:
	setx	ASI_DEVICE_QUEUE_TAIL, %g1, %g6
