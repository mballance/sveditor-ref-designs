...
* 
* OpenSPARC T2 Processor File: interrupt_QUEUE_DEV_MONDO_trap.s
...
init_dev_queue:
	...
	stxa	%g2, [%g0 + ASI_DEVICE_QUEUE_HEAD]%asi
	stxa	%g2, [%g0 + ASI_DEVICE_QUEUE_TAIL]%asi
...
mondo_wait:
	...
	setx	dev_mondo_trap_count, %g1, %g3
mondo_loop:
	brz	%g7, test_failed
	nop
	ld	[%g3], %g4
...
loop:
	...
	! Go back to supervisor mode, trap should occur now.
go_super2:
	ta      T_CHANGE_NONHPRIV
	nop
...
.global	my_Dev_Mondo_trap
.global	my_H_T0_DAE_invalid_asi_0x14

my_Dev_Mondo_trap:
	! Increment the count
	
	setx	dev_mondo_trap_count, %g6, %g7
	ld	[%g7], %g5
	add	%g5, 1, %g5
	st	%g5, [%g7]
	membar	#Sync
       ...
       ldxa    [%g0 + ASI_DEVICE_QUEUE_TAIL]%asi, %g2
       stxa    %g2, [%g0 + ASI_DEVICE_QUEUE_HEAD]%asi
       membar  #Sync
