...
* 
* OpenSPARC T2 Processor File: ncu_ssi_rw.s
...
!Write bytes to the SSI interface
    setx 0x000000ffffff0000,%g7,%g1
    setx data_byte,%g7,%g2
    set  0x05,%g3
loop1:
    ldub [%g2],%g4
    stb  %g4,[%g1]
...
!Write half-words to the SSI interface
    setx 0x000000ffffff0100,%g7,%g1
    setx data_half_word,%g7,%g2
    set  0x05,%g3
loop3:
    lduh [%g2],%g4
    sth  %g4,[%g1]
