...
* 
* OpenSPARC T2 Processor File: rst_mem_st_ld.s
...
*/
#ifndef RST_DIAG_LOOP_COUNT
#define	RST_DIAG_LOOP_COUNT		0x10
#endif
...
thread_0:
	...
	setx	Dest_addr, %g1, %l2
	setx	RST_DIAG_LOOP_COUNT, %g1, %g4
	mov	%g0, %g3
	mov	%g0, %l6
ldx:
	mov	0xf, %g5
