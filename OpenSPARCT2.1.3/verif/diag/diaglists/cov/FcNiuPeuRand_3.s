...
* 
* OpenSPARC T2 Processor File: FcNiuPeuRand_3.s
...
Gen_Packet:
	nop	 ! $EV trig_pc_d(1, @VA(.MAIN.Gen_Packet)) -> TxPktGen(MAC_ID, f, 0xff,0,0)
	nop
...
_DMAWr_t_DMA_store_exword_1: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd2404006  ! 2: LDSW_R	ldsw	[%r1 + %r6], %r9
...
_DMAWr_t_DMA_store_exword_4: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd6288005  ! 8: STB_R	stb	%r11, [%r2 + %r5]

_DMAWr_t_DMA_store_exword_5: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd470c004  ! 10: STX_R	stx	%r10, [%r3 + %r4]
...
_DMAWr_t_DMA_store_exword_7: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd6200005  ! 14: STW_R	stw	%r11, [%r0 + %r5]
...
_DMAWr_t_DMA_store_partial_8: .word 0xfc2a001b  !STB_R stb %r30,[%r8+%r27] 
...
_DMAWr_t_DMA_store_partial_14: .word 0xfc2a001b  !STB_R stb %r30,[%r8+%r27] 
...
_DMAWr_t_DMA_store_exword_16: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd4588006  ! 32: LDX_R	ldx	[%r2 + %r6], %r10

_DMAWr_t_DMA_store_exword_17: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd470c006  ! 34: STX_R	stx	%r10, [%r3 + %r6]

_DMAWr_t_DMA_store_exword_18: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd220c005  ! 36: STW_R	stw	%r9, [%r3 + %r5]

_DMAWr_t_DMA_store_exword_19: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd2208005  ! 38: STW_R	stw	%r9, [%r2 + %r5]

_DMAWr_t_DMA_store_exword_20: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd6400006  ! 40: LDSW_R	ldsw	[%r0 + %r6], %r11

_DMAWr_t_DMA_store_exword_21: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd4584007  ! 42: LDX_R	ldx	[%r1 + %r7], %r10
...
_DMAWr_t_DMA_store_exword_25: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd2408004  ! 50: LDSW_R	ldsw	[%r2 + %r4], %r9

_DMAWr_t_DMA_store_exword_26: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd6700005  ! 52: STX_R	stx	%r11, [%r0 + %r5]

_DMAWr_t_DMA_store_exword_27: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd6304006  ! 54: STH_R	sth	%r11, [%r1 + %r6]
...
_DMAWr_t_DMA_store_exword_29: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd4204007  ! 58: STW_R	stw	%r10, [%r1 + %r7]
...
_DMAWr_t_DMA_store_partial_32: .word 0xfc2a001b  !STB_R stb %r30,[%r8+%r27] 

_DMAWr_t_DMA_store_exword_33: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd2404007  ! 66: LDSW_R	ldsw	[%r1 + %r7], %r9
...
_DMAWr_t_DMA_store_exword_37: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd228c007  ! 74: STB_R	stb	%r9, [%r3 + %r7]

_DMAWr_t_DMA_store_exword_38: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd2300004  ! 76: STH_R	sth	%r9, [%r0 + %r4]

_DMAWr_t_DMA_store_exword_39: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd6588005  ! 78: LDX_R	ldx	[%r2 + %r5], %r11

_DMAWr_t_DMA_store_exword_40: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd0208004  ! 80: STW_R	stw	%r8, [%r2 + %r4]

_DMAWr_t_DMA_store_exword_41: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd040c006  ! 82: LDSW_R	ldsw	[%r3 + %r6], %r8
...
_DMAWr_t_DMA_store_partial_47: .word 0xfc2a001b  !STB_R stb %r30,[%r8+%r27] 

_DMAWr_t_DMA_store_exword_48: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd4408005  ! 96: LDSW_R	ldsw	[%r2 + %r5], %r10

_DMAWr_t_DMA_store_exword_49: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd620c007  ! 98: STW_R	stw	%r11, [%r3 + %r7]
...
_DMAWr_t_DMA_store_partial_50: .word 0xfc2a001b  !STB_R stb %r30,[%r8+%r27] 

_DMAWr_t_DMA_store_exword_51: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd2588006  ! 102: LDX_R	ldx	[%r2 + %r6], %r9

_DMAWr_t_DMA_store_exword_52: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd4708004  ! 104: STX_R	stx	%r10, [%r2 + %r4]
...
_DMAWr_t_DMA_store_exword_54: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd058c005  ! 108: LDX_R	ldx	[%r3 + %r5], %r8
...
_DMAWr_t_DMA_store_partial_56: .word 0xfc2a001b  !STB_R stb %r30,[%r8+%r27] 
...
_DMAWr_t_DMA_store_exword_60: .word 0xf871c019  ! STX_R  stx  %r28, [%r7 + %r25]
	.word 0xd0580004  ! 120: LDX_R	ldx	[%r0 + %r4], %r8
        nop
        nop
