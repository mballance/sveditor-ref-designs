...
// 
// OpenSPARC T2 Processor File: dmu_imu_ics_csr_imu_perf_cntrl.v
...
module dmu_imu_ics_csr_imu_perf_cntrl 
	(
	clk,
	rst_l,
	imu_perf_cntrl_w_ld,
...
input  imu_perf_cntrl_w_ld;  // SW load bus
...
wire imu_perf_cntrl_w_ld;  // SW load bus
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_IMU_ICS_CSR_IMU_PERF_CNTRL_WIDTH-1:0] omni_data;

// vlint flag_unsynthesizable_initial off
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_IMU_ICS_CSR_IMU_PERF_CNTRL_WIDTH'b0;
...
assign imu_perf_cntrl_sel1_hw_read=
           imu_perf_cntrl_csrbus_read_data
               [`FIRE_DLC_IMU_ICS_CSR_IMU_PERF_CNTRL_SEL1_SLC];
assign imu_perf_cntrl_sel0_hw_read=
           imu_perf_cntrl_csrbus_read_data
               [`FIRE_DLC_IMU_ICS_CSR_IMU_PERF_CNTRL_SEL0_SLC];
...
//----- Entry 0
dmu_imu_ics_csr_imu_perf_cntrl_entry imu_perf_cntrl_0
	(
	// synopsys translate_off
	  .omni_ld	(omni_ld),
	  .omni_data	(omni_data),
