...
// 
// OpenSPARC T2 Processor File: dmu_imu_iss_csr_interrupt_retry_timer.v
...
module dmu_imu_iss_csr_interrupt_retry_timer 
	(
	clk,
	rst_l,
	interrupt_retry_timer_w_ld,
	csrbus_wr_data,
...
input  interrupt_retry_timer_w_ld;  // SW load bus
...
wire interrupt_retry_timer_w_ld;  // SW load bus
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_IMU_ISS_CSR_INTERRUPT_RETRY_TIMER_WIDTH-1:0] omni_data;

// vlint flag_unsynthesizable_initial off
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_IMU_ISS_CSR_INTERRUPT_RETRY_TIMER_WIDTH'b0;
...
assign interrupt_retry_timer_limit_hw_read=
           interrupt_retry_timer_csrbus_read_data
               [`FIRE_DLC_IMU_ISS_CSR_INTERRUPT_RETRY_TIMER_LIMIT_SLC];
...
//----- Entry 0
dmu_imu_iss_csr_interrupt_retry_timer_entry interrupt_retry_timer_0
	(
	// synopsys translate_off
	  .omni_ld	(omni_ld),
	  .omni_data	(omni_data),
