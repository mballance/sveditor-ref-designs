...
// 
// OpenSPARC T2 Processor File: dmu_mmu_csr_prf0.v
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_MMU_CSR_PRF0_WIDTH-1:0] omni_data;

// vlint flag_unsynthesizable_initial off
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_MMU_CSR_PRF0_WIDTH'b0;
...
assign prf0_cnt_hw_read=
           prf0_csrbus_read_data
               [`FIRE_DLC_MMU_CSR_PRF0_CNT_SLC];
