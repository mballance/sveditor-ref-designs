...
// 
// OpenSPARC T2 Processor File: dmu_imu_ics_csr_imu_eqs_error_log_reg.v
...
module dmu_imu_ics_csr_imu_eqs_error_log_reg 
	(
	clk,
	por_l,
	imu_eqs_error_log_reg_w_ld,
	csrbus_wr_data,
...
input  imu_eqs_error_log_reg_w_ld;  // SW load bus
...
wire imu_eqs_error_log_reg_w_ld;  // SW load bus
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_IMU_ICS_CSR_IMU_EQS_ERROR_LOG_REG_WIDTH-1:0] omni_data;

// vlint flag_unsynthesizable_initial off
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_IMU_ICS_CSR_IMU_EQS_ERROR_LOG_REG_WIDTH'b0;
...
//----- Entry 0
dmu_imu_ics_csr_imu_eqs_error_log_reg_entry imu_eqs_error_log_reg_0
	(
	// synopsys translate_off
	  .omni_ld	(omni_ld),
	  .omni_data	(omni_data),
	...
	.clk	(clk),
	.por_l	(por_l),
	.w_ld	(imu_eqs_error_log_reg_w_ld),
...
endmodule // dmu_imu_ics_csr_imu_eqs_error_log_reg
