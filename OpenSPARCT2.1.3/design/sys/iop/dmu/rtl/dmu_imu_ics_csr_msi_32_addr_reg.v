...
// 
// OpenSPARC T2 Processor File: dmu_imu_ics_csr_msi_32_addr_reg.v
...
module dmu_imu_ics_csr_msi_32_addr_reg 
	(
	clk,
	rst_l,
	msi_32_addr_reg_w_ld,
	csrbus_wr_data,
...
input  msi_32_addr_reg_w_ld;  // SW load bus
...
wire msi_32_addr_reg_w_ld;  // SW load bus
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_IMU_ICS_CSR_MSI_32_ADDR_REG_WIDTH-1:0] omni_data;

// vlint flag_unsynthesizable_initial off
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_IMU_ICS_CSR_MSI_32_ADDR_REG_WIDTH'b0;
...
assign msi_32_addr_reg_addr_hw_read=
           msi_32_addr_reg_csrbus_read_data
               [`FIRE_DLC_IMU_ICS_CSR_MSI_32_ADDR_REG_ADDR_SLC];
...
//----- Entry 0
dmu_imu_ics_csr_msi_32_addr_reg_entry msi_32_addr_reg_0
	(
	// synopsys translate_off
	  .omni_ld	(omni_ld),
	  .omni_data	(omni_data),
