...
// 
// OpenSPARC T2 Processor File: dmu_imu_rds_mess_csr_err_nonfatal_mapping.v
...
module dmu_imu_rds_mess_csr_err_nonfatal_mapping 
	(
	clk,
	rst_l,
	err_nonfatal_mapping_w_ld,
	csrbus_wr_data,
...
input  err_nonfatal_mapping_w_ld;  // SW load bus
...
wire err_nonfatal_mapping_w_ld;  // SW load bus
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_IMU_RDS_MESS_CSR_ERR_NONFATAL_MAPPING_WIDTH-1:0] omni_data;

// vlint flag_unsynthesizable_initial off
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_IMU_RDS_MESS_CSR_ERR_NONFATAL_MAPPING_WIDTH'b0;
...
assign err_nonfatal_mapping_v_hw_read=
           err_nonfatal_mapping_csrbus_read_data [63];
assign err_nonfatal_mapping_eqnum_hw_read=
           err_nonfatal_mapping_csrbus_read_data
               [`FIRE_DLC_IMU_RDS_MESS_CSR_ERR_NONFATAL_MAPPING_EQNUM_SLC];
...
//----- Entry 0
dmu_imu_rds_mess_csr_err_nonfatal_mapping_entry err_nonfatal_mapping_0
	(
	// synopsys translate_off
	  .omni_ld	(omni_ld),
	  .omni_data	(omni_data),
	...
	.clk	(clk),
	.rst_l	(rst_l),
	.w_ld	(err_nonfatal_mapping_w_ld),
	.csrbus_wr_data	(csrbus_wr_data),
	.err_nonfatal_mapping_csrbus_read_data	(err_nonfatal_mapping_csrbus_read_data)
	);

endmodule // dmu_imu_rds_mess_csr_err_nonfatal_mapping
