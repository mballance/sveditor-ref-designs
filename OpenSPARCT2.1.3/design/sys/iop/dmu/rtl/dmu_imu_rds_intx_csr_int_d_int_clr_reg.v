...
// 
// OpenSPARC T2 Processor File: dmu_imu_rds_intx_csr_int_d_int_clr_reg.v
...
module dmu_imu_rds_intx_csr_int_d_int_clr_reg 
	(
	clk,
	rst_l,
	int_d_int_clr_reg_w_ld,
	csrbus_wr_data,
...
input  int_d_int_clr_reg_w_ld;  // SW load bus
...
wire int_d_int_clr_reg_w_ld;  // SW load bus
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_IMU_RDS_INTX_CSR_INT_D_INT_CLR_REG_WIDTH-1:0] omni_data;

// vlint flag_unsynthesizable_initial off
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_IMU_RDS_INTX_CSR_INT_D_INT_CLR_REG_WIDTH'b0;
...
assign int_d_int_clr_reg_clr_hw_read=
           int_d_int_clr_reg_csrbus_read_data [0];
...
//----- Entry 0
dmu_imu_rds_intx_csr_int_d_int_clr_reg_entry int_d_int_clr_reg_0
	(
	// synopsys translate_off
	  .omni_ld	(omni_ld),
	  .omni_data	(omni_data),
...
endmodule // dmu_imu_rds_intx_csr_int_d_int_clr_reg
