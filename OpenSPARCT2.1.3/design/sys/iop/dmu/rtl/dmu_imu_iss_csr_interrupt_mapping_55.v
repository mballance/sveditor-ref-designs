...
// 
// OpenSPARC T2 Processor File: dmu_imu_iss_csr_interrupt_mapping_55.v
...
module dmu_imu_iss_csr_interrupt_mapping_55 
	(
	clk,
	rst_l,
	interrupt_mapping_55_w_ld,
	csrbus_wr_data,
...
input  interrupt_mapping_55_w_ld;  // SW load bus
...
wire interrupt_mapping_55_w_ld;  // SW load bus
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_IMU_ISS_CSR_INTERRUPT_MAPPING_55_WIDTH-1:0] omni_data;

// vlint flag_unsynthesizable_initial off
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_IMU_ISS_CSR_INTERRUPT_MAPPING_55_WIDTH'b0;
...
assign interrupt_mapping_55_mdo_mode_hw_read=
           interrupt_mapping_55_csrbus_read_data [63];
assign interrupt_mapping_55_v_hw_read=
           interrupt_mapping_55_csrbus_read_data [31];
assign interrupt_mapping_55_t_id_hw_read=
           interrupt_mapping_55_csrbus_read_data
               [`FIRE_DLC_IMU_ISS_CSR_INTERRUPT_MAPPING_55_T_ID_SLC];
assign interrupt_mapping_55_int_cntrl_num_hw_read=
           interrupt_mapping_55_csrbus_read_data
               [`FIRE_DLC_IMU_ISS_CSR_INTERRUPT_MAPPING_55_INT_CNTRL_NUM_SLC];
...
//----- Entry 0
dmu_imu_iss_csr_interrupt_mapping_55_entry interrupt_mapping_55_0
	(
	// synopsys translate_off
	  .omni_ld	(omni_ld),
	  .omni_data	(omni_data),
