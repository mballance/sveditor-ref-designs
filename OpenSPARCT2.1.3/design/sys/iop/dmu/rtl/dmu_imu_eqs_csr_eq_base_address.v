...
// 
// OpenSPARC T2 Processor File: dmu_imu_eqs_csr_eq_base_address.v
...
module dmu_imu_eqs_csr_eq_base_address 
	(
	clk,
	rst_l,
	eq_base_address_w_ld,
	csrbus_wr_data,
...
input  eq_base_address_w_ld;  // SW load bus
...
wire eq_base_address_w_ld;  // SW load bus
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_IMU_EQS_CSR_EQ_BASE_ADDRESS_WIDTH-1:0] omni_data;

// vlint flag_unsynthesizable_initial off
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_IMU_EQS_CSR_EQ_BASE_ADDRESS_WIDTH'b0;
...
assign eq_base_address_address_hw_read=
           eq_base_address_csrbus_read_data
               [`FIRE_DLC_IMU_EQS_CSR_EQ_BASE_ADDRESS_ADDRESS_SLC];
...
//----- Entry 0
dmu_imu_eqs_csr_eq_base_address_entry eq_base_address_0
	(
	// synopsys translate_off
	  .omni_ld	(omni_ld),
	  .omni_data	(omni_data),
