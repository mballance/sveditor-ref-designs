...
// 
// OpenSPARC T2 Processor File: dmu_mmu_csr_err.v
...
// verilint 498 off
reg omni_ld;
reg [`FIRE_DLC_MMU_CSR_ERR_RW1C_ALIAS_WIDTH-1:0] omni_data;
reg omni_rw1c_alias;
reg omni_rw1s_alias;
...
initial
  begin
     omni_ld         = 1'b0;
     omni_data       = `FIRE_DLC_MMU_CSR_ERR_RW1C_ALIAS_WIDTH'b0;
...
assign err_hw_read=
           err_csrbus_read_data
               [`FIRE_DLC_MMU_CSR_ERR_RW1C_ALIAS_WIDTH-1:0];
