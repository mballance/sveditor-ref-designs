...
// 
// OpenSPARC T2 Processor File: dmu_imu_ics_csr_msi_64_addr_reg_entry.v
...
module dmu_imu_ics_csr_msi_64_addr_reg_entry 
	(
...
// vlint flag_input_port_not_connected off
  input  [`FIRE_DLC_IMU_ICS_CSR_MSI_64_ADDR_REG_WIDTH - 1:0] omni_data;
    // Omni write data
// synopsys translate_on
...
// vlint flag_net_has_no_load off
  wire [`FIRE_DLC_IMU_ICS_CSR_MSI_64_ADDR_REG_WIDTH - 1:0] omni_data;
    // Omni write data
// synopsys translate_on
...
assign  msi_64_addr_reg_csrbus_read_data[0] = 1'b0;  // bit 0
assign  msi_64_addr_reg_csrbus_read_data[1] = 1'b0;  // bit 1
assign  msi_64_addr_reg_csrbus_read_data[2] = 1'b0;  // bit 2
assign  msi_64_addr_reg_csrbus_read_data[3] = 1'b0;  // bit 3
assign  msi_64_addr_reg_csrbus_read_data[4] = 1'b0;  // bit 4
assign  msi_64_addr_reg_csrbus_read_data[5] = 1'b0;  // bit 5
assign  msi_64_addr_reg_csrbus_read_data[6] = 1'b0;  // bit 6
assign  msi_64_addr_reg_csrbus_read_data[7] = 1'b0;  // bit 7
assign  msi_64_addr_reg_csrbus_read_data[8] = 1'b0;  // bit 8
assign  msi_64_addr_reg_csrbus_read_data[9] = 1'b0;  // bit 9
assign  msi_64_addr_reg_csrbus_read_data[10] = 1'b0;  // bit 10
assign  msi_64_addr_reg_csrbus_read_data[11] = 1'b0;  // bit 11
assign  msi_64_addr_reg_csrbus_read_data[12] = 1'b0;  // bit 12
assign  msi_64_addr_reg_csrbus_read_data[13] = 1'b0;  // bit 13
assign  msi_64_addr_reg_csrbus_read_data[14] = 1'b0;  // bit 14
assign  msi_64_addr_reg_csrbus_read_data[15] = 1'b0;  // bit 15
// bit 16
csr_sw csr_sw_16
	(
	// synopsys translate_off
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[16])
	);
...
csr_sw csr_sw_17
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[17])
	);
...
csr_sw csr_sw_18
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[18])
	);
...
csr_sw csr_sw_19
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[19])
	);
...
csr_sw csr_sw_20
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[20])
	);
...
csr_sw csr_sw_21
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[21])
	);
...
csr_sw csr_sw_22
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[22])
	);
...
csr_sw csr_sw_23
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[23])
	);
...
csr_sw csr_sw_24
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[24])
	);
...
csr_sw csr_sw_25
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[25])
	);
...
csr_sw csr_sw_26
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[26])
	);
...
csr_sw csr_sw_27
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[27])
	);
...
csr_sw csr_sw_28
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[28])
	);
...
csr_sw csr_sw_29
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[29])
	);
...
csr_sw csr_sw_30
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[30])
	);
...
csr_sw csr_sw_31
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[31])
	);
...
csr_sw csr_sw_32
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[32])
	);
...
csr_sw csr_sw_33
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[33])
	);
...
csr_sw csr_sw_34
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[34])
	);
...
csr_sw csr_sw_35
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[35])
	);
...
csr_sw csr_sw_36
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[36])
	);
...
csr_sw csr_sw_37
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[37])
	);
...
csr_sw csr_sw_38
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[38])
	);
...
csr_sw csr_sw_39
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[39])
	);
...
csr_sw csr_sw_40
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[40])
	);
...
csr_sw csr_sw_41
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[41])
	);
...
csr_sw csr_sw_42
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[42])
	);
...
csr_sw csr_sw_43
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[43])
	);
...
csr_sw csr_sw_44
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[44])
	);
...
csr_sw csr_sw_45
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[45])
	);
...
csr_sw csr_sw_46
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[46])
	);
...
csr_sw csr_sw_47
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[47])
	);
...
csr_sw csr_sw_48
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[48])
	);
...
csr_sw csr_sw_49
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[49])
	);
...
csr_sw csr_sw_50
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[50])
	);
...
csr_sw csr_sw_51
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[51])
	);
...
csr_sw csr_sw_52
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[52])
	);
...
csr_sw csr_sw_53
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[53])
	);
...
csr_sw csr_sw_54
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[54])
	);
...
csr_sw csr_sw_55
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[55])
	);
...
csr_sw csr_sw_56
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[56])
	);
...
csr_sw csr_sw_57
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[57])
	);
...
csr_sw csr_sw_58
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[58])
	);
...
csr_sw csr_sw_59
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[59])
	);
...
csr_sw csr_sw_60
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[60])
	);
...
csr_sw csr_sw_61
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[61])
	);
...
csr_sw csr_sw_62
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[62])
	);
...
csr_sw csr_sw_63
	...
	.hw_data        (1'b0),
	.cp             (clk),
	.q              (msi_64_addr_reg_csrbus_read_data[63])
	);


endmodule // dmu_imu_ics_csr_msi_64_addr_reg_entry
