...
// 
// OpenSPARC T2 Processor File: tds_l2l1clk_io.v
...
//        ccu_slow_cmp_sync_en,
	...
	gclk,
	cluster_arst_l,
// following two pin remove in I6.1
//	clk_ext,
//	ccu_serdes_dtm,
	tcu_aclk,
	tcu_bclk,
...
output  iol2clk; // direct clock source to memory
...
// ************************** 
 clkgen_tds_io clkgen_tds_io ( 
   ...
   .rst_wmr_(rst_wmr_),
   .rst_por_(rst_por_),
// This pin will ground internal in the I5.3 release
...
//  following two pins remove in I6.1
//   .clk_ext(clk_ext),
//   .ccu_serdes_dtm(ccu_serdes_dtm),
 ...
 cl_a1_l1hdr_8x tds_l1clk_1 ( .l2clk(iol2clk), .se(scan_en), .pce(1'b1),
      .pce_ov(pce_ov), .stop(1'b0), .l1clk(l1clk) );
