...
// 
// OpenSPARC T2 Processor File: rdp_clkgen_rdp_io.v
...
// New ports 8/05 due to new clstr_hdr
...
output	aclk_wmr;		// New output for cluster header
...
//   input	ccu_serdes_dtm;		// New input for cluster header
...
clkgen_rdp_io clkgen_rdp_io (
    .array_wr_inhibit	  (array_wr_inhibit),	// New for I6.1
    .tcu_atpg_mode	  (tcu_atpg_mode),	// New for I6.1
    .tcu_wr_inhibit	  (tcu_wr_inhibit),	// New for I6.1
    .l2clk		  (iol2clk),
    .aclk		  (aclk),
    .bclk		  (bclk),
    ...
    .clk_ext		  (1'b0),		// port left doesn't do anything
    .ccu_serdes_dtm	  (1'b0),     
    .tcu_aclk		  (tcu_aclk),
    .tcu_bclk		  (tcu_bclk),
    .scan_en		  (tcu_scan_en),
...
cl_a1_l1hdr_12x iol2clk_cl_a1_l1hdr_12x	(
	.l2clk	(iol2clk),	// This is the input
	.se	(tcu_scan_en),
	.pce    (1'b1),
        .pce_ov	(pce_ov),
	.stop   (1'b0),
	.l1clk  (l1clk)		// This is output
		);
