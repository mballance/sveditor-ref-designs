...
// 
// OpenSPARC T2 Processor File: ncu_i2cbuf32_ni_ctl.v
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_1 vld_d1_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_32 data_d1_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__width_1 stall_ff 
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__width_1 stall_d1_ff 
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__width_1 rdy0_ff 
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__width_1 rdy1_ff 
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_1 vld_buf0_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_32 data_buf0_ff  
				(
...
// Buffer 1
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__width_1 skid_buf1_en_ff 
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_1 vld_buf1_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_32 data_buf1_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__width_1 skid_buf1_sel_ff 
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_4 indata_vec_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_128 indata_buf_ff  
				(
...
// detect a new packet	  
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_1 indata_vec0_d1_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_1 buf1_older_ff  
				(
...
// the actual buffers
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_1 buf0_vld_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_1 buf1_vld_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_128 buf0_obj_ff  
				(
...
ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_128 buf1_obj_ff  
				(
...
/**** adding clock header ****/
ncu_i2cbuf32_ni_ctl_l1clkhdr_ctl_macro clkgen (
				.l2clk	(iol2clk),
				.l1en	(1'b1),
				.l1clk	(l1clk),
  .pce_ov(pce_ov),
...
module ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_1 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_32 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module ncu_i2cbuf32_ni_ctl_msff_ctl_macro__width_1 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_4 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module ncu_i2cbuf32_ni_ctl_msff_ctl_macro__en_1__width_128 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module ncu_i2cbuf32_ni_ctl_l1clkhdr_ctl_macro (
  l2clk, 
  l1en, 
  pce_ov, 
  stop, 
