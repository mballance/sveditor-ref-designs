...
// 
// OpenSPARC T2 Processor File: ncu_c2ibuf4_ctl.v
...
ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_1 buf1_older_ff  
				(
...
// the actual buffers
ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_1 buf0_vld_ff  
				(
...
ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_1 buf1_vld_ff  
				(
...
ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_64 buf0_obj_p_ff  
				(
...
ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_55 buf0_obj_h_ff  
				(
...
ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_64 buf1_obj_p_ff  
				(
...
ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_55 buf1_obj_h_ff  
				(
...
assign	iob_ucb_vld = outdata_vec[0];
assign	iob_ucb_data[3:0] = outdata_buf[3:0];

ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_1 stall_d1_ff  
				(
...
ncu_c2ibuf4_ctl_msff_ctl_macro__width_1 rdy0_ff 
				(
...
ncu_c2ibuf4_ctl_msff_ctl_macro__width_1 rdy1_ff 
				(
...
assign  outdata_vec_next[31:0] =
			//load_outdata  ? outdata_vec_in[128/UCB_BUS_WIDTH-1:0] : 
			load_outdata  ? 32'hffff_ffff : 
			//shift_outdata ? outdata_vec[128/UCB_BUS_WIDTH-1:0] >> 1 : 
			shift_outdata ? {1'b0,outdata_vec[31:1]} :
					outdata_vec[31:0] ;

ncu_c2ibuf4_ctl_msff_ctl_macro__width_32 outdata_vec_ff 
				(
				.scan_in(outdata_vec_ff_scanin),
				.scan_out(outdata_vec_ff_scanout),
				.dout		(outdata_vec[31:0]),
				.l1clk		(l1clk),
				.din		(outdata_vec_next[31:0]),
  .siclk(siclk),
  .soclk(soclk)
				);

assign  outdata_buf_next[127:0] = load_outdata  ? outdata_buf_in[127:0] :
	 		          shift_outdata ? (outdata_buf[127:0] >> 4) :  
	                         		     outdata_buf[127:0] ;

ncu_c2ibuf4_ctl_msff_ctl_macro__width_128 outdata_buf_ff 
				(
...
/**** adding clock header ****/
ncu_c2ibuf4_ctl_l1clkhdr_ctl_macro clkgen (
				.l2clk	(iol2clk),
				.l1en	(1'b1),
				.l1clk	(l1clk),
  .pce_ov(pce_ov),
...
assign stall_d1_ff_scanin        = buf1_obj_h_ff_scanout    ;
assign rdy0_ff_scanin            = stall_d1_ff_scanout      ;
assign rdy1_ff_scanin            = rdy0_ff_scanout          ;
assign outdata_vec_ff_scanin     = rdy1_ff_scanout          ;
...
module ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_1 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_64 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module ncu_c2ibuf4_ctl_msff_ctl_macro__en_1__width_55 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module ncu_c2ibuf4_ctl_msff_ctl_macro__width_1 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module ncu_c2ibuf4_ctl_msff_ctl_macro__width_32 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module ncu_c2ibuf4_ctl_msff_ctl_macro__width_128 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module ncu_c2ibuf4_ctl_l1clkhdr_ctl_macro (
  l2clk, 
  l1en, 
  pce_ov, 
  stop, 
