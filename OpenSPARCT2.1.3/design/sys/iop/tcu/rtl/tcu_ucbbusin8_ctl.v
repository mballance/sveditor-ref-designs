...
// 
// OpenSPARC T2 Processor File: tcu_ucbbusin8_ctl.v
...
tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_1 vld_d1_ff  
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_8 data_d1_ff  
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__width_1 stall_ff 
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__width_1 stall_d1_ff 
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_1 vld_buf0_ff  
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_8 data_buf0_ff   
				(
...
// Buffer 1
tcu_ucbbusin8_ctl_msff_ctl_macro__width_1 skid_buf1_en_ff 
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_1 vld_buf1_ff  
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_8 data_buf1_ff   
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__width_1 skid_buf1_sel_ff 
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_16 indata_vec_ff   
				(
...
tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_128 indata_buf_ff  
				(
...
// detect a new packet	  
tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_1 indata_vec0_d1_ff  
				(
...
/**** adding clock header ****/
tcu_ucbbusin8_ctl_l1clkhdr_ctl_macro clkgen (
				.l2clk	(iol2clk),
				.l1clk	(l1clk),
  .l1en(l1en),
  .pce_ov(pce_ov),
...
module tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_1 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_8 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module tcu_ucbbusin8_ctl_msff_ctl_macro__width_1 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_16 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module tcu_ucbbusin8_ctl_msff_ctl_macro__en_1__width_128 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module tcu_ucbbusin8_ctl_l1clkhdr_ctl_macro (
  l2clk, 
  l1en, 
  pce_ov, 
  stop, 
