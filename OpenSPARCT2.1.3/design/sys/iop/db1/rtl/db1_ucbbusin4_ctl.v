...
// 
// OpenSPARC T2 Processor File: db1_ucbbusin4_ctl.v
...
db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_1 vld_d1_ff  
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_4 data_d1_ff  
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__width_1 stall_ff 
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__width_1 stall_d1_ff 
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_1 vld_buf0_ff  
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_4 data_buf0_ff   
				(
...
// Buffer 1
db1_ucbbusin4_ctl_msff_ctl_macro__width_1 skid_buf1_en_ff 
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_1 vld_buf1_ff  
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_4 data_buf1_ff   
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__width_1 skid_buf1_sel_ff 
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_32 indata_vec_ff   
				(
...
db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_128 indata_buf_ff  
				(
...
// detect a new packet	  
db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_1 indata_vec0_d1_ff  
				(
...
/**** adding clock header ****/
db1_ucbbusin4_ctl_l1clkhdr_ctl_macro clkgen (
				.l2clk	(iol2clk),
				.l1en	(1'b1),
				.l1clk	(l1clk),
  .pce_ov(pce_ov),
...
module db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_1 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_4 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module db1_ucbbusin4_ctl_msff_ctl_macro__width_1 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_32 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module db1_ucbbusin4_ctl_msff_ctl_macro__en_1__width_128 (
  din, 
  en, 
  l1clk, 
  scan_in, 
...
module db1_ucbbusin4_ctl_l1clkhdr_ctl_macro (
  l2clk, 
  l1en, 
  pce_ov, 
  stop, 
