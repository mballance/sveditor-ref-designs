...
// 
// OpenSPARC T2 Processor File: niu_ram_32_146.v
...
***********************************************************
    ...
    File name       : niu_ram_32_146.v

    Module(s) name  : niu_ram_32_146
...
wire                     [1:0] spare_bits;
  ...
  n2_com_dp_32x148s_cust   ram_32_148_0   (
                                           .tcu_pce_ov            (1'h1),
                                           .tcu_aclk              (tcu_aclk),
                                           .tcu_bclk              (tcu_bclk),
                                           ...
                                           .scan_in               (scan_in),
                                           .scan_out              (scan_out),
                                           .wr_adr                (mux_wr_adr[4:0]),
                                           .wr_en                 (mux_wr_en),
                                           .rd_adr                (mux_rd_adr[4:0]),
                                           .rd_en                 (mux_rd_en),
