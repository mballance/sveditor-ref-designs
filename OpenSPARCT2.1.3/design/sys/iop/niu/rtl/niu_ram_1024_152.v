...
// 
// OpenSPARC T2 Processor File: niu_ram_1024_152.v
...
***********************************************************
    ...
    File name       : niu_ram_1024_152.v

    Module(s) name  : niu_ram_1024_152
...
`ifdef NEPTUNE
  niu_ram_1024i152 ram_1024i152_0 (
                                 .data_inp     (data_inp[151:0]),
                                 .addr_rd      (addr_rd[9:0]),
                                 .addr_wt      (addr_wt[9:0]),
                                 .wt_enable    (wt_enable),
                                 .cs_rd        (cs_rd),
                                 .clk          (clk),
                                 .data_out     (data_out[151:0])
                                );
