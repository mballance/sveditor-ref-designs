...
// 
// OpenSPARC T2 Processor File: niu_ram_256x148.v
...
***********************************************************
    ...
    File name       : niu_ram_256x148.v

    Module(s) name  : niu_ram_256x148
...
parameter DATA_WIDTH_MINUS1 = 147; 
parameter ADDR_WIDTH_MINUS1 = 7; 
...
wire                     [3:0] spare_bits;
  ...
  n2_niu_dp_256x152s_cust  ram_256x152_0  (
                                           .reset                 (reset),
                                           .tcu_aclk              (tcu_aclk),
                                           .tcu_bclk              (tcu_bclk),
                                           ...
                                           .wr_adr                (mux_wr_adr[7:0]),
                                           .wr_en                 (mux_wr_en),
                                           .rd_adr                (mux_rd_adr[7:0]),
                                           .rd_en                 (mux_rd_en),
                                           .din                   ({4'h0,mux_wdata[147:0]}),
                                           .dout                  ({spare_bits,data_out[147:0]}),
                                           .l2clk_2x              (l2clk_2x),
                                           .l2clk                 (clk)
                                          );
