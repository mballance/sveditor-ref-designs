...
// 
// OpenSPARC T2 Processor File: mac_core.v
...
module mac_core 
  (/*AUTOARG*/
   ...
   serdes_reset_1, serdes_reset_0, mif_pio_intr, mdoe, mdo, mdclk, 
   mac_txc_req1, mac_txc_req0, mac_rxc_tag1, mac_rxc_tag0, 
   mac_rxc_stat1, mac_rxc_stat0, mac_rxc_data1, mac_rxc_data0, 
   mac_rxc_ctrl1, mac_rxc_ctrl0, mac_rxc_ack1, mac_rxc_ack0, 
   mac_pio_rdata, mac_pio_intr1, mac_pio_intr0, mac_pio_err, 
   mac_pio_ack, mac_esr_txd3_1, mac_esr_txd3_0, mac_esr_txd2_1, 
   mac_esr_txd2_0, mac_esr_txd1_1, mac_esr_txd1_0, mac_esr_txd0_1, 
   mac_esr_txd0_0, mac_esr_tclk_1, mac_esr_tclk_0, mac_debug_port, 
   // Inputs
   xaui_mdint1_l, xaui_mdint0_l, txc_mac_tag1, txc_mac_tag0, 
   txc_mac_stat1, txc_mac_stat0, txc_mac_data1, txc_mac_data0, 
   txc_mac_ack1, txc_mac_ack0, txc_mac_abort1, txc_mac_abort0, 
   ...
   tcu_mac_125rx_clk_stop, rxc_mac_req1, rxc_mac_req0, pio_mac_sel, 
   pio_clients_wdata, pio_clients_rd, pio_clients_addr, niu_reset_l, 
   niu_clk, mdi_1, mdi_0, mdi, mac_reset1, mac_reset0, 
   mac_312tx_test_clk, mac_312rx_test_clk, mac_156tx_test_clk, 
   mac_156rx_test_clk, mac_125tx_test_clk, mac_125rx_test_clk, 
   esr_mac_tclk_1, esr_mac_tclk_0, esr_mac_rxd3_1, esr_mac_rxd3_0, 
   ...
   esr_mac_lock_1, esr_mac_lock_0
   );
   

/*AUTOINPUT*/
// Beginning of automatic inputs (from unused autoinst inputs)
input			esr_mac_lock_0;		// To mac_2ports of mac_2ports.v
input			esr_mac_lock_1;		// To mac_2ports of mac_2ports.v
...
input			tcu_mac_125rx_clk_stop;	// To mac_2ports of mac_2ports.v
input			tcu_mac_125tx_clk_stop;	// To mac_2ports of mac_2ports.v
input			tcu_mac_156rx_clk_stop;	// To mac_2ports of mac_2ports.v
input			tcu_mac_156tx_clk_stop;	// To mac_2ports of mac_2ports.v
input			tcu_mac_312rx_clk_stop;	// To mac_2ports of mac_2ports.v
input			tcu_mac_312tx_clk_stop;	// To mac_2ports of mac_2ports.v
...
output			serdes_reset_0;		// From mac_2ports of mac_2ports.v
output			serdes_reset_1;		// From mac_2ports of mac_2ports.v
...
wire			sel_por_clk_src0;	// From mac_2ports of mac_2ports.v
wire			sel_por_clk_src1;	// From mac_2ports of mac_2ports.v
...
mac_2ports mac_2ports 
  (/*AUTOINST*/
   ...
   .loopback0				(loopback0),
   .sel_por_clk_src0			(sel_por_clk_src0),
   ...
   .loopback1				(loopback1),
   .sel_por_clk_src1			(sel_por_clk_src1),
