...
// 
// OpenSPARC T2 Processor File: niu_ram_256_148.v
...
***********************************************************
    ...
    File name       : niu_ram_256_148.v

    Module(s) name  : niu_ram_256_148
...
wire                     [6:0] sram_hdr_read_data;
  ...
  niu_ram_256x148 ram_256x148_0 (
                                 ...
                                 .mbi_rd_en             (mbi_rd_en),
                                 .mbi_run               (mbi_run),
                                 .data_inp              (data_inp[147:0]),
                                 .addr_rd               (addr_rd[7:0]),
                                 .addr_wt               (addr_wt[7:0]),
                                 .wt_enable             (wt_enable),
                                 .cs_rd                 (cs_rd),
                                 .clk                   (clk),
                                 .data_out              (data_out[147:0])
                                );
`endif
