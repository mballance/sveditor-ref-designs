...
// 
// OpenSPARC T2 Processor File: niu_ram_512_146.v
...
***********************************************************
    ...
    File name       : niu_ram_512_146.v

    Module(s) name  : niu_ram_512_146
...
wire                     [5:0] spare_bits;
  ...
  n2_niu_dp_512x152s_cust  ram_512_152_0  (
                                           .reset                 (reset),
                                           .tcu_aclk              (tcu_aclk),
                                           .tcu_bclk              (tcu_bclk),
                                           ...
                                           .wr_adr                (mux_wr_adr[8:0]),
                                           .wr_en                 (mux_wr_en),
                                           .rd_adr                (mux_rd_adr[8:0]),
                                           .rd_en                 (mux_rd_en),
                                           .din                   ({6'h0,mux_wdata[145:0]}),
