...
// 
// OpenSPARC T2 Processor File: niu_ram_128_42.v
...
***********************************************************
    ...
    File name       : niu_ram_128_42.v

    Module(s) name  : niu_ram_128_42
...
parameter DATA_WIDTH_MINUS1 = 41; 
...
wire     [DATA_WIDTH_MINUS1:0] mux_wdata;
  ...
  n2_com_dp_128x42s_cust  ram_128_42_0    (
                                           .tcu_pce_ov            (1'h1),
                                           .tcu_aclk              (tcu_aclk),
                                           .tcu_bclk              (tcu_bclk),
                                           ...
                                           .scan_in               (scan_in),
                                           .scan_out              (scan_out),
                                           .wr_adr                (mux_wr_adr[6:0]),
                                           .wr_en                 (mux_wr_en),
                                           .rd_adr                (mux_rd_adr[6:0]),
                                           .rd_en                 (mux_rd_en),
                                           .din                   (mux_wdata[41:0]),
                                           .dout                  (data_out[41:0]),
                                           .rdclk                 (clk),
